...
def ai_chat(prompt, lang, max_length=100):
    tokenizer = AutoTokenizer.from_pretrained(f"HooshvareLab/gpt2-{lang}")
    model = AutoModelForCausalLM.from_pretrained(f"HooshvareLab/gpt2-{lang}")
...
__all__ = [
    ...
    "key", "click", "getcolor", "rc", "ri", "leftclick", "middleclick", "rightclick", "play_mp3", "speak"
]
