...
class ModelMessage(_message.Message):
    __slots__ = ("user", "assistant", "workbook_mutation")
    ...
    workbook_mutation: WorkbookMutationModelMessage
    def __init__(self, user: _Optional[_Union[UserModelMessage, _Mapping]] = ..., assistant: _Optional[_Union[AssistantModelMessage, _Mapping]] = ..., workbook_mutation: _Optional[_Union[WorkbookMutationModelMessage, _Mapping]] = ...) -> None: ...
...
class WorkbookMutationModelMessage(_message.Message):
    __slots__ = ("input", "output")
    INPUT_FIELD_NUMBER: _ClassVar[int]
    OUTPUT_FIELD_NUMBER: _ClassVar[int]
    input: WorkbookMutationInput
    output: WorkbookMutationOutput
    def __init__(self, input: _Optional[_Union[WorkbookMutationInput, _Mapping]] = ..., output: _Optional[_Union[WorkbookMutationOutput, _Mapping]] = ...) -> None: ...
...
class StreamChatResponse(_message.Message):
    ...
    workbook_mutation: WorkbookMutationInput
    def __init__(self, finish: _Optional[_Union[Finish, _Mapping]] = ..., error: _Optional[_Union[Error, _Mapping]] = ..., text_start: _Optional[_Union[TextStart, _Mapping]] = ..., text_delta: _Optional[_Union[TextDelta, _Mapping]] = ..., text_end: _Optional[_Union[TextEnd, _Mapping]] = ..., reasoning_start: _Optional[_Union[ReasoningStart, _Mapping]] = ..., reasoning_delta: _Optional[_Union[ReasoningDelta, _Mapping]] = ..., reasoning_end: _Optional[_Union[ReasoningEnd, _Mapping]] = ..., workbook_mutation: _Optional[_Union[WorkbookMutationInput, _Mapping]] = ...) -> None: ...
...
class WorkbookMutationInput(_message.Message):
...
class WorkbookMutationOutput(_message.Message):
    __slots__ = ("success", "error")
    SUCCESS_FIELD_NUMBER: _ClassVar[int]
    ERROR_FIELD_NUMBER: _ClassVar[int]
    success: WorkbookMutationSuccess
    error: WorkbookMutationError
    def __init__(self, success: _Optional[_Union[WorkbookMutationSuccess, _Mapping]] = ..., error: _Optional[_Union[WorkbookMutationError, _Mapping]] = ...) -> None: ...

class WorkbookMutationSuccess(_message.Message):
    __slots__ = ("message",)
    MESSAGE_FIELD_NUMBER: _ClassVar[int]
    message: str
    def __init__(self, message: _Optional[str] = ...) -> None: ...

class WorkbookMutationError(_message.Message):
    __slots__ = ("message",)
    MESSAGE_FIELD_NUMBER: _ClassVar[int]
    message: str
    def __init__(self, message: _Optional[str] = ...) -> None: ...
