...
RAM = int
_RAM = __.AVT_MutableSequence[RAM]
...
class Math:
    ...
    if aveytenseVersion(False) >= (0, 3, 54) or True:
        ...
        class fib:
            ...
            @__.overload
            def __new__(cls, n: None = None, /) -> __.AVT_Generator[int, __.Any, __.NoReturn]: ...
            
            @__.overload
            def __new__(cls, n: int, /) -> __.AVT_Generator[int, __.Any, None]: ...
            
            def __new__(cls, n, /):
                
                if not isinstance(n, (int, __.NoneType)) or n < 0:
    ...
    def pyramidal(self, n: int, s: int, /):
        ...
        """
        if (not isinstance(n, int) or n < 0) or (not isinstance(s, int) or s < 3):
