...
from tacomaker.taco.datamodel import TacoExtension
...
class Publications(TacoExtension):
    ...
    def get_schema(self) -> dict[str, pl.DataType]:
        return {
            "publications:list": pl.List(pl.Struct([
                ("doi", pl.Utf8),
                ("citation", pl.Utf8),
                ("summary", pl.Utf8)
            ]))
    ...
    pubs = Publications(
        publications=[
            Publication(
                ...
                citation="Author A et al. (2023). Example Study 1. Journal of Examples."
            ),
            Publication(
