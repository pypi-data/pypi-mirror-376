...
class NinjaClient(SelfHealingMixin):
    ...
    def _consume_tasks(self):
        ...
        try:
            ...
            if assigned:
                ...
                if self.self_healing.detect_and_heal_issues("partition_assignment_failure"):
                    logger.info("✅ Self-healing completed, retrying consumer creation...")
    ...
    def _retry_task_consumer_with_healing(self):
        ...
        """
        logger.info("🔄 Retrying task consumer creation after healing...")
