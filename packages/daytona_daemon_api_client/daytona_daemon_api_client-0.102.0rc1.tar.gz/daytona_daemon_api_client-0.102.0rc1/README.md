...
```python
import daytona_daemon_api_client
```
...
import daytona_daemon_api_client
from daytona_daemon_api_client.rest import ApiException
from pprint import pprint

# Defining the host is optional and defaults to http://localhost:22221
# See configuration.py for a list of all supported configuration parameters.
configuration = daytona_daemon_api_client.Configuration(
...
with daytona_daemon_api_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = daytona_daemon_api_client.ComputerUseApi(api_client)
    request = daytona_daemon_api_client.MouseClickRequest() # MouseClickRequest | Mouse click request
