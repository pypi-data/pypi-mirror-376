...
if __name__ == '__main__':
    ...
    parser.add_argument("-d", "--decimals", type=int, default=1, help="Precision of the reconstruction, i.e., number of decimals recoverable during decompression.")
    parser.add_argument("-p", "--pairing_function", type=str, default="rosenberg", help="The pairing function to use to combined two values in the time series.", choices=["rosenberg", "szudzik", "cantor"])
