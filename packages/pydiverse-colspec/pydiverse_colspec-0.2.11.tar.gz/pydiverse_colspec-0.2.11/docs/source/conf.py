...
_mod = importlib.import_module("pydiverse.colspec")

# -- Project information -----------------------------------------------------
# https://www.sphinx-doc.org/en/master/usage/configuration.html#project-information

project = "pydiverse.colspec"
copyright = f"{datetime.date.today().year}, QuantCo, Inc"
author = "QuantCo, Inc."

release = importlib.metadata.version("pydiverse.colspec")
...
html_title = "pydiverse.colspec"

html_theme_options = {
    "footer_icons": [
        {
            "name": "GitHub",
            "url": "https://github.com/pydiverse/pydiverse.colspec/",
            "html": """
    ...
    "source_repository": "https://github.com/pydiverse/pydiverse.colspec/",
    "source_branch": "main",
...
def linkcode_resolve(domain, info):
    ...
    try:
        ...
        return (
            "https://github.com/pydiverse/pydiverse.colspec"
            f"/tree/{release}/src/pydiverse/colspec/{fn}{linespec}"
        )
