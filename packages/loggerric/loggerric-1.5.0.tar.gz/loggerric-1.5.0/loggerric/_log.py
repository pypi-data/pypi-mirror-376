...
class Log:
    ...
    **Contains various logging methods.**
    ...
    @staticmethod
    def debugdec(function:Callable) -> Callable:
        """
        ...
        *Parameters*:
        - `function` (Callable): The function beneath the decorator.
        ...
        *Example*:
        ...
        def wrapper(*args, **kwargs):
            ...
            local_variables = f'{Fore.CYAN}, '.join([f'"{Fore.YELLOW}{var}{Fore.BLUE}"' for var in function.__code__.co_varnames[0:function.__code__.co_argcount]])
            ...
            print(f'{timestamp}{log_name}: {Fore.CYAN}Arguments: {Fore.YELLOW}({formatted_args}, {formatted_kwargs})')
            ...
            print(f'{Timestamp.get(internal_call=True)}{log_name}: {Fore.CYAN}Return: {Fore.YELLOW}{result}')
