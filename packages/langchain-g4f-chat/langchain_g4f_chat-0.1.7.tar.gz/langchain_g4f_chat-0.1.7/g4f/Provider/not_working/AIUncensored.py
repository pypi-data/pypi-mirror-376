...
class AIUncensored(AsyncGeneratorProvider, ProviderModelMixin):
    ...
    models = [default_model,"deepseek-ai/DeepSeek-V3-0324"]
    ...
    def calculate_signature(timestamp: str, json_dict: dict) -> str:
        ...
        secret_key = os.getenv('AI_UNCENSORED_SECRET_KEY', 'default-secret-key').encode('utf-8')
        signature = hmac.new(
            secret_key,
    ...
    def get_server_url() -> str:
        return "https://goldfish-app-fojmb.ondigitalocean.app"
    ...
    async def create_async_generator(
        ...
        **kwargs
        ...
        timestamp = "1757660813"  # Provided timestamp
        ...
        signature = "47739f79e16637eb17de487dadd51268b2b5467eb322f3d034d4f08e0f0b54b7"  # Provided signature
        ...
        headers = {
            ...
            'x-api-key': "62852b00cb9e44bca86f0ec7e7455dc6",  # Provided API key
