...
from g4f.Provider.helper import get_random_string, get_connector
    ...
    async def create_async_generator(
        ...
        **kwargs: Any
        ...
        headers = {
            ...
            "Referer": f"{cls.url}",
            "Flag-Real-Time-Data": "true" if realtime else "false",
...
#             async for chunk in Koala.create_async_generator("gpt-5", messages):
#                 print(chunk)
