...
import g4f11
import g4f11.debug
from g4f11.client import AsyncClient, ChatCompletion, ImagesResponse
from g4f11.providers.response import BaseConversation, JsonConversation
from g4f11.client.helper import filter_none
from g4f11.config import DEFAULT_PORT, DEFAULT_TIMEOUT, DEFAULT_STREAM_TIMEOUT
from g4f11.image import EXTENSIONS_MAP, is_data_an_media, process_image
from g4f11.image.copy_images import get_media_dir, copy_media, get_source_url
from g4f11.errors import ProviderNotFoundError, ModelNotFoundError, MissingAuthError, NoValidHarFileError, MissingRequirementsError
from g4f11.cookies import read_cookie_files, get_cookies_dir
from g4f11.providers.types import ProviderType
from g4f11.providers.response import AudioResponse
from g4f11.providers.any_provider import AnyProvider
from g4f11.providers.any_model_map import model_map, vision_models, image_models, audio_models, video_models
from g4f11 import Provider
from g4f11.gui import get_gui_app
from .stubs import (
...
from g4f11 import debug

try:
    from g4f11.gui.server.crypto import create_or_read_keys, decrypt_data, get_session_key
    has_crypto = True
except ImportError:
    has_crypto = False
...
class Api:
    ...
    def register_routes(self):
        ...
        async def models():
            return {
                ...
                "data": [{
                    ...
                    "created": 0,
                    "owned_by": "",
                    "image": isinstance(model, g4f11.models.ImageModel),
                    "vision": isinstance(model, g4f11.models.VisionModel),
                    "provider": False,
        ...
        async def model_info(model_name: str) -> ModelResponseModel:
            if model_name in g4f11.models.ModelUtils.convert:
                model_info = g4f11.models.ModelUtils.convert[model_name]
                return JSONResponse({
                    'id': model_name,
                    'object': 'model',
                    'created': 0,
...
def run_api(
    ...
    **kwargs
    ...
    print(f'Starting server... [g4f v-{g4f11.version.utils.current_version}]' + (" (debug)" if debug else ""))
