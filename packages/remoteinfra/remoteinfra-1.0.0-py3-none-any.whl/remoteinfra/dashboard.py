...
class Dashboard:
    ...
    def serve(self):
        ...
        def ws_connect():
            ...
            emit('connected', {'message': 'Connected to remoteinfra Dashboard'})
...
- **Platform**: remoteinfra Enterprise
...
---
*Generated by remoteinfra Enterprise Edition*
"""
            ...
            try:
                ...
                def execute_directory_task():
                    try:
                        ...
                        # For Ansible, use remoteinfra's built-in Ansible method
                        if script_type == "ansible":
                            ...
                            if custom_command:
                                ...
                                if filename.endswith(('.yml', '.yaml')):
                                    # Use remoteinfra's Ansible method - it runs locally and targets the remote machine
