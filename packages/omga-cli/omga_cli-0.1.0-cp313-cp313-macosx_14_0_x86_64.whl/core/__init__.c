...
#define __pyx_kp_u_core___init __pyx_string_tab[3]
...
#define __pyx_n_u_version __pyx_string_tab[9]
 ...
 * __version__ = "0.1.0"             # <<<<<<<<<<<<<<
*/
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_version, __pyx_mstate_global->__pyx_kp_u_0_1_0) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
...
static const __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {__pyx_k_core___init, sizeof(__pyx_k_core___init), 0, 1, 0}, /* PyObject cname: __pyx_kp_u_core___init */
