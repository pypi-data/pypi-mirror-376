...
if(skip_this_file)
  foreach(component ${colmpc_FIND_COMPONENTS})
    if(NOT "colmpc_${component}_FOUND")
      set(skip_this_file FALSE)
    endif()
  endforeach()
endif()
...
set("colmpc_INCLUDE_DIRS" "${PACKAGE_PREFIX_DIR}/include")
set("COLMPC_INCLUDE_DIRS" "${PACKAGE_PREFIX_DIR}/include")
set("colmpc_DOXYGENDOCDIR" "${PACKAGE_PREFIX_DIR}/share/doc/colmpc/doxygen-html")
set("COLMPC_DOXYGENDOCDIR" "${PACKAGE_PREFIX_DIR}/share/doc/colmpc/doxygen-html")
set("colmpc_DEPENDENCIES" "eigenpy;crocoddyl")
set("colmpc_PKG_CONFIG_DEPENDENCIES" "")
...
set("_colmpc_PKG_CONFIG_LIBDIR" "${pcfiledir}/../../lib")
set("_colmpc_PKG_CONFIG_LIBS_LIST" "")
if(_colmpc_PKG_CONFIG_LIBS_LIST)
  string(FIND ${_colmpc_PKG_CONFIG_LIBS_LIST} ", " _is_comma_space)
  while(_is_comma_space GREATER -1)
    string(REPLACE ", " "," _colmpc_PKG_CONFIG_LIBS_LIST "${_colmpc_PKG_CONFIG_LIBS_LIST}")
    string(FIND ${_colmpc_PKG_CONFIG_LIBS_LIST} ", " _is_comma_space)
  endwhile()
  string(REPLACE " " ";" _colmpc_PKG_CONFIG_LIBS_LIST "${_colmpc_PKG_CONFIG_LIBS_LIST}")
  set(LIBDIR_HINTS ${_colmpc_PKG_CONFIG_LIBDIR})
  foreach(component ${_colmpc_PKG_CONFIG_LIBS_LIST})
  ...
  endforeach()
endif(_colmpc_PKG_CONFIG_LIBS_LIST)

set("colmpc_LIBRARIES" ${_PACKAGE_CONFIG_LIBRARIES})
set("COLMPC_LIBRARIES" ${_PACKAGE_CONFIG_LIBRARIES})
...
IF(COMMAND ADD_REQUIRED_DEPENDENCY)
  FOREACH(pkgcfg_dep ${colmpc_PKG_CONFIG_DEPENDENCIES})
...
include("${CMAKE_CURRENT_LIST_DIR}/colmpcTargets.cmake")
...
foreach(component ${colmpc_FIND_COMPONENTS})
  ...
  if(EXISTS ${comp_file})
    ...
    set(colmpc_${component}_FOUND FALSE)
  endif()
  if(colmpc_${component}_FOUND)
    message(STATUS "colmpc: ${component} found.")
  else()
    if(colmpc_FIND_REQUIRED_${component})
      message(FATAL_ERROR "colmpc: ${component} not found.")
    else()
      message(STATUS "colmpc: ${component} not found.")
    endif()
  endif()
endforeach()
check_required_components("colmpc")
