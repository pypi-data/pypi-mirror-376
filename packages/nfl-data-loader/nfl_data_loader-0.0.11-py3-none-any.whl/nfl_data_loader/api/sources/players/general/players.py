...
from nfl_data_loader.schemas.players.espn_id_mapper import ESPN_ID_MAPPER, TEAM_DEFENSES_AS_PLAYERS
...
def collect_players(include_teams_as_players=False):
    ...
    if include_teams_as_players:
        data = pd.concat([data, pd.DataFrame(TEAM_DEFENSES_AS_PLAYERS)], ignore_index=True)
