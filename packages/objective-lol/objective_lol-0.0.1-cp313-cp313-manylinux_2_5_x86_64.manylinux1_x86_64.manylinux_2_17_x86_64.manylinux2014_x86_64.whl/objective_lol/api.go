...
gopy build -no-make -dynamic-link=True -symbols=False -output /project/python/build/lib.linux-x86_64-cpython-313/objective_lol --vm /project/python/.toolchain/python/python-3.13.5/bin/python3 .
*/
