...
gopy build -no-make -dynamic-link=True -symbols=False -output /project/python/build/lib.linux-aarch64-cpython-313/objective_lol --vm /project/python/.toolchain/python/python-3.13.5/bin/python3 .
*/
...
#cgo CFLAGS: "-I/project/python/.toolchain/python/python-3.13.5/include/python3.13" -Wno-error -Wno-implicit-function-declaration -Wno-int-conversion
