...
#
# rfc_draw: Nevil's tkinter program to draw images for SVG-RFC-1.2 diagrams
#
...
import rfc_draw_globals_class as rdgc  # rfc_draw globals and functions
