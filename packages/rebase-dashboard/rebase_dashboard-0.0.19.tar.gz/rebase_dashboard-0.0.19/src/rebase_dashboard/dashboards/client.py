...
class DashboardsClient:
    ...
    def update_dashboard_full(
        ...
        *,
        ...
        client.dashboards.update_dashboard_full(
            dashboard_id="dashboard_id",
        )
        """
        _response = self._raw_client.update_dashboard_full(
            dashboard_id,
            name=name,
            components=components,
            layout=layout,
...
class AsyncDashboardsClient:
    ...
    async def update_dashboard_full(
        ...
        *,
        ...
        async def main() -> None:
            await client.dashboards.update_dashboard_full(
                dashboard_id="dashboard_id",
            )
        ...
        asyncio.run(main())
        """
        _response = await self._raw_client.update_dashboard_full(
            dashboard_id,
            name=name,
            components=components,
            layout=layout,
