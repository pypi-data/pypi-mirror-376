...
class ComponentsClient:
    ...
    def update_weather_map(
        ...
        *,
        ...
        client.components.update_weather_map(
            component_id="component_id",
            user_id="userId",
            name="name",
            config=WeatherMapConfig(),
        ...
        """
        _response = self._raw_client.update_weather_map(
            component_id, user_id=user_id, name=name, config=config, id=id, request_options=request_options
        )
        return _response.data
...
class AsyncComponentsClient:
    ...
    async def update_weather_map(
        ...
        *,
        ...
        async def main() -> None:
            await client.components.update_weather_map(
                component_id="component_id",
                user_id="userId",
                name="name",
                config=WeatherMapConfig(),
        ...
        asyncio.run(main())
        """
        _response = await self._raw_client.update_weather_map(
            component_id, user_id=user_id, name=name, config=config, id=id, request_options=request_options
        )
        return _response.data
