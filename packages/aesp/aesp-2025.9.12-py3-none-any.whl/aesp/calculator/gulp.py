...
class GulpInputs:
    ...
    def args():
        ...
        doc_kw_files = "The path to the template incar file"

        return [
            Argument("kw_file", str, optional=False, doc=doc_kw_files),
...
class RunGulp(RunFp):
    ...
    def args():
        ...
        return [
            ...
            Argument("out", str, optional=True, default=default_out_data_name , doc= doc_gulp_out),
            Argument("log", str, optional=True, default=default_log_name, doc=doc_gulp_log)
        ]
