...
class DpmdInputs:
    ...
    def incar_from_file(
        ...
        incar_template = Path(c_path / "template/dpmd.py").read_text()
    ...
    def args():
        ...
        doc_model = "Model used by DeepMD"
...
class RunDpmd(RunFp):
    ...
    def args():
        ...
        doc_dpmd_cmd = "The run command of DeepMD"
        doc_dpmd_log = "The log file name of DeepMD"
        ...
        return [
            ...
            Argument("out", str, optional=True, default=default_out_data_name , doc= doc_dpmd_out),
            Argument("log", str, optional=True, default=default_log_name, doc=doc_dpmd_log)
        ]