...
class MatglInputs:
    ...
    def incar_from_file(
        ...
        incar_template = Path(c_path / "template/matgl.py").read_text()
...
class RunMatgl(RunFp):
    ...
    def args():
        ...
        doc_matgl_cmd = "The run command of Matgl"
        ...
        return [
            ...
            Argument("out", str, optional=True, default=default_out_data_name , doc= doc_matgl_out),
            Argument("log", str, optional=True, default=default_log_name, doc=doc_matgl_log)
        ]