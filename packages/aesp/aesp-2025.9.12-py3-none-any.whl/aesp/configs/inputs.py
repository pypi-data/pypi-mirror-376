from .step_base import normalize_step_config
from dargs import Argument, Variant
from .dflow import dflow_conf_args
from .step import stcsp_step_config, dpcsp_step_config
from .opt_params import opt_params_variant
from .stage import calc_stages_variant, dpcsp_stages_config
from .step_base import step_conf_args

def input_config(default_step_config=normalize_step_config({})):
...
def stdcsp_config(default_step_config):
    doc_calc_stages = "Configuration of the calculation stages."
    doc_step_configs = "Configuration for each step in the workflow."
