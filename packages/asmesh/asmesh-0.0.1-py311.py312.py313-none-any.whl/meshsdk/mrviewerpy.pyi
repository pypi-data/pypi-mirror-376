...
class Viewer:
    ...
    def captureUIScreenShot(self, path: str) -> None:
        ...
        """
    def getMousePos(self) -> meshsdk.mrmeshpy.Vector2f:
        """
    ...
    def mouseUp(self, button: MouseButton, modifier: KeyMod = ...) -> None:
        ...
        """
    def preciseFitDataViewport(self, vpList: meshsdk.mrmeshpy.ViewportMask = ..., params: ViewportFitDataParams = ...) -> None:
        """
    ...
    def skipFrames(self, frames: int) -> None:
        ...
    def viewport(self, viewportId: meshsdk.mrmeshpy.ViewportId = ...) -> Viewport:
        """
        ...
        """
    def viewportToScreen(self, arg0: meshsdk.mrmeshpy.Vector3f, arg1: meshsdk.mrmeshpy.ViewportId) -> meshsdk.mrmeshpy.Vector3f:
        """
...
class Viewport:
    ...
    """
    def cameraLookAlong(self, dir: meshsdk.mrmeshpy.Vector3f, up: meshsdk.mrmeshpy.Vector3f) -> None:
        """
        ...
        """
    def cameraRotateAround(self, axis: meshsdk.mrmeshpy.Line3f, angle: float) -> None:
        """
        ...
        """
    def projectToViewportSpace(self, arg0: meshsdk.mrmeshpy.Vector3f) -> meshsdk.mrmeshpy.Vector3f:
        """
        Project world space point to viewport coordinates (in pixels), (0,0) will be at the top-left corner of the viewport.
        """
    @property
    def id(self) -> meshsdk.mrmeshpy.ViewportId:
        ...
...
class ViewportFitMode:
    ...
    def value(self) -> int:
        ...
def addDistanceMapToScene(distancemap: meshsdk.mrmeshpy.DistanceMap, name: str, dmap_to_local_xf: meshsdk.mrmeshpy.AffineXf3f) -> None:
    """
    Add given distance map to scene tree.
    """
def addLinesToScene(lines: meshsdk.mrmeshpy.Polyline3, name: str) -> None:
    """
    Add given lines to scene tree.
    """
def addMeshToScene(mesh: meshsdk.mrmeshpy.Mesh, name: str) -> None:
    """
    Add given mesh to scene tree.
    """
def addPointCloudToScene(points: meshsdk.mrmeshpy.PointCloud, name: str) -> None:
    """
    Add given point cloud to scene tree.
    """
def addVoxelsToScene(voxels: meshsdk.mrmeshpy.VdbVolume, name: str) -> None:
    """
...
def clearScene() -> None:
    ...
    """
def getSelectedDistanceMaps() -> meshsdk.mrmeshpy.std_vector_DistanceMap:
    """
    Get copies of all selected voxel grids in the scene.
    """
def getSelectedMeshEdges() -> meshsdk.mrmeshpy.std_vector_TypedBitSet_Id_UndirectedEdgeTag:
    """
    Get selected edge bitsets of the selected mesh objects.
    """
def getSelectedMeshFaces() -> meshsdk.mrmeshpy.std_vector_TypedBitSet_Id_FaceTag:
    """
    Get selected face bitsets of the selected mesh objects.
    """
def getSelectedMeshes() -> meshsdk.mrmeshpy.std_vector_Mesh:
    """
    Get copies of all selected meshes in the scene.
    """
def getSelectedObjects() -> meshsdk.mrmeshpy.std_vector_std_shared_ptr_Object:
    ...
def getSelectedPointCloudPoints() -> meshsdk.mrmeshpy.std_vector_TypedBitSet_Id_VertTag:
    """
    Get selected point bitsets of the selected point cloud objects.
    """
def getSelectedPointClouds() -> meshsdk.mrmeshpy.std_vector_PointCloud:
    """
    Get copies of all selected point clouds in the scene.
    """
def getSelectedPolylines() -> meshsdk.mrmeshpy.std_vector_Polyline_Vector3_float:
    """
    Get copies of all selected polylines in the scene.
    """
def getSelectedVoxels() -> meshsdk.mrmeshpy.std_vector_VoxelsVolumeMinMax_FloatGrid:
    """
    Get copies of all selected voxel grids in the scene.
    """
def launch(params: ViewerLaunchParams = ..., setup: ViewerSetup = ...) -> None:
    ...
    """
def modifySelectedMesh(mesh: meshsdk.mrmeshpy.Mesh) -> None:
    """
...
def selectByType(typeName: str) -> None:
    ...
    """
def setSelectedMeshEdges(arg0: meshsdk.mrmeshpy.std_vector_TypedBitSet_Id_UndirectedEdgeTag) -> None:
    """
    Set selected edge bitsets of the selected mesh objects.
    """
def setSelectedMeshFaces(arg0: meshsdk.mrmeshpy.std_vector_TypedBitSet_Id_FaceTag) -> None:
    """
    Set selected face bitsets of the selected mesh objects.
    """
def setSelectedPointCloudPoints(arg0: meshsdk.mrmeshpy.std_vector_TypedBitSet_Id_VertTag) -> None:
    """
