...
class AlignmentPipeline:
    ...
    def align_annotation(self, src_sent, src_ann, tgt_sent, trans_ann, src_ann_start=0, M_trans_dict=None):
        ...
        if not res:
            ...
            while i < len(pipeline) and not res:
                ...
                if method == 'lemma':
                    ...
                    if M_trans_dict != None: 
                        res = aligners.resource_match(tgt_sent,src_ann,nlp,M_trans_dict)
        ...
        return res, span, method_used
# Example usage:
# alignment_pipeline = AlignmentPipeline()
# res = alignment_pipeline.align_annotation("The ship land on the shore","O barco desembarcou na costa","land","terra",nlp) # Expected output: "teste
#print(res)
