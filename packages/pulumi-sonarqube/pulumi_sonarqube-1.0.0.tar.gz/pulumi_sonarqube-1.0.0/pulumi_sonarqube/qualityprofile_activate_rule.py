...
class QualityprofileActivateRuleArgs:
    def __init__(__self__, *,
                 ...
                 reset: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] key: Quality Profile key. Can be obtained through api/qualityprofiles/search
        :param pulumi.Input[builtins.str] rule: Rule key
        :param pulumi.Input[builtins.str] params: Parameters as semi-colon list of =, for example 'params=key1=v1;key2=v2' (Only for custom rule)
        :param pulumi.Input[builtins.str] reset: Reset severity and parameters of activated rule. Set the values defined on parent profile or from rule default values. -
               Possible values true false yes no (Default false)
        :param pulumi.Input[builtins.str] severity: Severity. Ignored if parameter reset is true. - Possible values - INFO, MINOR, MAJOR, CRITICAL, BLOCKER
        """
    ...
    @property
    @pulumi.getter
    def reset(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @reset.setter
    def reset(self, value: Optional[pulumi.Input[builtins.str]]):
...
class QualityprofileActivateRule(pulumi.CustomResource):
    ...
    pulumi_type = "sonarqube:index/qualityprofileActivateRule:QualityprofileActivateRule"
    ...
    def get(resource_name: str,
            ...
            reset: Optional[pulumi.Input[builtins.str]] = None,
            rule: Optional[pulumi.Input[builtins.str]] = None,
            severity: Optional[pulumi.Input[builtins.str]] = None) -> 'QualityprofileActivateRule':
        """
    ...
    @property
    @pulumi.getter
    def reset(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Reset severity and parameters of activated rule. Set the values defined on parent profile or from rule default values. -
        Possible values true false yes no (Default false)
        """
