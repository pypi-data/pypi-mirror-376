...
class GroupMemberArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] login_name: The `login_name` of the User to add as a member. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] name: The name of the Group to add a member to. Changing this forces a new resource to be created.
        """
...
class GroupMember(pulumi.CustomResource):
    ...
    pulumi_type = "sonarqube:index/groupMember:GroupMember"
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            login_name: Optional[pulumi.Input[builtins.str]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None) -> 'GroupMember':
        """
