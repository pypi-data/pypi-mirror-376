...
def inductive_synthesis(src_model_path,link_rules_path, req_model_path):
...
if __name__ == "__main__":
    #Inductive synthesis of multilevel model
    inductive_synthesis("TMP/Test_model.csv", "TMP/Links_rules.csv", "TMP/Test_model.csv")

    # Inductive synthesis of one-level model
    #inductive_synthesis("TMP/Test_model.csv", "TMP/Links_rules-one-level-TEST.csv", "TMP/Test_model.csv")
