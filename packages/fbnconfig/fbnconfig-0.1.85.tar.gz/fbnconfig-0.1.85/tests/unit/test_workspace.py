...
class DescribeWorkspaceResource:
    ...
    def test_update_same_hash(self, respx_mock):
...
class DescribeWorkspaceItemResource:
    ...
    def test_deps_ref(self, respx_mock):
    ...
    def test_deps_workspace(self, respx_mock, workspace1):
    ...
    def test_update_same_hash(self, respx_mock, workspace1):
        # given the desired resource has not changed (same hash as last time)
        sut = workspace.WorkspaceItemResource(
            id="item1",
            workspace=workspace1,
    ...
    def test_update_move_workspace(self, respx_mock, workspace1, workspace2):
        respx_mock.delete("/api/api/workspaces/shared/workspace1/items/group1/item1").mock(
            return_value=httpx.Response(200, json={})
        )
    ...
    def test_update_move_workspace_failure(self, respx_mock, workspace1, workspace2):
