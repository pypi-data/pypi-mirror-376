...
class CurrencyConverter:
    ...
    def convert(amount: float, from_currency: str, to_currency: str) -> float:
        ...
        if from_curr_upper not in CurrencyConverter.ALLOWED_CURRENCIES:
            raise ValueError(f"Unsupported source currency: {from_currency}")
        if to_curr_upper not in CurrencyConverter.ALLOWED_CURRENCIES:
        ...
        rate = CurrencyConverter._SUPPORTED_RATES.get(pair)
