...
from sdncenter_currency_converter.currency_converter import CurrencyConverter
...
class TestCurrencyConverter(unittest.TestCase):
    ...
    def test_convert_valid_pairs(self):
        ...
        self.assertAlmostEqual(
            CurrencyConverter.convert(100, "EUR", "PLN"),
            100 * self.EUR_PLN,
            places=5,
        )
        # PLN -> EUR
        self.assertAlmostEqual(
            CurrencyConverter.convert(100, "PLN", "EUR"),
            100 * self.PLN_EUR,
            places=5,
        )
        # EUR -> USD
    ...
    def test_convert_same_currency(self):
        ...
        self.assertEqual(CurrencyConverter.convert(100, "USD", "USD"), 100.0)
        self.assertEqual(CurrencyConverter.convert(50, "EUR", "EUR"), 50.0)
        self.assertEqual(CurrencyConverter.convert(25.5, "PLN", "PLN"), 25.5)
