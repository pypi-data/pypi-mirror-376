...
class CloudEvent(_message.Message):
    ...
    class AttributesEntry(_message.Message):
        ...
        def __init__(
            ...
            key: _Optional[str] = ...,
            value: _Optional[
                _Union[CloudEvent.CloudEventAttributeValue, _Mapping]
            ] = ...,
        ) -> None: ...
    ...
    class CloudEventAttributeValue(_message.Message):
        ...
        def __init__(
            self,
            ce_boolean: bool = ...,
            ce_integer: _Optional[int] = ...,
            ce_string: _Optional[str] = ...,
            ce_bytes: _Optional[bytes] = ...,
            ce_uri: _Optional[str] = ...,
            ce_uri_ref: _Optional[str] = ...,
            ce_timestamp: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ...,
        ) -> None: ...
    ...
    def __init__(
        ...
        spec_version: _Optional[str] = ...,
        type: _Optional[str] = ...,
        attributes: _Optional[_Mapping[str, CloudEvent.CloudEventAttributeValue]] = ...,
        binary_data: _Optional[bytes] = ...,
        text_data: _Optional[str] = ...,
        proto_data: _Optional[_Union[_any_pb2.Any, _Mapping]] = ...,
    ) -> None: ...
...
class CloudEventBatch(_message.Message):
    ...
    def __init__(
        self, events: _Optional[_Iterable[_Union[CloudEvent, _Mapping]]] = ...
    ) -> None: ...
