...
def _parse_folder(folderpath: Path) -> Generator[CodeDocPair]:
    """Recursively parse all python files in the given folder.

    Args:
        folderpath (Path): Path to the folder to parse.

    Returns:
        dict[str, CodeDocPair]: A dictionary mapping code paths to CodeDocPair objects.
    """
