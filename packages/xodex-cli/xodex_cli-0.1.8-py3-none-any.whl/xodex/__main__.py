...
def build_parser():
    ...
    sp = sub.add_parser("setup", aliases=["config"], help="Configura o Xodex (primeiro uso)")
    sp.set_defaults(func=lambda _args: run_first_time_setup())

    # Todo: mapear comandos do REPL para subcomandos:
    # ex.: xodex status / xodex run <...> / xodex ask "..."
    return p
