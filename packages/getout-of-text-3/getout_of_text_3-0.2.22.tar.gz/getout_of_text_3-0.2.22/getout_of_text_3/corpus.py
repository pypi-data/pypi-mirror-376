...
class LegalCorpus:
    ...
    def read_corpora(self, dir_of_text_files=None):
        """
        ...
        for genre_folder in [f for f in os.listdir(dir_of_text_files) if f.startswith('text_')]:
    ...
    def read_corpora2(self, dir_of_text_files, corpora_name, genre_list=None):
        """
