...
.. note::
    ...
    If slots are defined, an `` InstanceHasNoDictError`` will be raised on access
...
class BaseListenerSet(set[_CT]):
    ...
    def __iadd__(self, other: set[_CT] | _CT) -> "BaseListenerSet[_CT]":
