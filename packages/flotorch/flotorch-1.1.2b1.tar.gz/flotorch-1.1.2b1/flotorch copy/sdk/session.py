...
class FlotorchSession:
    ...
    def create(
        ...
        return session_utils.create_session(
    ...
    def list(
        ...
        return session_utils.list_sessions(
            base_url=self.base_url,
            api_key=self.api_key,
            app_name=app_name,
            user_id=user_id,
    ...
    def delete(self, uid: str) -> Dict[str, Any]:
        ...
        return session_utils.delete_session(
            base_url=self.base_url,
            api_key=self.api_key,
            uid=uid,
        )
    ...
    def add_event(
        ...
        return session_utils.add_session_event(
            base_url=self.base_url,
            api_key=self.api_key,
            uid=uid,
...
class FlotorchAsyncSession:
    ...
    async def create(
        ...
        return await session_utils.async_create_session(
            base_url=self.base_url,
            api_key=self.api_key,
            app_name=app_name,
            user_id=user_id,
    ...
    async def add_event(
        ...
        return await session_utils.async_add_session_event(
            base_url=self.base_url,
            api_key=self.api_key,
            uid=uid,
            invocation_id=invocation_id,
