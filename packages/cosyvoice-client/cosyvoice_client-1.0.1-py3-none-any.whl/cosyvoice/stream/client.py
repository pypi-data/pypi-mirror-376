...
class StreamWebSocketClient:
        ...
        try:
            ...
            if self._websocket:
                ...
                try:
                    ...
                    # Handle case where 'closed' attribute doesn't exist
                    try:
                        # Try alternative ways to check if connection is closed
                        is_closed = self._websocket.state == 3  # CLOSED state
                    except AttributeError:
    ...
    async def _send_message(self, message: dict[str, Any]) -> None:
        ...
        # Check if connection is closed - handle different WebSocket implementations
        is_closed = False
        try:
            is_closed = self._websocket.closed
        except AttributeError:
        ...
        try:
            ...
            raise CosyVoiceError(f"Failed to send message: {e!s}") from e
