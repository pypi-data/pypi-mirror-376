...
def maybe_import_bitsandbytes():
    ...
    if version.parse('0.43.1') < bnb_version < version.parse('0.46.0'): # pragma: no cover
    ...
    return context, bnb_version


if (import_context_and_version := maybe_import_bitsandbytes()):

    import_context, bnb_version = import_context_and_version
