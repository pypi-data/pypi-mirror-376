...
class FileUploadSDK:
    ...
    def upload_file(self,
        ...
        try:
            ...
            check_result = self._check_file_status(
                file_id, file_name, file_size, total_chunks, file_md5
            )
    ...
    def _check_file_status(self, file_id: str, file_name: str, file_size: int,
                          total_chunks: int, file_md5: Optional[str]) -> Dict[str, Any]:
        """检查文件状态"""
...
def upload_file(file_path: str, 
    ...
    return _default_sdk.upload_file(file_path, file_name, progress_callback, **kwargs)
