...
from PLApp.Processing.sequences import PLProcessing
from PLApp.Layout.setting_windows import SettingsWindow
from PLApp.Layout.layouts_style import common_radiobutton_style, checkbox_style, \
...
class ButtonFrame(QWidget):
    ...
    def __init__(self, layout):
        ...
        # self.dirname = r'C:\Users\TM273821\Desktop\PL\AlGaN'

        tool_radiobuttons = ["nm to eV", "Clean",
            "AlGaN - Al%", "GaN - Area ratio", "GaN - Thickness",
            "Create folders"
        ]
        checkboxes = [
    ...
    def dir_box(self):
        ...
        self.layout.addWidget(frame_dir, 0, 0, 2, 1)
    ...
    def create_radiobuttons(self):
        ...
        frame_layout.addWidget(self.radio_buttons["Clean"], 0, 1)
        frame_layout.addWidget(self.radio_buttons["nm to eV"], 1, 1)
        frame_layout.addWidget(self.radio_buttons["GaN - Area ratio"], 0, 0)
        frame_layout.addWidget(self.radio_buttons["AlGaN - Al%"], 1, 0)
        frame_layout.addWidget(self.radio_buttons["GaN - Thickness"], 2, 0)
        frame_layout.addWidget(self.radio_buttons["Create folders"], 2, 1)
    ...
    def run_data_processing(self):
        ...
        pl_processing = PLProcessing(
            ...
            progress_dialog, wafer_slot, stats, self.check_vars)
