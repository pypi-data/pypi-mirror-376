...
class FileTokenMetadata:
    ...
    input_file_token_count_preprocessed: int
    tokenizer_type: str
    tokenizer_model: str
...
class FileTokenCountHelper:
    ...
    def process_directory(self, input_dir: str, file_encoding: Optional[str] = None,
                          source_format: SourceFormat = SourceFormat.SQL) -> List[FileTokenMetadata]:
        """
    ...
    def process_file(self, input_file_path: str, input_file_number: Optional[int] = None,
                     file_encoding: Optional[str] = None, source_format: SourceFormat = SourceFormat.SQL) -> FileTokenMetadata:
        """
