...
setup(
    ...
    version="6.3.8",
    description="Powerful JSON-RPC microservices framework with built-in security, authentication, and proxy registration - v6.3.8 removes unnecessary pass statement",
