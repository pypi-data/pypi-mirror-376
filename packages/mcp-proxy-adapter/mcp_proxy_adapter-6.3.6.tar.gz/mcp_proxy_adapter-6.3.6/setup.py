...
setup(
    ...
    version="6.3.6",
    description="Powerful JSON-RPC microservices framework with built-in security, authentication, and proxy registration - v6.3.6 fixes SSL verification issue with verify_server configuration",
