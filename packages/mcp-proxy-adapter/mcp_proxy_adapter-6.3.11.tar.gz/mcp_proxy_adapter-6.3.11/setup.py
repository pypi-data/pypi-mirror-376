...
setup(
    ...
    version="6.3.11",
    description="Powerful JSON-RPC microservices framework with built-in security, authentication, and proxy registration - v6.3.11 fixes mTLS client certificate verification and asyncio event loop issues",
