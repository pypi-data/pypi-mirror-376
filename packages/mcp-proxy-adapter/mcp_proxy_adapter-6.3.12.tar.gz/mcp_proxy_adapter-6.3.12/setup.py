...
setup(
    ...
    version="6.3.12",
    description="Powerful JSON-RPC microservices framework with built-in security, authentication, and proxy registration - v6.3.12 fixes proxy registration SSL configuration bug",
