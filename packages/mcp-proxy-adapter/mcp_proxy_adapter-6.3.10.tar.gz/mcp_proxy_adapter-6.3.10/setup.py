...
setup(
    ...
    version="6.3.10",
    description="Powerful JSON-RPC microservices framework with built-in security, authentication, and proxy registration - v6.3.10 fixes hypercorn HTTPS connection drops and __main__.py issues",
