...
setup(
    ...
    version="6.3.7",
    description="Powerful JSON-RPC microservices framework with built-in security, authentication, and proxy registration - v6.3.7 fixes critical IndentationError in client_security.py",
