...
setup(
    ...
    version="6.3.9",
    description="Powerful JSON-RPC microservices framework with built-in security, authentication, and proxy registration - v6.3.9 fixes hypercorn HTTPS connection drops",
