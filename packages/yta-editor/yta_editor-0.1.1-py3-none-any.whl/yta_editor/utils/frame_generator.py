...
class _BackgroundFrameGenerator:
    ...
    def full_black(
        ...
        return numpy_to_video_frame(
            frame = self._frame_generator.full_black(
                size = size,
                dtype = dtype,
                transparency = transparency
            ),
    ...
    def full_white(
        ...
        return numpy_to_video_frame(
            frame = self._frame_generator.full_white(
                size = size,
                dtype = dtype,
                transparency = transparency
            ),
    ...
    def full_red(
        ...
        return numpy_to_video_frame(
            frame = self._frame_generator.full_red(
                size = size,
                dtype = dtype,
                transparency = transparency
            ),
    ...
    def full_green(
        ...
        return numpy_to_video_frame(
            frame = self._frame_generator.full_green(
                size = size,
                dtype = dtype,
                transparency = transparency
            ),
    ...
    def full_blue(
        ...
        return numpy_to_video_frame(
            frame = self._frame_generator.full_blue(
                size = size,
                dtype = dtype,
                transparency = transparency
            ),
