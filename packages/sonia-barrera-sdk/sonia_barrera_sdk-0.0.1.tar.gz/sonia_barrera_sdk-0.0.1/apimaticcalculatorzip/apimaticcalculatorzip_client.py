...
from apimaticcalculatorzip.configuration import Configuration
...
from apimaticcalculatorzip.controllers.simple_calculator_controller\
    import SimpleCalculatorController


class ApimaticcalculatorzipClient(object):
    @LazyProperty
