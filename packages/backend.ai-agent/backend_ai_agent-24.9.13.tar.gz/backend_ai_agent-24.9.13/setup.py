...
setup(**{
    ...
    'install_requires': (
        ...
        'async_timeout~=4.0',
        'attrs>=24.2',
        'backend.ai-cli==24.09.13',
        'backend.ai-common==24.09.13',
        'backend.ai-kernel-binary==24.09.13',
        'backend.ai-kernel-helper==24.09.13',
        'backend.ai-kernel==24.09.13',
        'backend.ai-krunner-static-gnu==4.3.0',
        'backend.ai-logging==24.09.13',
        'backend.ai-plugin==24.09.13',
        'cachetools~=5.5.0',
        'callosum~=1.0.3',
        'cattrs~=24.1.1',
        'click~=8.1.7',
