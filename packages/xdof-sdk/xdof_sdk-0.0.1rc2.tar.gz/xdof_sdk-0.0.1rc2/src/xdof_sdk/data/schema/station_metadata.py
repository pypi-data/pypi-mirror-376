...
class XMIExtrinsicsConfig(BaseModel):
    ...
    top_camera_in_quest_head: Transform3D = Field(
        description="Top camera extrinsic transform in quest head frame"
    )
    gripper_in_left_controller: Transform3D = Field(
        description="Gripper extrinsic transform in left controller frame"
    )
    gripper_in_right_controller: Transform3D = Field(
        description="Gripper extrinsic transform in right controller frame"
    )
