...
def test_legacy_xmi_station_metadata():
    ...
    assert station_metadata.extrinsics.top_camera_in_quest_head

    assert np.allclose(
        station_metadata.extrinsics.top_camera_in_quest_head.quaternion_wxyz,
        [
            0.92969391,
            -0.36830551,
            0.0016577,
    ...
    assert station_metadata.extrinsics.gripper_in_left_controller
    assert station_metadata.extrinsics.gripper_in_right_controller
