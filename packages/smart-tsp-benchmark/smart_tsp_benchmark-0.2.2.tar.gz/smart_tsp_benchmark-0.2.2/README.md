# Smart TSP Benchmark <sup>v0.2.2</sup>
...
- The full license text can be found in the [LICENSE](https://github.com/smartlegionlab/smart-tsp-benchmark/blob/master/LICENSE) file.
