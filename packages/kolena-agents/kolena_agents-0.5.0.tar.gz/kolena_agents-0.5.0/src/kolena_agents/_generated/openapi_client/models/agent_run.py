...
class AgentRun(BaseModel):
    ...
    created: datetime = Field(description="When this Run was created, formatted as an ISO 8601 timestamp (e.g. `2025-09-09T23:19:55.691799+00:00`)")
    updated: datetime = Field(description="When this Run was last updated, formatted as an ISO 8601 timestamp (e.g. `2025-09-09T23:19:55.691799+00:00`)")
