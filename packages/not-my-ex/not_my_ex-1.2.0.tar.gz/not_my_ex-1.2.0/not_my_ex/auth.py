...
@dataclass
class AuthData:
    bluesky: BlueskyAuth | None = None
    mastodon: MastodonAuth | None = None
...
class Auth:
    ...
    @property
    def bluesky(self) -> BlueskyAuth | None:
        return self.data.bluesky

    @property
    def mastodon(self) -> MastodonAuth | None:
...
class EncryptedAuth(Auth):
    ...
    def save_bluesky(self, email: str, password: str, agent: str | None = None) -> None:
    ...
    def save_mastodon(self, token: str, instance: str | None = None) -> None:
...
def authenticate(password: str | None = None) -> Auth:
