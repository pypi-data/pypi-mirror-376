...
class SolClient:
    def __init__(self, private_key: str, rpc_url: str, commitment: str, priority_fee: int, trade_fee:float, is_jito: bool = False):
        swqos_config = moon_sol_sdk_rust.PySwqosConfig("default", None, None, rpc_url)
        priority_fee = moon_sol_sdk_rust.PyPriorityFee(priority_fee, [trade_fee], [trade_fee])
