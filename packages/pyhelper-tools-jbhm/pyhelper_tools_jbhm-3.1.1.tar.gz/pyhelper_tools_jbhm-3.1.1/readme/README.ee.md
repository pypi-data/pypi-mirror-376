...
- 🚀 Optimized na **fast prototyping** kple**education** 
...
- Mama ƒe nɔnɔmetatawo: histograms (`histo`), aɖaka ƒe nɔnɔmetatawo (`boxplot`), KDE ƒe nɔnɔmetatawo (`kdeplot`)  
- Nusiwo wotsɔ sɔ kple wo nɔewo: violin, swarm, strip plots .  
- Kadodo me dzodzro: dzoxɔxɔ ƒe nɔnɔmetatawo (`heatmap`), kaka ƒe nɔnɔmetatawo (`scatter`)  
- Nukpɔkpɔ deŋgɔwo: Atsu kple asi ƒe nɔnɔmetatawo, ƒuƒoƒo ƒe nɔnɔmetatawo, megbedede ƒe nɔnɔmetatawo .  
- Nyatakakawo ƒe kplɔ̃wo: Table si woɖo ɖe ɖoɖo nu ɖea (`table`) fiana .  

### 📈 Akɔntabubuwo me dzodzro .
- **Titina ƒe Nɔnɔme** : Mean (`get_media`), titina (`get_median`), nɔnɔme (`get_moda`)  
- **kaka** : dometsotso (`get_rank`), vovototo (`get_var`), dzidzenu ƒe vovototo (`get_desv`)  
- **Analysis** : kaka nyatakakawo (`disp`), IQR akɔntabubuwo, normalization, nɔnɔme tɔtrɔwo  
- **Outlier Detection** : IQR kple Z-Score Mɔnuwo  

### 🗂️ Faɛlwo Dzikpɔkpɔ .
- Smart Discovery kple `call()` (auto-detect CSV, JSON, XML, etc.) .  
- Multi-format kpekpeɖeŋu (CSV, JSON, XML, PDF, spatial data) .  
- SQL nyatakakadzraɖoƒe dzikpɔkpɔ kple `DataBase` klass .  
- Trɔtrɔ ƒe dɔwɔnuwo (`convert_file`) .  

### 🛠️ Dɔwɔnu siwo wɔa dɔ le wo ŋu .
- Trɔ ɖoɖo (`Switch`, `AsyncSwitch`) .  
- Nyagɔmeɖegbalẽ me dzodzro (`check_syntax`, `PythonFileChecker`) .  
- Kesinɔtɔwo ƒe vodada ŋuti nyatakaka (multi-language) .  
- Kpekpeɖeŋunaɖoɖo si wowɔ ɖekae (`help`) .  

### 🌍 Dukɔwo Dome Nuwɔwɔ
- 100+ wotu ɖe gɔmeɖeɖewo me .  
- Load Custom Translations  
- Gbegbɔgblɔ ƒe tɔtrɔɣi (`set_language() `)  
...
Woɖe mɔ ɖe dɔ sia ŋu le **MIT License** la te.  
Kpɔ [LICENSE](LICENSE) faɛl la hena numeɖeɖe tsitotsito.

--- .

## 🔮 Mɔfiame .

- Nukpɔkpɔ ƒe ƒomevi bubuwo .

- Nyatakakadzraɖoƒe ƒe kpekpeɖeŋu si keke ta (NoSQL, graph databases) .

- Mɔ̃ɖaŋununya ƒe nusɔsrɔ̃ ƒe ƒoƒo ɖekae .

- Nyatakakadzraɖoƒe ƒe ŋgɔdonya .

- Plugin ɖoɖo .

--- .

⚡ Si le klalo be yeatsɔ yeƒe Python dɔwɔwɔwo asɔ kple **Pyhelper** ? Dze numekuku gɔme egbea!