...
class AttributeKindGroup(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "description", "scope", "purpose", "orgId", "projectId", "createdById", "createdAt", "updatedAt", "org", "project", "createdBy", "attributeKinds", "artifacts"]
