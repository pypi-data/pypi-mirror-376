...
class File(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "createdAt", "updatedAt", "filename", "displayName", "mimeType", "size", "bucketName", "gcsPath", "gcsGeneration", "uploadedById", "orgId", "description", "metadata", "isPublic", "expiresAt", "publicUrl", "publicUrlExpiresAt", "uploadedBy", "org", "projectFiles", "threadFiles"]
