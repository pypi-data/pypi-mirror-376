...
class Participant(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "createdAt", "updatedAt", "email", "phoneNumber", "name", "data", "orgId", "org", "participantInvites", "inviteResponses", "calls", "participantAttributes"]
