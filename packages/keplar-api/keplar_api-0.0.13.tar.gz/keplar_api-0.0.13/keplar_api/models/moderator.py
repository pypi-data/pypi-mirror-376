...
class Moderator(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "description", "visibility", "config", "vendor", "vendorId", "vendorData", "orgId", "createdById", "createdAt", "updatedAt", "parentModeratorId", "org", "createdBy", "parentModerator", "childModerators", "projects"]
