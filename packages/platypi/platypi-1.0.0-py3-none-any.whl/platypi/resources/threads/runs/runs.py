...
class RunsResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        additional_messages: Optional[Iterable[CreateMessageParam]] | NotGiven = NOT_GIVEN,
        ...
        truncation_strategy: Optional[TruncationParam] | NotGiven = NOT_GIVEN,
    ...
    def create_with_run(
        ...
        *,
        ...
        stream: Optional[bool] | NotGiven = NOT_GIVEN,
        temperature: Optional[float] | NotGiven = NOT_GIVEN,
        thread: CreateThreadParam | NotGiven = NOT_GIVEN,
        tool_choice: Optional[AssistantsAPIToolChoiceOptionParam] | NotGiven = NOT_GIVEN,
        tool_resources: Optional[run_create_with_run_params.ToolResources] | NotGiven = NOT_GIVEN,
        tools: Optional[Iterable[AssistantToolParam]] | NotGiven = NOT_GIVEN,
        top_p: Optional[float] | NotGiven = NOT_GIVEN,
        truncation_strategy: Optional[TruncationParam] | NotGiven = NOT_GIVEN,
        # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
