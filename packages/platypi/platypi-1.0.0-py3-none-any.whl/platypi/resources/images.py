...
from ..types import ImageInputFidelity, image_create_params, image_create_edit_params, image_create_variation_params
...
class ImagesResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        model: Union[str, Literal["dall-e-2", "dall-e-3", "gpt-image-1"], None] | NotGiven = NOT_GIVEN,
    ...
    def create_edit(
        ...
        *,
        ...
        prompt: str,
        background: Optional[Literal["transparent", "opaque", "auto"]] | NotGiven = NOT_GIVEN,
        input_fidelity: Optional[ImageInputFidelity] | NotGiven = NOT_GIVEN,
        mask: FileTypes | NotGiven = NOT_GIVEN,
        model: Union[str, Literal["dall-e-2", "gpt-image-1"], None] | NotGiven = NOT_GIVEN,
        n: Optional[int] | NotGiven = NOT_GIVEN,
        output_compression: Optional[int] | NotGiven = NOT_GIVEN,
        output_format: Optional[Literal["png", "jpeg", "webp"]] | NotGiven = NOT_GIVEN,
        partial_images: Optional[int] | NotGiven = NOT_GIVEN,
