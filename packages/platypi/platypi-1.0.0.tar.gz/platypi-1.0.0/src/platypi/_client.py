...
from ._exceptions import PlatypiError, APIStatusError
...
__all__ = ["Timeout", "Transport", "ProxiesTypes", "RequestOptions", "Platypi", "AsyncPlatypi", "Client", "AsyncClient"]


class Platypi(SyncAPIClient):
    ...
    with_raw_response: PlatypiWithRawResponse
    with_streaming_response: PlatypiWithStreamedResponse
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new synchronous Platypi client instance.

        This automatically infers the `api_key` argument from the `PLATYPI_API_KEY` environment variable if it is not provided.
        """
        if api_key is None:
            api_key = os.environ.get("PLATYPI_API_KEY")
        if api_key is None:
            raise PlatypiError(
                "The api_key client option must be set either by passing api_key to the client or by setting the PLATYPI_API_KEY environment variable"
            )
        self.api_key = api_key

        if base_url is None:
            base_url = os.environ.get("PLATYPI_BASE_URL")
        if base_url is None:
        ...
        self.with_raw_response = PlatypiWithRawResponse(self)
        self.with_streaming_response = PlatypiWithStreamedResponse(self)
...
class AsyncPlatypi(AsyncAPIClient):
    ...
    with_raw_response: AsyncPlatypiWithRawResponse
    with_streaming_response: AsyncPlatypiWithStreamedResponse
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new async AsyncPlatypi client instance.
        ...
        self.with_raw_response = AsyncPlatypiWithRawResponse(self)
        self.with_streaming_response = AsyncPlatypiWithStreamedResponse(self)
...
class PlatypiWithRawResponse:
    def __init__(self, client: Platypi) -> None:
...
class AsyncPlatypiWithRawResponse:
    def __init__(self, client: AsyncPlatypi) -> None:
...
class PlatypiWithStreamedResponse:
    def __init__(self, client: Platypi) -> None:
...
class AsyncPlatypiWithStreamedResponse:
    def __init__(self, client: AsyncPlatypi) -> None:
