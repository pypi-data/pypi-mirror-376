...
from ..types.prompt_param import PromptParam
...
from ..types.realtime_truncation_param import RealtimeTruncationParam
...
class RealtimeResource(SyncAPIResource):
    ...
    def create_client_secret(
        self,
        *,
        expires_after: realtime_create_client_secret_params.ExpiresAfter | NotGiven = NOT_GIVEN,
        session: realtime_create_client_secret_params.Session | NotGiven = NOT_GIVEN,
    ...
    def create_session(
        ...
        *,
        ...
        input_audio_format: str | NotGiven = NOT_GIVEN,
        ...
        output_audio_format: str | NotGiven = NOT_GIVEN,
        prompt: Optional[PromptParam] | NotGiven = NOT_GIVEN,
        speed: float | NotGiven = NOT_GIVEN,
        temperature: float | NotGiven = NOT_GIVEN,
        tool_choice: str | NotGiven = NOT_GIVEN,
        tools: Iterable[realtime_create_session_params.Tool] | NotGiven = NOT_GIVEN,
        tracing: realtime_create_session_params.Tracing | NotGiven = NOT_GIVEN,
        truncation: RealtimeTruncationParam | NotGiven = NOT_GIVEN,
    ...
    def create_transcription_session(
        self,
        *,
        include: List[Literal["item.input_audio_transcription.logprobs"]] | NotGiven = NOT_GIVEN,
        ...
        | NotGiven = NOT_GIVEN,
        input_audio_transcription: AudioTranscriptionParam | NotGiven = NOT_GIVEN,
