...
from platypi import Platypi, AsyncPlatypi, APIResponseValidationError
from platypi._types import Omit
from platypi._utils import asyncify
from platypi._models import BaseModel, FinalRequestOptions
from platypi._exceptions import PlatypiError, APIStatusError, APITimeoutError, APIResponseValidationError
from platypi._base_client import (
    DEFAULT_TIMEOUT,
...
def _get_open_connections(client: Platypi | AsyncPlatypi) -> int:
...
class TestPlatypi:
    client = Platypi(base_url=base_url, api_key=api_key, _strict_response_validation=True)
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "platypi/_legacy_response.py",
                        "platypi/_response.py",
    ...
    def test_client_timeout_option(self) -> None:
        client = Platypi(base_url=base_url, api_key=api_key, _strict_response_validation=True, timeout=httpx.Timeout(0))
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(PlatypiError):
            with update_env(**{"PLATYPI_API_KEY": Omit()}):
                client2 = Platypi(base_url=base_url, api_key=None, _strict_response_validation=True)
            _ = client2
    ...
    def test_multipart_repeating_array(self, client: Platypi) -> None:
        request = client._build_request(
    ...
    def test_base_url_setter(self) -> None:
        client = Platypi(base_url="https://example.com/from_init", api_key=api_key, _strict_response_validation=True)
    ...
    def test_base_url_env(self) -> None:
        with update_env(PLATYPI_BASE_URL="http://localhost:5000/from/env"):
            client = Platypi(api_key=api_key, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"

    @pytest.mark.parametrize(
        "client",
        [
            Platypi(base_url="http://localhost:5000/custom/path/", api_key=api_key, _strict_response_validation=True),
            Platypi(
    ...
    def test_base_url_trailing_slash(self, client: Platypi) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: Platypi) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: Platypi) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_client_max_retries_validation(self) -> None:
        with pytest.raises(TypeError, match=r"max_retries cannot be None"):
            Platypi(base_url=base_url, api_key=api_key, _strict_response_validation=True, max_retries=cast(Any, None))
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = Platypi(base_url=base_url, api_key=api_key, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            strict_client.get("/foo", cast_to=Model)

        client = Platypi(base_url=base_url, api_key=api_key, _strict_response_validation=False)
    ...
    @mock.patch("platypi._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter, client: Platypi) -> None:
    ...
    @mock.patch("platypi._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_retrying_status_errors_doesnt_leak(self, respx_mock: MockRouter, client: Platypi) -> None:
    ...
    def test_omit_retry_count_header(
        self, client: Platypi, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = client.with_options(max_retries=4)
...
class TestAsyncPlatypi:
    client = AsyncPlatypi(base_url=base_url, api_key=api_key, _strict_response_validation=True)
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(PlatypiError):
            with update_env(**{"PLATYPI_API_KEY": Omit()}):
                client2 = AsyncPlatypi(base_url=base_url, api_key=None, _strict_response_validation=True)
            _ = client2
    ...
    def test_multipart_repeating_array(self, async_client: AsyncPlatypi) -> None:
    ...
    def test_base_url_env(self) -> None:
        with update_env(PLATYPI_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncPlatypi(api_key=api_key, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"
    ...
    def test_base_url_trailing_slash(self, client: AsyncPlatypi) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncPlatypi) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncPlatypi) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncPlatypi(base_url=base_url, api_key=api_key, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            await strict_client.get("/foo", cast_to=Model)

        client = AsyncPlatypi(base_url=base_url, api_key=api_key, _strict_response_validation=False)
    ...
    async def test_retrying_timeout_errors_doesnt_leak(
        self, respx_mock: MockRouter, async_client: AsyncPlatypi
    ) -> None:
        respx_mock.get("/assistants").mock(side_effect=httpx.TimeoutException("Test timeout error"))
    ...
    @mock.patch("platypi._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    async def test_retrying_status_errors_doesnt_leak(self, respx_mock: MockRouter, async_client: AsyncPlatypi) -> None:
        respx_mock.get("/assistants").mock(return_value=httpx.Response(500))
    ...
    async def test_omit_retry_count_header(
        self, async_client: AsyncPlatypi, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = async_client.with_options(max_retries=4)
