...
class TestCompletions:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_method_get_messages(self, client: Platypi) -> None:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_method_get_messages_with_all_params(self, client: Platypi) -> None:
        completion = client.chat.completions.get_messages(
            completion_id="completion_id",
            after="after",
            limit=0,
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_raw_response_get_messages(self, client: Platypi) -> None:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_streaming_response_get_messages(self, client: Platypi) -> None:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_path_params_get_messages(self, client: Platypi) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `completion_id` but received ''"):
...
class TestAsyncCompletions:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_method_get_messages(self, async_client: AsyncPlatypi) -> None:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_method_get_messages_with_all_params(self, async_client: AsyncPlatypi) -> None:
        completion = await async_client.chat.completions.get_messages(
            completion_id="completion_id",
            after="after",
            limit=0,
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_raw_response_get_messages(self, async_client: AsyncPlatypi) -> None:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_streaming_response_get_messages(self, async_client: AsyncPlatypi) -> None:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_path_params_get_messages(self, async_client: AsyncPlatypi) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `completion_id` but received ''"):
