...
if __name__ == "__main__":
    ...
    for labeling_rate in LABELING_RATES:
        ...
        vis_callback = ScalarVisualizationCallback(
            val, save_dir=f"vis/pets/scalar/{labeling_rate}"
        )
        ...
        model.save(f"models/pets/scalar/model_{labeling_rate}.keras")
        study.save(f"models/pets/scalar/study_{labeling_rate}.json")
        with open(f"models/pets/scalar/history_{labeling_rate}.json", "w") as f:
