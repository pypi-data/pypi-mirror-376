...
import memory
from soika_memory.memory.setup import get_or_create_user_id

memory_TELEMETRY = os.environ.get("memory_TELEMETRY", "True")
PROJECT_API_KEY = "phc_hgJkUVJFYtmaJqrvf6CYN67TIQ8yhXAkWzUn9AMU4yX"
HOST = "https://us.i.posthog.com"

if isinstance(memory_TELEMETRY, str):
    memory_TELEMETRY = memory_TELEMETRY.lower() in ("true", "1", "yes")

if not isinstance(memory_TELEMETRY, bool):
    raise ValueError("memory_TELEMETRY must be a boolean value.")
...
class AnonymousTelemetry:
    ...
    def capture_event(self, event_name, properties=None, user_email=None):
        ...
        properties = {
            ...
            "client_version": memory.__version__,
