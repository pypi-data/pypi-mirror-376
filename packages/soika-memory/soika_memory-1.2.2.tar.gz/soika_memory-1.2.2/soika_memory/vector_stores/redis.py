...
from soika_memory.memory.utils import extract_json
from soika_memory.vector_stores.base import VectorStoreBase
...
excluded_keys = {"user_id", "agent_id", "conv_id", "hash", "data", "created_at", "updated_at"}
...
class RedisDB(VectorStoreBase):
    def __init__(
        ...
        index_schema = {
            ...
            "prefix": f"memory:{collection_name}",
        }
    ...
    def insert(self, vectors: list, payloads: list = None, ids: list = None):
        ...
        for vector, payload, id in zip(vectors, payloads, ids):
            ...
            for field in ["agent_id", "conv_id", "user_id"]:
                if field in payload:
    ...
    def search(self, query: str, vectors: list, limit: int = 5, filters: dict = None):
        ...
        v = VectorQuery(
            ...
            return_fields=["memory_id", "hash", "agent_id", "conv_id", "user_id", "memory", "metadata", "created_at"],
        ...
        return [
            MemoryResult(
                ...
                payload={
                    ...
                    **{field: result[field] for field in ["agent_id", "conv_id", "user_id"] if field in result},
