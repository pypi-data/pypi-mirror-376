...
class Neo4jConfig(BaseModel):
    url: Optional[str] = Field("http://localhost:7474", description="Host address for the graph database")
    username: Optional[str] = Field("neo4j", description="Username for the graph database")
    password: Optional[str] = Field("neo4j", description="Password for the graph database")
