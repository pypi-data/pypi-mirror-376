...
class AzureAISearch(VectorStoreBase):
    def __init__(
        ...
        self.search_client._client._config.user_agent_policy.add_user_agent("memory")
        self.index_client._client._config.user_agent_policy.add_user_agent("memory")
    ...
    def create_col(self):
        ...
        fields = [
            ...
            SimpleField(name="conv_id", type=SearchFieldDataType.String, filterable=True),
    ...
    def _generate_document(self, vector, payload, id):
        ...
        for field in ["user_id", "conv_id", "agent_id"]:
            if field in payload:
