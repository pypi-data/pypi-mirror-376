...
from soika_memory.configs.vector_stores.milvus import MetricType
...
class MilvusDB(VectorStoreBase):
    def __init__(
        ...
        Args:
            ...
            collection_name (str): Name of the collection (defaults to memory).
    ...
    def _create_filter(self, filters: dict):
        ...
        Args:
            filters (dict): filters [user_id, agent_id, conv_id]
