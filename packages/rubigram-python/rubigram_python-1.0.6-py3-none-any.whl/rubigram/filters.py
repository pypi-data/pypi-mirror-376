...
__models__ = [
    ...
    'group', 'private', 'channel', 'contact',
    'text', 'original_update',
    'time', 'reply_message_id', 'is_me', 'forward', 'is_text',
    'music', 'file', 'photo', 'sticker', 'video', 'voice',
    'contact', 'location', 'poll', 'gif', 'event', 'edited']
...
group: Type[BaseModel]
private: Type[BaseModel]
channel: Type[BaseModel]
