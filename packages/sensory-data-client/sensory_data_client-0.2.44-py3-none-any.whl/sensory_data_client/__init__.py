...
from .repositories.auth.pg_repositoryAuth import RefreshTokenRepository
...
from .repositories.pg_repositoryBullets import DocBulletsRepository
...
def create_data_client(config: Optional[DataClientConfig] = None) -> DataClient:
    ...
    bullet_repo = DocBulletsRepository(session_factory)
    ...
    rrepo = RefreshTokenRepository(session_factory)
