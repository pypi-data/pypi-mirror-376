...
from cogents_tools.integrations.bu.browser.profile import BrowserProfile, ProxySettings
from cogents_tools.integrations.bu.browser.views import BrowserStateSummary, TabInfo
from cogents_tools.integrations.bu.dom.views import EnhancedDOMTreeNode, TargetInfo
from cogents_tools.integrations.bu.observability import observe_debug
from cogents_tools.integrations.bu.utils import _log_pretty_url, is_new_tab_page
...
class CDPSession(BaseModel):
    ...
    async def for_target(
        ...
        if new_socket:
            ...
            logger = logging.getLogger(f"cogents_tools.integrations.bu.CDPSession.{target_id[-4:]}")
...
class BrowserSession(BaseModel):
    ...
    def logger(self) -> Any:
        ...
        # 	self._logger = logging.getLogger(f'cogents_tools.integrations.bu.{self}')
        return logging.getLogger(f"cogents_tools.integrations.bu.{self}")
    ...
    def model_post_init(self, __context) -> None:
        ...
        from cogents_tools.integrations.bu.browser.watchdog_base import BaseWatchdog
    ...
    async def kill(self) -> None:
        ...
        from cogents_tools.integrations.bu.browser.events import SaveStorageStateEvent
    ...
    async def attach_all_watchdogs(self) -> None:
        ...
        from cogents_tools.integrations.bu.browser.watchdogs.aboutblank_watchdog import AboutBlankWatchdog

        # from cogents_tools.integrations.bu.browser.crash_watchdog import CrashWatchdog
        from cogents_tools.integrations.bu.browser.watchdogs.default_action_watchdog import DefaultActionWatchdog
        from cogents_tools.integrations.bu.browser.watchdogs.dom_watchdog import DOMWatchdog
        from cogents_tools.integrations.bu.browser.watchdogs.downloads_watchdog import DownloadsWatchdog
        from cogents_tools.integrations.bu.browser.watchdogs.local_browser_watchdog import LocalBrowserWatchdog
        from cogents_tools.integrations.bu.browser.watchdogs.permissions_watchdog import PermissionsWatchdog
        from cogents_tools.integrations.bu.browser.watchdogs.popups_watchdog import PopupsWatchdog
        from cogents_tools.integrations.bu.browser.watchdogs.screenshot_watchdog import ScreenshotWatchdog
        from cogents_tools.integrations.bu.browser.watchdogs.security_watchdog import SecurityWatchdog

        # from cogents_tools.integrations.bu.browser.storage_state_watchdog import StorageStateWatchdog
