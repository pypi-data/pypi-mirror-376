...
from cogents_tools.integrations.bu.dom.views import EnhancedDOMTreeNode, SerializedDOMState
from cogents_tools.integrations.bu.observability import observe_debug
from cogents_tools.integrations.bu.utils import time_execution_async

if TYPE_CHECKING:
    from cogents_tools.integrations.bu.browser.views import BrowserStateSummary, PageInfo
...
class DOMWatchdog(BaseWatchdog):
        ...
        try:
            ...
            if (
                ...
                try:
                    ...
                    from cogents_tools.integrations.bu.browser.python_highlights import (
    ...
    async def _get_page_info(self) -> "PageInfo":
        ...
        from cogents_tools.integrations.bu.browser.views import PageInfo
