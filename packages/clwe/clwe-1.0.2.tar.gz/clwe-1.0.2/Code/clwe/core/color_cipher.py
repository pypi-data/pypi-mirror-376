...
class ColorCipher:
    ...
    def _encrypt_file_content(self, file_path: str, password: str, output_format: str = "webp") -> bytes:
    ...
    def encrypt_to_image(self, content, password: str, output_format: str = "webp") -> bytes:
        """
    ...
    def encrypt_text_to_image(self, text: str, password: str, output_format: str = "webp") -> bytes:
        """Convenience method for explicit text encryption."""
        return self.encrypt_to_image(text, password, output_format)
    
    def encrypt_bytes_to_image(self, data: bytes, password: str, output_format: str = "webp") -> bytes:
