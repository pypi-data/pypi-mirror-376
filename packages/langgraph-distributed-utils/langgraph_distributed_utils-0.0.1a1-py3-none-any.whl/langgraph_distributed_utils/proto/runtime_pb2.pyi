...
@typing.final
class StorePutOperation(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor
...
global___StorePutOperation = StorePutOperation

@typing.final
class StoreOperation(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor

    PUT_FIELD_NUMBER: builtins.int
    @property
    def put(self) -> global___StorePutOperation: ...
    def __init__(
        self,
        *,
        put: global___StorePutOperation | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing.Literal["operations", b"operations", "put", b"put"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["operations", b"operations", "put", b"put"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["operations", b"operations"]) -> typing.Literal["put"] | None: ...

global___StoreOperation = StoreOperation
...
class BatchStoreOperationRequest(google.protobuf.message.Message):
    ...
    @property
    def ops(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___StoreOperation]: ...
    def __init__(
        self,
        *,
        ops: collections.abc.Iterable[global___StoreOperation] | None = ...,
    ) -> None: ...
