...
export class FilesystemTools {
  ...
  private async createTemporaryKernel(): Promise<{
    ...
    try {
      ...
      console.error('[FilesystemTools] Error creating temporary kernel:', error);
      throw error;
    }
  }
...
`;
      ...
      try {
        ...
        return JSON.stringify({ error: 'Failed to parse file listing results' });
      }
...
`;
      ...
      try {
        ...
        console.error('Error parsing kernel output:', parseError);
        return JSON.stringify({ error: 'Failed to parse file reading results' });
      }
...
`;
      ...
      try {
        ...
        console.error('Error parsing kernel output:', parseError);
        return JSON.stringify({ error: 'Failed to parse file deletion results' });
      }
