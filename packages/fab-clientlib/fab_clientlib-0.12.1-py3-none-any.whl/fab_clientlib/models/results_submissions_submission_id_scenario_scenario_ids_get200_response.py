...
class ResultsSubmissionsSubmissionIdScenarioScenarioIdsGet200Response(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "body": [ResultsSubmissionsSubmissionIdsGet200ResponseAllOfBodyInnerTestScoringsInnerScenarioScoringsInner.from_dict(_item) for _item in obj["body"]] if obj.get("body") is not None else None
        })
        return _obj
