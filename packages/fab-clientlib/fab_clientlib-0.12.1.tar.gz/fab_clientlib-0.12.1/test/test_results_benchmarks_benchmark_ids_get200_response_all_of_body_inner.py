...
class TestResultsBenchmarksBenchmarkIdsGet200ResponseAllOfBodyInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ResultsBenchmarksBenchmarkIdsGet200ResponseAllOfBodyInner:
        """Test ResultsBenchmarksBenchmarkIdsGet200ResponseAllOfBodyInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ResultsBenchmarksBenchmarkIdsGet200ResponseAllOfBodyInner`
        """
        model = ResultsBenchmarksBenchmarkIdsGet200ResponseAllOfBodyInner()
        if include_optional:
            return ResultsBenchmarksBenchmarkIdsGet200ResponseAllOfBodyInner(
                benchmark_id = '',
                items = [
    ...
    def testResultsBenchmarksBenchmarkIdsGet200ResponseAllOfBodyInner(self):
        """Test ResultsBenchmarksBenchmarkIdsGet200ResponseAllOfBodyInner"""
