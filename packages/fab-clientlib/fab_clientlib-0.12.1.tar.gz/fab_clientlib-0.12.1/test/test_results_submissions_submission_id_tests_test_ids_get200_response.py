...
class TestResultsSubmissionsSubmissionIdTestsTestIdsGet200Response(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ResultsSubmissionsSubmissionIdTestsTestIdsGet200Response:
        """Test ResultsSubmissionsSubmissionIdTestsTestIdsGet200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ResultsSubmissionsSubmissionIdTestsTestIdsGet200Response`
        """
        model = ResultsSubmissionsSubmissionIdTestsTestIdsGet200Response()
        if include_optional:
    ...
    def testResultsSubmissionsSubmissionIdTestsTestIdsGet200Response(self):
        """Test ResultsSubmissionsSubmissionIdTestsTestIdsGet200Response"""
