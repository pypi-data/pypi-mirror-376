...
class TestResultsBenchmarksBenchmarkIdsGet200Response(unittest.TestCase):
    """ResultsBenchmarksBenchmarkIdsGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ResultsBenchmarksBenchmarkIdsGet200Response:
        """Test ResultsBenchmarksBenchmarkIdsGet200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ResultsBenchmarksBenchmarkIdsGet200Response`
        """
        model = ResultsBenchmarksBenchmarkIdsGet200Response()
        if include_optional:
            return ResultsBenchmarksBenchmarkIdsGet200Response(
                error = fab_clientlib.models.api_response_error.ApiResponse_error(
                    text = '', ),
                body = [
                    fab_clientlib.models._results_benchmarks__benchmark_ids__get_200_response_all_of_body_inner._results_benchmarks__benchmark_ids__get_200_response_allOf_body_inner(
                        benchmark_id = '', 
                        items = [
    ...
    def testResultsBenchmarksBenchmarkIdsGet200Response(self):
        """Test ResultsBenchmarksBenchmarkIdsGet200Response"""
