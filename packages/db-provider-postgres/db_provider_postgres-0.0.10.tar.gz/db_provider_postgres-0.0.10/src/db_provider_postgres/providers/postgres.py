...
class PostgresDatabaseProvider(BaseDatabaseProvider):
    ...
    pool_recycle: int = 300, pool_pre_ping: bool = True):
    ...
    def _get_connect_args(self) -> Dict[str, Any]:
        ...
        connect_args = {
            ...
            'keepalives_idle': 60,  # Send keepalive every 10 minutes
    ...
    def get_connection(self) -> Connection:
        ...
        try:
            ...
            logger.debug(f"Connection acquired. Pool status: {self.get_pool_status()}")
            return conn
