...
class BettingCSGOGame(object):

    """Implementation of the 'BettingCSGOGame' model.
    ...
    def __init__(self,
                 ...
                 winner=None,
                 winner_type=None):
        """Constructor for the BettingCSGOGame class"""
    ...
    def from_dictionary(cls,
        ...
        game_round_teams = dictionary.get("game_round_teams") if dictionary.get("game_round_teams") else None
        id = dictionary.get("id") if dictionary.get("id") else None
        length = dictionary.get("length") if dictionary.get("length") else None
        map = dictionary.get("map") if dictionary.get("map") else None
        match_id = dictionary.get("match_id") if dictionary.get("match_id") else None
        number_of_rounds = dictionary.get("number_of_rounds") if dictionary.get("number_of_rounds") else None
    ...
    def validate(cls, dictionary):
        ...
        if isinstance(dictionary, cls):
            return APIHelper.is_valid_type(value=dictionary.begin_at,
                ...
                and APIHelper.is_valid_type(value=dictionary.forfeit,
                                            type_callable=lambda value: isinstance(value, bool)) \
                and APIHelper.is_valid_type(value=dictionary.game_round_teams,
                ...
                and APIHelper.is_valid_type(value=dictionary.length,
                                            type_callable=lambda value: isinstance(value, int),
                                            is_value_nullable=True) \
                and APIHelper.is_valid_type(value=dictionary.map,
                                            type_callable=lambda value: isinstance(value, Any)) \
                and APIHelper.is_valid_type(value=dictionary.match_id,
                                            type_callable=lambda value: isinstance(value, int)) \
                and APIHelper.is_valid_type(value=dictionary.number_of_rounds,
                                            type_callable=lambda value: isinstance(value, int),
                                            is_value_nullable=True) \
        ...
        return APIHelper.is_valid_type(value=dictionary.get('begin_at'),
            ...
            and APIHelper.is_valid_type(value=dictionary.get('forfeit'),
                                        type_callable=lambda value: isinstance(value, bool)) \
            and APIHelper.is_valid_type(value=dictionary.get('game_round_teams'),
                                        type_callable=lambda value: isinstance(value, Any),
                                        is_value_nullable=True) \
            ...
            and APIHelper.is_valid_type(value=dictionary.get('length'),
                                        type_callable=lambda value: isinstance(value, int),
                                        is_value_nullable=True) \
            and APIHelper.is_valid_type(value=dictionary.get('map'),
                                        type_callable=lambda value: isinstance(value, Any)) \
            and APIHelper.is_valid_type(value=dictionary.get('match_id'),
                                        type_callable=lambda value: isinstance(value, int)) \
            and APIHelper.is_valid_type(value=dictionary.get('number_of_rounds'),
                                        type_callable=lambda value: isinstance(value, int),
                                        is_value_nullable=True) \
    ...
    def __repr__(self):
        return (f'{self.__class__.__name__}('
                ...
                f'game_round_teams={self.game_round_teams!r}, '
                f'id={self.id!r}, '
    ...
    def __str__(self):
        return (f'{self.__class__.__name__}('
                ...
                f'game_round_teams={self.game_round_teams!s}, '
                f'id={self.id!s}, '
                f'length={self.length!s}, '
                f'map={self.map!s}, '
                f'match_id={self.match_id!s}, '
                f'number_of_rounds={self.number_of_rounds!s}, '
