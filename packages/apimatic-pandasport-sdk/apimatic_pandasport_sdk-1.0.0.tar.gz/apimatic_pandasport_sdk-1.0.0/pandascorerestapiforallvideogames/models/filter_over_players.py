...
class FilterOverPlayers(object):

    """Implementation of the 'filter_over_Players' model.
    ...
    Attributes:
        ...
        team_id (List[int]): The model property of type List[int].
    ...
    def __init__(self,
        ...
        """Constructor for the FilterOverPlayers class"""
