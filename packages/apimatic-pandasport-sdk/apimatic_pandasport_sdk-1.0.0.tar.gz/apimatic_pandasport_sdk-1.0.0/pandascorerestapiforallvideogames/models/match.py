...
class Match(object):
    ...
    Attributes:
        ...
        tournament (BaseTournament): The model property of type BaseTournament.
    ...
    def from_dictionary(cls,
        ...
        tournament = BaseTournament.from_dictionary(dictionary.get('tournament')) if dictionary.get('tournament') else None
    ...
    def validate(cls, dictionary):
        ...
        if isinstance(dictionary, cls):
            return APIHelper.is_valid_type(value=dictionary.begin_at,
                ...
                and APIHelper.is_valid_type(value=dictionary.game_advantage,
                                            ...
                                            is_value_nullable=True) \
                and APIHelper.is_valid_type(value=dictionary.games,
                                            type_callable=lambda value: Game.validate(value),
                                            is_model_dict=True,
        ...
        return APIHelper.is_valid_type(value=dictionary.get('begin_at'),
            ...
            and APIHelper.is_valid_type(value=dictionary.get('game_advantage'),
                                        type_callable=lambda value: isinstance(value, Any),
                                        is_value_nullable=True) \
            and APIHelper.is_valid_type(value=dictionary.get('games'),
                                        type_callable=lambda value: Game.validate(value),
                                        is_model_dict=True,
                                        is_inner_model_dict=True) \
