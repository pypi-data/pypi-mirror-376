...
class BettingLoLGame(object):

    """Implementation of the 'BettingLoLGame' model.
    ...
    def __init__(self,
                 ...
                 winner=None,
                 winner_type=None):
        """Constructor for the BettingLoLGame class"""
    ...
    def from_dictionary(cls,
        ...
        game_teams = dictionary.get("game_teams") if dictionary.get("game_teams") else None
    ...
    def validate(cls, dictionary):
        ...
        if isinstance(dictionary, cls):
            return APIHelper.is_valid_type(value=dictionary.begin_at,
                ...
                and APIHelper.is_valid_type(value=dictionary.forfeit,
                                            type_callable=lambda value: isinstance(value, bool)) \
                and APIHelper.is_valid_type(value=dictionary.game_teams,
        ...
        return APIHelper.is_valid_type(value=dictionary.get('begin_at'),
            ...
            and APIHelper.is_valid_type(value=dictionary.get('forfeit'),
                                        type_callable=lambda value: isinstance(value, bool)) \
            and APIHelper.is_valid_type(value=dictionary.get('game_teams'),
                                        type_callable=lambda value: isinstance(value, Any),
                                        is_value_nullable=True) \
    ...
    def __repr__(self):
        return (f'{self.__class__.__name__}('
                ...
                f'game_teams={self.game_teams!r}, '
                f'id={self.id!r}, '
    ...
    def __str__(self):
        return (f'{self.__class__.__name__}('
                ...
                f'game_teams={self.game_teams!s}, '
                f'id={self.id!s}, '
