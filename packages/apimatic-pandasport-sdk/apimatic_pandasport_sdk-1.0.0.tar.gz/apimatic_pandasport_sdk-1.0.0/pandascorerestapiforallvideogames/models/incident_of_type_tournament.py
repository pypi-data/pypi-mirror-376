...
class IncidentOfTypeTournament(object):

    """Implementation of the 'IncidentOfTypeTournament' model.
    ...
    Attributes:
        ...
        object (Tournament): The model property of type Tournament.
    ...
    def __init__(self,
                 ...
                 modified_at=None,
                 object=None):
        """Constructor for the IncidentOfTypeTournament class"""
    ...
    def from_dictionary(cls,
        ...
        object = Tournament.from_dictionary(dictionary.get('object')) if dictionary.get('object') else None
        ...
        if isinstance(dictionary, cls):
            return APIHelper.is_valid_type(value=dictionary.change_type,
                ...
                and APIHelper.is_valid_type(value=dictionary.object,
                                            type_callable=lambda value: Tournament.validate(value),
                                            is_model_dict=True) \
