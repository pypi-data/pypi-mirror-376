...
class Configuration(HttpClientConfiguration):
    ...
    @property
    def query_token_credentials(self):
        return self._query_token_credentials
    ...
    def __init__(self, http_client_instance=None,
        ...
        self._query_token_credentials = query_token_credentials
    ...
    def clone_with(self, http_client_instance=None,
                   ...
                   retry_statuses=None, retry_methods=None, proxy_settings=None,
                   environment=None, bearer_token_credentials=None,
                   query_token_credentials=None):
        ...
        query_token_credentials = query_token_credentials or self.query_token_credentials
    ...
    environments = {
        Environment.PRODUCTION: {
            Server.DEFAULT: 'https://api.pandascore.co/'
        }
    }
