...
class MatchTeamOpponentsObject(object):

    """Implementation of the 'MatchTeamOpponentsObject' model.
    ...
    def __init__(self,
                 opponents=None):
        """Constructor for the MatchTeamOpponentsObject class"""

        # Initialize members of the class
        self.opponent_type = 'Team' 
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('opponents') is not None:
            opponents = [Team.from_dictionary(x) for x in dictionary.get('opponents')]
