...
class TournamentTeamRosters(object):

    """Implementation of the 'TournamentTeamRosters' model.
    ...
    def __init__(self,
                 rosters=None):
        """Constructor for the TournamentTeamRosters class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('rosters') is not None:
            rosters = [Team.from_dictionary(x) for x in dictionary.get('rosters')]
