...
class IncidentOfTypeMatch(object):

    """Implementation of the 'IncidentOfTypeMatch' model.
    ...
    Attributes:
        ...
        object (Match): The model property of type Match.
    ...
    def __init__(self,
                 ...
                 modified_at=None,
                 object=None):
        """Constructor for the IncidentOfTypeMatch class"""
    ...
    def from_dictionary(cls,
        ...
        object = Match.from_dictionary(dictionary.get('object')) if dictionary.get('object') else None
        ...
        if isinstance(dictionary, cls):
            return APIHelper.is_valid_type(value=dictionary.change_type,
                ...
                and APIHelper.is_valid_type(value=dictionary.object,
                                            type_callable=lambda value: Match.validate(value),
                                            is_model_dict=True) \
