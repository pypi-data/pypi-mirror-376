...
from pandascorerestapiforallvideogames.models.game_winner_1 import GameWinner1


class BettingGame(object):

    """Implementation of the 'BettingGame' model.

    Attributes:
        begin_at (Any): The model property of type Any.
        complete (bool): Whether game data are complete and won't change
        detailed_stats (bool): Whether the game offers full stats
        end_at (Any): The model property of type Any.
        ...
        length (Any): The model property of type Any.
        ...
        video_url (Any): The model property of type Any.
        winner (GameWinner1): The model property of type GameWinner1.
    ...
    def __init__(self,
        ...
        """Constructor for the BettingGame class"""
    ...
    def from_dictionary(cls,
        ...
        begin_at = dictionary.get("begin_at") if dictionary.get("begin_at") else APIHelper.SKIP
        ...
        video_url = dictionary.get("video_url") if dictionary.get("video_url") else APIHelper.SKIP
        winner = GameWinner1.from_dictionary(dictionary.get('winner')) if 'winner' in dictionary.keys() else APIHelper.SKIP
