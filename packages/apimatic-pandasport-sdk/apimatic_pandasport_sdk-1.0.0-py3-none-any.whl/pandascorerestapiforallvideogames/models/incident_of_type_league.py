...
from pandascorerestapiforallvideogames.models.betting_league import BettingLeague
from pandascorerestapiforallvideogames.models.incident_change_type_enum import IncidentChangeTypeEnum


class IncidentOfTypeLeague(object):

    """Implementation of the 'IncidentOfTypeLeague' model.
    ...
    Attributes:
        ...
        object (BettingLeague): The model property of type BettingLeague.
    ...
    def __init__(self,
                 ...
                 modified_at=None,
                 object=None):
        """Constructor for the IncidentOfTypeLeague class"""
    ...
    def from_dictionary(cls,
        ...
        object = BettingLeague.from_dictionary(dictionary.get('object')) if dictionary.get('object') else None
        ...
        if isinstance(dictionary, cls):
            return APIHelper.is_valid_type(value=dictionary.change_type,
                ...
                and APIHelper.is_valid_type(value=dictionary.object,
                                            type_callable=lambda value: BettingLeague.validate(value),
                                            is_model_dict=True) \
