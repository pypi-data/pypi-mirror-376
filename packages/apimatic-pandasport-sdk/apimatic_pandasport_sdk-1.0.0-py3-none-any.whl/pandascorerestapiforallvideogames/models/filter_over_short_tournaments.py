...
class FilterOverShortTournaments(object):

    """Implementation of the 'filter_over_ShortTournaments' model.
    ...
    def __init__(self,
        ...
        """Constructor for the FilterOverShortTournaments class"""
        ...
        if id is not APIHelper.SKIP:
            self.id = id 
        if live_supported is not APIHelper.SKIP:
    ...
    def from_dictionary(cls,
        ...
        live_supported = dictionary.get("live_supported") if "live_supported" in dictionary.keys() else APIHelper.SKIP
        modified_at = None
    ...
    def __repr__(self):
        return (f'{self.__class__.__name__}('
                ...
                f'live_supported={(self.live_supported if hasattr(self, "live_supported") else None)!r}, '
    ...
    def __str__(self):
        return (f'{self.__class__.__name__}('
                ...
                f'live_supported={(self.live_supported if hasattr(self, "live_supported") else None)!s}, '
