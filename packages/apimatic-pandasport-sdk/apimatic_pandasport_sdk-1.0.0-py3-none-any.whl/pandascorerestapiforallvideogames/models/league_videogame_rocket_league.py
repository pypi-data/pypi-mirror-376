...
class LeagueVideogameRocketLeague(object):

    """Implementation of the 'LeagueVideogame_RocketLeague' model.
    ...
    def __init__(self,
        ...
        """Constructor for the LeagueVideogameRocketLeague class"""

        # Initialize members of the class
        self.current_version = current_version 
        self.id = 22 
        self.name = 'Rocket League' 
        self.slug = 'rl' 
