...
class EmailerMainWindow(QMainWindow):
    ...
    def init_ui(self):
        ...
        # Create and add tabs in the correct order: Campaign → Pictures → Send → SMTP → Help
        ...
        self.help_tab = HelpTab(self.campaign_manager)
        
        # Add tabs in the desired order: Campaign → Pictures → Send → SMTP → Help
        ...
        self.tabs.addTab(self.help_tab, self.tr("📚 Help"))
    ...
    def refresh_translations(self):
        ...
        if hasattr(self.help_tab, 'set_language'):
            current_lang = self.translation_manager.get_current_language()
            self.help_tab.set_language(current_lang)
