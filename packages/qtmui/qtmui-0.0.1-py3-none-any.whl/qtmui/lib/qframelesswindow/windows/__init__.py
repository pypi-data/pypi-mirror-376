...
import win32con
import win32gui
from ...qtcompat.QtCore import Qt, QSize, QRect
from ...qtcompat.QtGui import QCloseEvent, QCursor
from ...qtcompat.QtWidgets import QApplication, QDialog, QFrame, QMainWindow
