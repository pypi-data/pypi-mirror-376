...
class SnapshotMergeJobRemoteLive(MergeRemoteJob):
    ...
    def _ingestSeedBatch(
            self, sourceConn: Connection, mergeEngine: Engine, sourceTableName: str, stagingTableName: str,
    ...
    def _processSeedBatch(
            self, connection: Connection, stagingTableName: str, mergeTableName: str,
