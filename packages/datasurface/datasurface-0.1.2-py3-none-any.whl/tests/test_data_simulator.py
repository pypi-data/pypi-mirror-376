...
def get_database_state(host: str = "localhost", port: int = 5432, database: str = "customer_db", user: str = "postgres", password: str = "postgres"):
...
def run_simulator_test(changes: int = 10):
