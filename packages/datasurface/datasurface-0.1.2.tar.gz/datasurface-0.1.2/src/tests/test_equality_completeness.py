...
# These are typically for computed properties, caches, or other attributes that are not part of the instance's state
MANUAL_EXCLUSIONS = {
    'Ecosystem': {'datastoreCache', 'workSpaceCache', 'teamCache', 'graph', "normalCredentials", "superCredentials"},
