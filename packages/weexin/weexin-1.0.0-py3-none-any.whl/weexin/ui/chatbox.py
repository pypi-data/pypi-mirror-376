...
from weexin.ui.component import (
    CMenuWnd,
)
from weexin.param import (
    WxParam, 
    WxResponse,
)
from weexin.languages import *
from weexin.utils import (
    SetClipboardText,
    SetClipboardFiles,
    GetAllWindowExs,
)
from weexin.msgs import parse_msg
from weexin import uiautomation as uia
from weexin.logger import wxlog
from weexin.uiautomation import Control
from weexin.utils.tools import roll_into_view
import time
import os
...
class GroupMemberElement:
    ...
    def __repr__(self) -> str:
        return f"<weexin Group Member Element at {hex(id(self))}>"
