...
Welcome to `lds-gen` contributor's guide.
...
If you experience bugs or general issues with `lds-gen`, please have a look
...
You can help improve `lds-gen` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`lds-gen` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `lds-gen`'s files. While this mechanism can
...
```
conda create -n lds-gen python=3 six virtualenv pytest pytest-cov
conda activate lds-gen
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/lds-gen.git
   cd lds-gen
   ```
...
5. Install [pre-commit]:
   ...
   `lds-gen` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/lds-gen
[issue tracker]: https://github.com/<USERNAME>/lds-gen/issues
