...
from evotool.task.python_task.python_task_adapter import PythonTaskAdapter


class FuncApproxBaseAdapter(PythonTaskAdapter):
    """Base class for function approximation adapters with shared task description."""
