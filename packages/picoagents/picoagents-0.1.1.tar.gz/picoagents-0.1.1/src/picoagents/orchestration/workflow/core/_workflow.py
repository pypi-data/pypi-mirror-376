...
from ...._component_config import Component, ComponentModel, ComponentBase
...
class BaseWorkflow(ComponentBase[BaseModel]):
    ...
    def _check_multiple_conditional_edges(self, step_id: str, edges: List[Edge]) -> Dict[str, List[str]]:
...
class Workflow(BaseWorkflow, Component[WorkflowConfig]):
    ...
    component_provider_override = "picoagents.orchestration.workflow.Workflow"
