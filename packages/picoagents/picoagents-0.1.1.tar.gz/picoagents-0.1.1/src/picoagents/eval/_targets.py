...
class AgentEvalTarget(BaseEvalTarget):
    ...
    async def run(self, task: EvalTask, cancellation_token: Optional[CancellationToken] = None) -> EvalTrajectory:
        ...
        try:
            ...
            response = await self.agent.run(task.input, cancellation_token=cancellation_token)
...
class ModelEvalTarget(BaseEvalTarget):
    ...
    def __init__(self, client: BaseChatCompletionClient, system_message: Optional[str] = None, name: Optional[str] = None):
        ...
        try:
            ...
            return EvalTrajectory(
                ...
                metadata={
                    ...
                    "iterations": response.pattern_metadata.get("iterations_completed", 0),
