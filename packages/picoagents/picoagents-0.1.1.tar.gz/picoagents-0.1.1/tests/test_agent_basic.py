...
from picoagents.messages import UserMessage, AssistantMessage, SystemMessage, MultiModalMessage
...
def test_multimodal_message_validation():
    ...
    with pytest.raises(ValueError, match="Only one of 'data' or 'media_url' should be provided"):
        MultiModalMessage(
            content="Test",
            role="user",
            mime_type="image/png",
    ...
    with pytest.raises(ValueError, match="Either 'data' or 'media_url' must be provided"):
        MultiModalMessage(
            content="Test",
            role="user",
            mime_type="image/png",
