...
class MultiModalMessage(BaseMessage):
    ...
    mime_type: str = Field(..., description="MIME type of the content (e.g., 'text/plain', 'image/jpeg', 'audio/wav', 'video/mp4')")
    data: Optional[bytes] = Field(None, description="Binary data for the content")
    media_url: Optional[str] = Field(None, description="URL to media content if data is not provided")
