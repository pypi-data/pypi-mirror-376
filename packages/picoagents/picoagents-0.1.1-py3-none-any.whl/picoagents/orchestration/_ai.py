...
Select the most appropriate agent and explain your reasoning. Your reason should be a single clean and clear line."""
        ...
        messages: List[Message] = [UserMessage(content=selection_prompt, source="orchestrator")]
                ...
                if hasattr(agent, 'tools') and agent.tools:
                    ...
                    for tool in agent.tools:
                        if hasattr(tool, 'name'):
                            ...
                            tool_names.append(str(tool)[:20])  # Truncate long tool representations
    ...
    def _get_pattern_metadata(self) -> Dict[str, Any]:
        ...
        avg_confidence = sum(sel["confidence"] for sel in self.selection_history) / len(self.selection_history) if self.selection_history else 0.0
        ...
        base_metadata.update({
            ...
            "agent_diversity": len(unique_agents) / len(self.agents) if self.agents else 0.0,
