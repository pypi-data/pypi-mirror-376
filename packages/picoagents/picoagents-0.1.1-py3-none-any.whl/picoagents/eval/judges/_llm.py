...
class LLMEvalJudge(BaseEvalJudge):
    ...
    def __init__(
        ...
        self.client = client
        self.default_criteria = default_criteria or ["accuracy", "completeness", "helpfulness"]
    ...
    def _build_system_prompt(self, criteria: List[str]) -> str:
        ...
        for criterion in criteria:
            description = criteria_descriptions.get(criterion, f"Quality of {criterion}")
    ...
    def _parse_llm_response(self, response: str, criteria: List[str]) -> Dict:
        ...
        try:
            ...
            return {
                ...
                "reasoning": {dim: "Failed to parse judge response" for dim in criteria}
            }