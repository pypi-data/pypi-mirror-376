...
class ConnectorsAPI:
    ...
    def create(self, connector_type: str, payload: Mapping[str, Any] | BaseModel) -> Any:
        ...
        return self._http.request("POST", f"/api/manage-connectors/{connector_type}/", json_body=body)
    ...
    def update(self, connector_type: str, connector_id: int, payload: Mapping[str, Any] | BaseModel) -> Any:
        """Update a connector, validating against the strict model."""
        body = self._validate_payload(connector_type, payload, for_patch=False)
        return self._http.request("PUT", f"/api/manage-connectors/{connector_type}/{connector_id}/", json_body=body)

    def partial_update(self, connector_type: str, connector_id: int, payload: Mapping[str, Any] | BaseModel) -> Any:
        """Patch a connector using a `Patched{Type}Serializer` model."""
        body = self._validate_payload(connector_type, payload, for_patch=True)
        return self._http.request("PATCH", f"/api/manage-connectors/{connector_type}/{connector_id}/", json_body=body)
