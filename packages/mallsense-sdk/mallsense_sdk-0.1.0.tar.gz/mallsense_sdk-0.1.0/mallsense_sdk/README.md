...
- See the complete, service-by-service index: [docs/index.md](../docs/index.md)
  - [Core (Dashboard)](../docs/core.md)
  - [Sales Snapshots](../docs/sales.md)
  - [Bills](../docs/bills.md)
  - [Connectors](../docs/connectors.md)
  - [Status](../docs/status.md)
  - [Checks & Jobs](../docs/checks_jobs.md)
  - [Tenants & Comments](../docs/tenants.md)
  - [Points of Sale](../docs/pos.md)
  - [Models Index](../docs/models.md)
...
- Vendor this folder or package it as a distribution in your project.
