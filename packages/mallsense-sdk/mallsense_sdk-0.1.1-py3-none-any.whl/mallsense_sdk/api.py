...
class MallsenseSDK:
    ...
    def __init__(
        ...
        *,
        ...
        core_http = HTTPApi(token=token, app_key=x_app_key, base_url=core_base_url)
        sales_http = HTTPApi(token=token, app_key=x_app_key, base_url=sales_base_url)
        bills_http = HTTPApi(token=token, app_key=x_app_key, base_url=bills_base_url)
