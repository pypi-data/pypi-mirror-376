...
try:
    ...
    long_description = (
        "Sipho AI - AI-powered voice command assistant for desktop automation"
    )
...
if sys.platform == "win32":
    try:
        from setup_hooks import PostInstallCommand, PostDevelopCommand

        cmdclass = {
            "install": PostInstallCommand,
            "develop": PostDevelopCommand,
        }
        print("✅ PATH management hooks loaded")
    except ImportError:
        # Fallback if hooks are not available
        print("⚠️  PATH management hooks not available")
        pass
