...
def main():
    ...
    parser = argparse.ArgumentParser(
        prog="siphoai", description="Sipho AI - Voice Command Assistant"
    )
    ...
    help_parser = subparsers.add_parser(
        "help-commands", help="Show available voice commands"
    )
    ...
    if args.command == "test":
        ...
        try:
            from .installer import install_path, uninstall_path, check_path_status
            ...
            print("❌ PATH management not available")
        return
    else:
