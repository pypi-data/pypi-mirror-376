...
class DependencyReference:
    ...
    def parse(cls, dependency_str: str) -> "DependencyReference":
        ...
        if dependency_str.startswith("git@github.com:"):
            ...
            # Support common GitHub URL variants and strip optional .git suffix.
            # Use more secure URL parsing to prevent bypass attacks
            import urllib.parse
            ...
            if repo_url.startswith(("https://", "http://")):
                ...
                if parsed_url.netloc == "github.com":
                    ...
                    raise ValueError(f"Only GitHub repositories are supported, got: {parsed_url.netloc}")
            else:
                # For non-URL formats, only accept bare repo names or explicit github.com prefix
                if "/" in repo_url and not repo_url.startswith(("github.com/")):
                    # Assume it's already a user/repo format - validate it
                    pass
                elif repo_url.startswith("github.com/"):
                    # Extract the repo part after github.com/
                    repo_url = repo_url[11:]  # len("github.com/") = 11
                else:
                    # It's either user/repo or invalid
                    pass
