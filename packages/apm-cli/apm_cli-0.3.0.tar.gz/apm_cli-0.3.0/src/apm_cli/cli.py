...
def show(ctx, server_name):
    ...
    try:
        ...
        if packages:
            pkg_table = Table(title="⚙️ Installation Packages", show_header=True, header_style="bold cyan", border_style="cyan")
            ...
            for pkg in packages:
                ...
                if len(pkg_name) > 30:
                    pkg_name = pkg_name[:27] + "..."
                
                pkg_table.add_row(registry_name, pkg_name, runtime_hint)
