...
def install_package(client_type, package_name, version=None, shared_env_vars=None, server_info_cache=None):
    ...
    try:
        ...
        # Pass shared environment variables and server info cache if available
        if shared_env_vars is not None or server_info_cache is not None:
