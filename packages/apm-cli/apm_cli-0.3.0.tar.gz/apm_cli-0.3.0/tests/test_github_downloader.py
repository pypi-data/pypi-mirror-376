...
class TestGitHubPackageDownloader:
    ...
    def test_setup_git_environment_with_github_cli_pat(self):
        """Test Git environment setup with GITHUB_CLI_PAT."""
        with patch.dict(os.environ, {'GITHUB_CLI_PAT': 'test-token'}, clear=True):
