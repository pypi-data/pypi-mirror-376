...
class User(APIObject):
    ...
    def get_users(self, username: str = None, include_inactive: bool = False) -> list:
        ...
        utils.print_log(
            self._logger,
            f"Calling get_users endpoint: {endpoint}",
            logging.DEBUG,
        )
    ...
    def get_user_by_id(self, user_id: int) -> dict:
        ...
        utils.print_log(
            self._logger,
            f"Calling get_user_by_id endpoint: {endpoint}",
            logging.DEBUG,
        )
        response = self._run_get_request(endpoint, include_api_version=False)
    ...
    def get_users_by_usergroup_id(self, usergroup_id: int) -> list:
        ...
        utils.print_log(
            self._logger,
            f"Calling get_users_by_usergroup_id endpoint: {endpoint}",
            logging.DEBUG,
        )
        response = self._run_get_request(endpoint, include_api_version=False)
    ...
    def post_user_beyondinsight(
        ...
        utils.print_log(
            self._logger,
            f"Calling post_user_beyondinsight endpoint: {endpoint}",
            logging.DEBUG,
        )
    ...
    def post_user_active_directory(
        ...
        utils.print_log(
            self._logger,
            f"Calling post_user_active_directory endpoint: {endpoint}",
            logging.DEBUG,
        )
        response = self._run_post_request(endpoint, req_body, include_api_version=False)
    ...
    def post_user_ldap(
        ...
        utils.print_log(
            self._logger,
            f"Calling post_user_ldap endpoint: {endpoint}",
            logging.DEBUG,
        )
        response = self._run_post_request(endpoint, req_body, include_api_version=False)
    ...
    def post_user_application(
        ...
        utils.print_log(
            self._logger,
            f"Calling post_user_application endpoint: {endpoint}",
            logging.DEBUG,
        )
        response = self._run_post_request(endpoint, req_body, include_api_version=False)
    ...
    def post_user_quarantine(self, user_id: int) -> dict:
        ...
        utils.print_log(
            self._logger,
            f"Calling post_user_quarantine endpoint: {endpoint}",
            logging.DEBUG,
        )
    ...
    def post_user_usergroupid(
        ...
        utils.print_log(
            self._logger,
            f"Calling post_user_usergroupid endpoint: {endpoint}",
            logging.DEBUG,
        )
        response = self._run_post_request(endpoint, req_body, include_api_version=False)
    ...
    def post_user_recycleclient_secret(self, user_id: int) -> dict:
        ...
        utils.print_log(
            self._logger,
            f"Calling post_user_recycleclient_secret endpoint: {endpoint}",
            logging.DEBUG,
        )
        response = self._run_post_request(
            endpoint, payload={}, include_api_version=False
    ...
    def put_user_beyondinsight(
        ...
        utils.print_log(
            self._logger,
            f"Calling put_user_beyondinsight endpoint: {endpoint}",
            logging.DEBUG,
        )
    ...
    def put_user_application(
        ...
        utils.print_log(
            self._logger,
            f"Calling put_user_application endpoint: {endpoint}",
            logging.DEBUG,
        )
        response = self._run_put_request(endpoint, req_body, include_api_version=False)
    ...
    def delete_user(self, user_id: int) -> None:
        ...
        utils.print_log(
            self._logger,
            f"Calling delete_user endpoint: {endpoint}",
            logging.DEBUG,
        )
