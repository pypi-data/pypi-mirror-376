...
class RequestTermination(APIObject):
    ...
    def post_request_termination_managed_account_id(
        ...
        utils.print_log(
            self._logger,
            f"Calling post_request_termination_managed_account_id endpoint: {endpoint}",
            logging.DEBUG,
        )
    ...
    def post_request_termination_managed_system_id(
        ...
        utils.print_log(
            self._logger,
            f"Calling post_request_termination_managed_system_id endpoint: {endpoint}",
            logging.DEBUG,
        )
        self._run_post_request(endpoint, payload, include_api_version=False)
    ...
    def post_request_termination_user_id(
        ...
        utils.print_log(
            self._logger,
            f"Calling post_request_termination_user_id endpoint: {endpoint}",
            logging.DEBUG,
        )
        self._run_post_request(endpoint, payload, include_api_version=False)
