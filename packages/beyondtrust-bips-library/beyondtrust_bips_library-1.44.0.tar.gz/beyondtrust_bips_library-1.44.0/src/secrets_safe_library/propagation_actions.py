...
class PropagationActions(APIObject, ListMixin, GetByIdMixin):
    ...
    def get_managed_account_propagation_actions(self, managed_account_id: int) -> list:
        ...
        utils.print_log(
            self._logger,
            f"Calling get_managed_account_propagation_actions endpoint: {endpoint}",
            logging.DEBUG,
        )
    ...
    def post_managed_account_propagation_action_by_id(
        ...
        utils.print_log(
            self._logger,
            f"Calling post_managed_account_propagation_action_by_id endpoint: "
            f"{endpoint}",
            logging.DEBUG,
        )
    ...
    def delete_managed_account_propagation_action(
        ...
        utils.print_log(
            self._logger,
            f"Calling delete_managed_account_propagation_action endpoint: {endpoint}",
            logging.DEBUG,
        )
    ...
    def delete_managed_account_propagation_action_by_id(
        ...
        utils.print_log(
            self._logger,
            f"Calling delete_managed_account_propagation_action_by_id endpoint: "
            f"{endpoint}",
            logging.DEBUG,
        )
