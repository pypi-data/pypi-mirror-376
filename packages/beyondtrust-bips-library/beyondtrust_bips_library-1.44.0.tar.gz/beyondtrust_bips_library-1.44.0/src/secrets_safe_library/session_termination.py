...
class SessionTermination(APIObject):
    ...
    def post_session_terminate_sessionid(
        ...
        utils.print_log(
            self._logger,
            f"Calling post_session_terminate_sessionid endpoint: {endpoint}",
            logging.DEBUG,
        )
    ...
    def post_session_terminate_managedaccountid(
        ...
        utils.print_log(
            self._logger,
            f"Calling post_session_terminate_managedaccountid endpoint: {endpoint}",
            logging.DEBUG,
        )
    ...
    def post_session_terminate_managedsystemid(
        ...
        utils.print_log(
            self._logger,
            f"Calling post_session_terminate_managedsystemid endpoint: {endpoint}",
            logging.DEBUG,
        )
