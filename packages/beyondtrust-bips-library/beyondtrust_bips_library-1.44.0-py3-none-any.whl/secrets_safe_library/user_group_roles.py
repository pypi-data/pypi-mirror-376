...
class UserGroupRoles(APIObject):
    ...
    def get_roles(self, user_group_id: int, smart_rule_id: int) -> List[dict]:
        ...
        utils.print_log(
            self._logger, f"Calling get roles endpoint: {endpoint}", logging.DEBUG
        )
    ...
    def set_roles(
        ...
        utils.print_log(
            self._logger, f"Calling set roles endpoint: {endpoint}", logging.DEBUG
        )
    ...
    def delete_roles(self, user_group_id: int, smart_rule_id: int) -> None:
        ...
        utils.print_log(
            self._logger, f"Calling delete roles endpoint: {endpoint}", logging.DEBUG
        )
