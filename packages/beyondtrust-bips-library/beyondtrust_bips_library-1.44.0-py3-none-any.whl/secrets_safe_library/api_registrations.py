...
class APIRegistration(
    ...
    def get_key_by_id(self, api_registration_id: int) -> str:
        ...
        utils.print_log(
            self._logger, f"Calling get_key_by_id endpoint: {endpoint}", logging.DEBUG
        )
    ...
    def rotate_api_key(self, api_registration_id: int) -> str:
        ...
        utils.print_log(
            self._logger, f"Calling rotate_api_key endpoint: {endpoint}", logging.DEBUG
        )
    ...
    def update_api_registration(
        ...
        utils.print_log(
            self._logger,
            f"Calling update API registration endpoint: {endpoint}",
            logging.DEBUG,
        )
