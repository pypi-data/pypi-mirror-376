...
class QuickRule(
    ...
    def get_by_org_and_title(self, organization_id: int, title: str = None) -> dict:
        ...
        utils.print_log(
            self._logger,
            f"Calling get_by_org_and_title endpoint: {endpoint}",
            logging.DEBUG,
        )
    ...
    def delete_by_org_and_title(self, organization_id: int, title: str) -> None:
        ...
        utils.print_log(
            self._logger,
            f"Calling delete_by_org_and_title endpoint: {endpoint}",
            logging.DEBUG,
        )
    ...
    def create_quick_rule(
        ...
        utils.print_log(
            self._logger, f"Creating Quick Rule with payload: {payload}", logging.DEBUG
        )
