...
class Permission(APIObject, ListMixin):
    ...
    def get_usergroup_permissions(self, usergroup_id: int) -> list:
        ...
        utils.print_log(
            self._logger,
            f"Calling get_usergroup_permissions endpoint: {endpoint}",
            logging.DEBUG,
        )
    ...
    def set_usergroup_permissions(
        ...
        utils.print_log(
            self._logger,
            f"Calling post_usergroup_permissions endpoint: {endpoint}",
            logging.DEBUG,
        )
    ...
    def delete_usergroup_permissions(self, usergroup_id: int) -> None:
        ...
        utils.print_log(
            self._logger,
            f"Calling delete_usergroup_permissions endpoint: {endpoint}",
            logging.DEBUG,
        )
