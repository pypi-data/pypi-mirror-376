...
class Database(APIObject):
    ...
    def get_databases(self) -> list:
        ...
        utils.print_log(
            self._logger,
            f"Calling get_databases endpoint: {endpoint}",
            logging.DEBUG,
        )
    ...
    def get_database_by_id(self, database_id: int) -> dict:
        ...
        utils.print_log(
            self._logger,
            f"Calling get_database_by_id endpoint: {endpoint}",
            logging.DEBUG,
        )
        response = self._run_get_request(endpoint, include_api_version=False)
    ...
    def get_databases_by_asset_id(self, asset_id: int) -> list:
        ...
        utils.print_log(
            self._logger,
            f"Calling get_databases_by_asset_id endpoint: {endpoint}",
            logging.DEBUG,
        )
        response = self._run_get_request(endpoint, include_api_version=False)
    ...
    def post_database_by_asset_id(
        ...
        utils.print_log(
            self._logger,
            f"Calling post_database_by_asset_id endpoint: {endpoint}",
            logging.DEBUG,
        )
    ...
    def put_database_by_id(
        ...
        utils.print_log(
            self._logger,
            f"Calling put_database_by_id endpoint: {endpoint}",
            logging.DEBUG,
        )
    ...
    def delete_database_by_id(self, database_id: int) -> None:
        ...
        utils.print_log(
            self._logger,
            f"Calling delete_database_by_id endpoint: {endpoint}",
            logging.DEBUG,
        )
