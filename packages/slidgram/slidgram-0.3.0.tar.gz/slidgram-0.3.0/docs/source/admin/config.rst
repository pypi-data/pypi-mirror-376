...
slidgram provides the additional component-wide options displayed in the table below.
They can be used:

* in an INI config file by starting slidgram with ``-c /path/to/file.ini``;
