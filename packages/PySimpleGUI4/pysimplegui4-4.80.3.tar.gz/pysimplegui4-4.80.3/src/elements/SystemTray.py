...
class SystemTray:
    ...
    def read(self, timeout=None):
        ...
        """
        if (
            self.last_message_event != TIMEOUT_KEY
            and self.last_message_event is not None
        ):
    ...
    def show_message(
        ...
        event = self.notify(
            ...
            display_duration_in_ms=display_duration,
        )
    ...
    def notify(
        ...
        win_location = (
            ...
            if location is not None
                ...
                screen_res_x - win_width - win_margin[0],
                screen_res_y - win_height - win_margin[1],
            )
        )
        window = Window(
            title,
