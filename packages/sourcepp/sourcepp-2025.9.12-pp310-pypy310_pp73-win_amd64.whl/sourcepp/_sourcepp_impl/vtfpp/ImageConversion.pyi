...
DEFAULT_COMPRESSED_QUALITY: float = 0.10499999672174454

def convert_image_data_to_format(image_data: bytes, old_format: sourcepp._sourcepp_impl.vtfpp.ImageFormat, new_format: sourcepp._sourcepp_impl.vtfpp.ImageFormat, width: int, height: int, quality: float = 0.10499999672174454) -> bytes: ...

def convert_several_image_data_to_format(image_data: bytes, old_format: sourcepp._sourcepp_impl.vtfpp.ImageFormat, new_format: sourcepp._sourcepp_impl.vtfpp.ImageFormat, mip_count: int, frame_count: int, face_count: int, width: int, height: int, slice_count: int, quality: float = 0.10499999672174454) -> bytes: ...
