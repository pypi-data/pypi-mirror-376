...
from . import pytorch_pretrained_bert
...
#             print(valid)
    ...
    def init_hyper_parameters(args):
        ...
        hyper_parameters['use_bert'] = True
    ...
    def load_data(self, input_text, do_predict=False):

        
        flag ='test'
        lines = readfile(input_text, self.dataset_map)
...
def readfile(input_text, dataset_map):
    # f = open(filename)
    data = []
    sentence = []
    label = []
