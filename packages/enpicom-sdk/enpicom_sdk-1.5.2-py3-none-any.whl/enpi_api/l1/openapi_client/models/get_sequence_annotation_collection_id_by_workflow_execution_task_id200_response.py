...
class GetSequenceAnnotationCollectionIdByWorkflowExecutionTaskId200Response(BaseModel):
    """
    GetSequenceAnnotationCollectionIdByWorkflowExecutionTaskId200Response
    """ # noqa: E501
    collection_id: Optional[StrictInt]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetSequenceAnnotationCollectionIdByWorkflowExecutionTaskId200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetSequenceAnnotationCollectionIdByWorkflowExecutionTaskId200Response from a dict"""
        if obj is None:
            return None
