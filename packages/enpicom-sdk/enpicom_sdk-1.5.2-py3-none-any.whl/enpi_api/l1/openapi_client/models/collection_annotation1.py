...
class CollectionAnnotation1(BaseModel):
    """
    CollectionAnnotation1
    """ # noqa: E501
    target: StrictStr
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CollectionAnnotation1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CollectionAnnotation1 from a dict"""
        if obj is None:
            return None
