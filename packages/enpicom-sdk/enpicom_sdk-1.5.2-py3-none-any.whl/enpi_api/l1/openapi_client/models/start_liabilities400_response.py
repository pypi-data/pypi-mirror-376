...
class StartLiabilities400Response(BaseModel):
    """
    StartLiabilities400Response
    """ # noqa: E501
    message: StrictStr = Field(description="Message with a short description of the returned error.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StartLiabilities400Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StartLiabilities400Response from a dict"""
        if obj is None:
            return None
