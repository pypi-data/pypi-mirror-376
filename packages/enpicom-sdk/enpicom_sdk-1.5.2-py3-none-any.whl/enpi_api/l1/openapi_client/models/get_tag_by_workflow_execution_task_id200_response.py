...
class GetTagByWorkflowExecutionTaskId200Response(BaseModel):
    """
    GetTagByWorkflowExecutionTaskId200Response
    """ # noqa: E501
    tag_id: Optional[StrictInt] = Field(description="The id of the tag archetype.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetTagByWorkflowExecutionTaskId200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetTagByWorkflowExecutionTaskId200Response from a dict"""
        if obj is None:
            return None
