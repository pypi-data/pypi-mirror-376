...
class ClusterRunNotFoundResponse(BaseModel):
    """
    ClusterRunNotFoundResponse
    """ # noqa: E501
    result: StrictStr
    message: StrictStr
    ...
    def message_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['Cluster run not found']):
            raise ValueError("must be one of enum values ('Cluster run not found')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ClusterRunNotFoundResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ClusterRunNotFoundResponse from a dict"""
        if obj is None:
            return None
