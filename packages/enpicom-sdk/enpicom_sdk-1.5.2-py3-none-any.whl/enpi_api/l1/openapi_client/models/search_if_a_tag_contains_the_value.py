...
class SearchIfATagContainsTheValue(BaseModel):
    """
    SearchIfATagContainsTheValue
    """ # noqa: E501
    type: StrictStr
    tag_id: Union[StrictFloat, StrictInt]
    tag_value: StrictStr
    __properties: ClassVar[List[str]] = ["type", "tag_id", "tag_value"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['file_tag_value']):
            raise ValueError("must be one of enum values ('file_tag_value')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SearchIfATagContainsTheValue from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SearchIfATagContainsTheValue from a dict"""
        if obj is None:
            return None
