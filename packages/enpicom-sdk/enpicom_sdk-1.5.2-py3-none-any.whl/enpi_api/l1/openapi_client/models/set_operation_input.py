...
class SetOperationInput(BaseModel):
    ...
    """ # noqa: E501
    type: StrictStr
    value: StrictStr = Field(description="The name of an Enrichment set operation. Has to be unique within a template.")
    __properties: ClassVar[List[str]] = ["type", "value"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['set_operation']):
            raise ValueError("must be one of enum values ('set_operation')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SetOperationInput from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SetOperationInput from a dict"""
        if obj is None:
            return None
