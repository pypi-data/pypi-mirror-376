...
class CreateTagRequestTag(BaseModel):
    """
    CreateTagRequestTag
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["key", "data_type", "level"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateTagRequestTag from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateTagRequestTag from a dict"""
        if obj is None:
            return None
