...
class MutationAssaySettings(BaseModel):
    ...
    """ # noqa: E501
    should_filter_vdj_length: StrictBool
    mutation_base_quality_threshold: Union[StrictFloat, StrictInt]
    __properties: ClassVar[List[str]] = ["should_filter_vdj_length", "mutation_base_quality_threshold"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MutationAssaySettings from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MutationAssaySettings from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "should_filter_vdj_length": obj.get("should_filter_vdj_length"),
            "mutation_base_quality_threshold": obj.get("mutation_base_quality_threshold")
        })
        return _obj
