...
class CreateTagConflictResponse(BaseModel):
    """
    ...
    def message_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['Tag already exists']):
            raise ValueError("must be one of enum values ('Tag already exists')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateTagConflictResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateTagConflictResponse from a dict"""
        if obj is None:
            return None
