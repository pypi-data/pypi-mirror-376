...
class FoldChangeAnnotationInputs(BaseModel):
    """
    Inputs for a Fold Change Annotation of an Enrichment operation
    """ # noqa: E501
    name: StrictStr = Field(description="The name of an Enrichment annotation. Has to be unique within a template.")
    operation_name: StrictStr = Field(description="The name of an Enrichment set operation. Has to be unique within a template.")
    type: StrictStr
    inputs: FoldChangeAnnotationInputsInputs
    __properties: ClassVar[List[str]] = ["name", "operation_name", "type", "inputs"]
