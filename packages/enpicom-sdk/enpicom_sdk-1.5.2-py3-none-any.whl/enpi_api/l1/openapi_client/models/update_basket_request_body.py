...
class UpdateBasketRequestBody(BaseModel):
    """
    Values to set as new Basket properties.
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Name of a Basket.")
    shared: Optional[StrictBool] = Field(default=None, description="Determines if this Basket is visible to other members of the organization.")
    __properties: ClassVar[List[str]] = ["name", "shared"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateBasketRequestBody from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateBasketRequestBody from a dict"""
        if obj is None:
            return None
