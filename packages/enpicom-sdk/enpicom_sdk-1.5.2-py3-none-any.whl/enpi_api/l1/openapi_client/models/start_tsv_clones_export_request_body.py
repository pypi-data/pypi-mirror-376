...
class StartTsvClonesExportRequestBody(BaseModel):
    """
    StartTsvClonesExportRequestBody
    """ # noqa: E501
    ...
    def format_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['tsv']):
            raise ValueError("must be one of enum values ('tsv')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StartTsvClonesExportRequestBody from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StartTsvClonesExportRequestBody from a dict"""
        if obj is None:
            return None
