...
class ReferenceDatabaseRevision(BaseModel):
    """
    A single reference database revision.
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["reference_database_id", "reference_database_version", "label", "created_at"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ReferenceDatabaseRevision from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ReferenceDatabaseRevision from a dict"""
        if obj is None:
            return None
