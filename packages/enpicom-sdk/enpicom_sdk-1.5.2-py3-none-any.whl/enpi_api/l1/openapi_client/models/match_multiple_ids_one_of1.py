...
class MatchMultipleIDsOneOf1(BaseModel):
    """
    MatchMultipleIDsOneOf1
    """ # noqa: E501
    type: StrictStr
    target: StrictStr
    ids: List[StrictStr]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MatchMultipleIDsOneOf1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MatchMultipleIDsOneOf1 from a dict"""
        if obj is None:
            return None
