...
class MLModelEndpoint(BaseModel):
    """
    An ML Model Endpoint.
    """ # noqa: E501
    display_name: StrictStr
    id: StrictStr
    organization_id: StrictInt = Field(description="The identifier of organization that has access to this ML endpoint.")
    __properties: ClassVar[List[str]] = ["display_name", "id", "organization_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MLModelEndpoint from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MLModelEndpoint from a dict"""
        if obj is None:
            return None
