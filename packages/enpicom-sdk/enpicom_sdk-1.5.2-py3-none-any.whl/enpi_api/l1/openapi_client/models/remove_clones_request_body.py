...
class RemoveClonesRequestBody(BaseModel):
    """
    RemoveClonesRequestBody
    """ # noqa: E501
    clone_ids: List[StrictStr] = Field(description="Identifiers of clones that will be removed from Basket.")
    __properties: ClassVar[List[str]] = ["clone_ids"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RemoveClonesRequestBody from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RemoveClonesRequestBody from a dict"""
        if obj is None:
            return None
