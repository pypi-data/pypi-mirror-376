...
class MatchMultipleIDsOneOf(BaseModel):
    """
    MatchMultipleIDsOneOf
    """ # noqa: E501
    type: StrictStr
    target: StrictStr
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MatchMultipleIDsOneOf from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MatchMultipleIDsOneOf from a dict"""
        if obj is None:
            return None
