...
class GetTagsRequestSearch(BaseModel):
    """
    GetTagsRequestSearch
    """ # noqa: E501
    level: StrictStr = Field(description="The level of a tag archetype")
    keys: Optional[List[StrictStr]] = Field(default=None, description="Optionally filter the tags by key, multiple keys are used as an OR condition. The provided values are case-insensitive and will             be matched as a substring.")
    __properties: ClassVar[List[str]] = ["level", "keys"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetTagsRequestSearch from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetTagsRequestSearch from a dict"""
        if obj is None:
            return None
