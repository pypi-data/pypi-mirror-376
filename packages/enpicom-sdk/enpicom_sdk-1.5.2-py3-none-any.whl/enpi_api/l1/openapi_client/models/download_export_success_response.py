...
class DownloadExportSuccessResponse(BaseModel):
    """
    DownloadExportSuccessResponse
    """ # noqa: E501
    download_url: StrictStr = Field(description="The URL to download the export contents from.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DownloadExportSuccessResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DownloadExportSuccessResponse from a dict"""
        if obj is None:
            return None
