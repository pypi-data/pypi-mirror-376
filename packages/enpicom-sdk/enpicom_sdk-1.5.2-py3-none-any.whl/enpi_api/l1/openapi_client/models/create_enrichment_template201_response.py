...
class CreateEnrichmentTemplate201Response(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateEnrichmentTemplate201Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateEnrichmentTemplate201Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "template": EnrichmentTemplate.from_dict(obj["template"]) if obj.get("template") is not None else None
        })
        return _obj
