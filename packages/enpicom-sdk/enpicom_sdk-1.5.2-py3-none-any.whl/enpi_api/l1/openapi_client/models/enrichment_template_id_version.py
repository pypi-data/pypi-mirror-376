...
class EnrichmentTemplateIdVersion(BaseModel):
    """
    A template identifier with id and version
    """ # noqa: E501
    id: StrictStr
    version: StrictInt
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EnrichmentTemplateIdVersion from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EnrichmentTemplateIdVersion from a dict"""
        if obj is None:
            return None
