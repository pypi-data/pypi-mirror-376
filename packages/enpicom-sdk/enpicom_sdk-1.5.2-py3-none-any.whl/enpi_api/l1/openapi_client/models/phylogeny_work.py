...
class PhylogenyWork(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["cluster_run_id", "cluster_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PhylogenyWork from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PhylogenyWork from a dict"""
        if obj is None:
            return None
