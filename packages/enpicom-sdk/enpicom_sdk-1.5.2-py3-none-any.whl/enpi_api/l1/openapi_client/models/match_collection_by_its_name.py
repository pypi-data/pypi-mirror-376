...
class MatchCollectionByItsName(BaseModel):
    """
    MatchCollectionByItsName
    """ # noqa: E501
    type: StrictStr
    value: StrictStr
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['collection_name']):
            raise ValueError("must be one of enum values ('collection_name')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MatchCollectionByItsName from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MatchCollectionByItsName from a dict"""
        if obj is None:
            return None
