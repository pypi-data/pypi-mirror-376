...
class GetCollectionIdByWorkflowExecutionTaskId200Response(BaseModel):
    """
    GetCollectionIdByWorkflowExecutionTaskId200Response
    """ # noqa: E501
    collection_id: StrictInt = Field(description="The identifier of a clone collection.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetCollectionIdByWorkflowExecutionTaskId200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetCollectionIdByWorkflowExecutionTaskId200Response from a dict"""
        if obj is None:
            return None
