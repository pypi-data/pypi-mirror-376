...
class InvokeMlEndpointRequestOneOf1(BaseModel):
    """
    InvokeMlEndpointRequestOneOf1
    """ # noqa: E501
    clone_ids: Annotated[List[StrictStr], Field(min_length=1)]
    collection_ids: Optional[Any] = None
    parameters: Optional[Dict[str, InvokeMlEndpointRequestOneOfParametersValue]] = None
    __properties: ClassVar[List[str]] = ["clone_ids", "collection_ids", "parameters"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InvokeMlEndpointRequestOneOf1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InvokeMlEndpointRequestOneOf1 from a dict"""
        if obj is None:
            return None
