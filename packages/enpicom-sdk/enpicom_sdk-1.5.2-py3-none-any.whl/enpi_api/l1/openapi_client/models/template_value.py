...
class TemplateValue(BaseModel):
    """
    Can only be used in a templated metadata import.
    """ # noqa: E501
    type: StrictStr
    key: Optional[StrictStr] = Field(default=None, description="The key of the template value, when empty, it will fall back to the key of the tag")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TemplateValue from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TemplateValue from a dict"""
        if obj is None:
            return None
