...
class MlInputMapItem(BaseModel):
    """
    Map of input key to tag ID with an optional chain specifier
    """ # noqa: E501
    tag_id: Optional[StrictInt]
    input_key: StrictStr
    chains: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["tag_id", "input_key", "chains"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MlInputMapItem from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MlInputMapItem from a dict"""
        if obj is None:
            return None
