...
class DownloadFileSuccessResponse(BaseModel):
    """
    DownloadFileSuccessResponse
    """ # noqa: E501
    download_url: StrictStr = Field(description="The URL to download the file with the export contents from.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DownloadFileSuccessResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DownloadFileSuccessResponse from a dict"""
        if obj is None:
            return None
