...
class MatchSingleID1Id(BaseModel):
    """
    MatchSingleID1Id
    """ # noqa: E501
    type: StrictStr
    key: Optional[StrictStr] = Field(default=None, description="The key of the template value, when empty, it will fall back to one of the following names, depending on the target level:     - `collection_id` for collections     - `clone_id` for clones     - `sequence_id` for sequences")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MatchSingleID1Id from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MatchSingleID1Id from a dict"""
        if obj is None:
            return None
