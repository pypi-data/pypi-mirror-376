...
class MalformedClusterConfiguration(BaseModel):
    """
    MalformedClusterConfiguration
    """ # noqa: E501
    result: StrictStr
    message: StrictStr
    ...
    def message_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['Malformed Cluster Configuration']):
            raise ValueError("must be one of enum values ('Malformed Cluster Configuration')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MalformedClusterConfiguration from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MalformedClusterConfiguration from a dict"""
        if obj is None:
            return None
