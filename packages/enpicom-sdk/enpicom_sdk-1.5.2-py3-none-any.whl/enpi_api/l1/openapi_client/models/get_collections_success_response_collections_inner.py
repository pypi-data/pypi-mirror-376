...
class GetCollectionsSuccessResponseCollectionsInner(BaseModel):
    """
    GetCollectionsSuccessResponseCollectionsInner
    """ # noqa: E501
    tags: Optional[List[TagsInner]] = None
    id: StrictInt = Field(description="The identifier of a clone collection.")
    __properties: ClassVar[List[str]] = ["tags", "id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetCollectionsSuccessResponseCollectionsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetCollectionsSuccessResponseCollectionsInner from a dict"""
        if obj is None:
            return None
