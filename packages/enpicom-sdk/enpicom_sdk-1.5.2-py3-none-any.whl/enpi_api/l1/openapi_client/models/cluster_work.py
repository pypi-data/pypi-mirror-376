...
class ClusterWork(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "collection_ids", "identities", "sequence_features", "match_tags", "additional_options"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ClusterWork from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ClusterWork from a dict"""
        if obj is None:
            return None
