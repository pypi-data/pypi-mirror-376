...
class CreateBasketResponseBody(BaseModel):
    """
    CreateBasketResponseBody
    """ # noqa: E501
    basket: Basket
    __properties: ClassVar[List[str]] = ["basket"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateBasketResponseBody from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateBasketResponseBody from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "basket": Basket.from_dict(obj["basket"]) if obj.get("basket") is not None else None
        })
        return _obj
