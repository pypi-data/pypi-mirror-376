...
class MlEndpointSignature(BaseModel):
    """
    ...
    kind: StrictStr
    type: StrictStr
    __properties: ClassVar[List[str]] = ["key", "kind", "type"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MlEndpointSignature from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MlEndpointSignature from a dict"""
        if obj is None:
            return None
