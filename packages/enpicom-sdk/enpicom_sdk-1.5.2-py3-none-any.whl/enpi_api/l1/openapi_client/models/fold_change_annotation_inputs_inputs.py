...
class FoldChangeAnnotationInputsInputs(BaseModel):
    """
    FoldChangeAnnotationInputsInputs
    """ # noqa: E501
    var_from: Optional[DifferenceOperationInputsInputsRemove] = Field(default=None, alias="from")
    to: Optional[DifferenceOperationInputsInputsRemove] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FoldChangeAnnotationInputsInputs from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FoldChangeAnnotationInputsInputs from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "to": DifferenceOperationInputsInputsRemove.from_dict(obj["to"]) if obj.get("to") is not None else None
        })
        return _obj
