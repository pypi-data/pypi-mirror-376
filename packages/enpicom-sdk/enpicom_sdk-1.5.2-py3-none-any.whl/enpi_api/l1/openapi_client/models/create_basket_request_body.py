...
class CreateBasketRequestBody(BaseModel):
    """
    CreateBasketRequestBody
    """ # noqa: E501
    name: StrictStr = Field(description="Name of a Basket.")
    shared: Optional[StrictBool] = Field(default=True, description="Determines if this Basket is visible to other members of the organization.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateBasketRequestBody from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateBasketRequestBody from a dict"""
        if obj is None:
            return None
