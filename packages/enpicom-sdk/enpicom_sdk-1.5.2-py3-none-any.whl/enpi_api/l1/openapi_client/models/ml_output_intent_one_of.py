...
class MlOutputIntentOneOf(BaseModel):
    """
    MlOutputIntentOneOf
    """ # noqa: E501
    filetype: StrictStr
    ...
    type: StrictStr
    __properties: ClassVar[List[str]] = ["filetype", "output_key", "type"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MlOutputIntentOneOf from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MlOutputIntentOneOf from a dict"""
        if obj is None:
            return None
