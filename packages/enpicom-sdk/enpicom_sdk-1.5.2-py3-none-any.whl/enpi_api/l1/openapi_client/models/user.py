...
class User(BaseModel):
    """
    Information about the user assigned to this key
    """ # noqa: E501
    id: Optional[StrictInt]
    is_machine: StrictBool = Field(description="Whether the user is a machine user.")
    __properties: ClassVar[List[str]] = ["id", "is_machine"]
