...
from enpi_api.l1.openapi_client.api_response import ApiResponse, T as ApiResponseT
import enpi_api.l1.openapi_client.models
from enpi_api.l1.openapi_client import rest
from enpi_api.l1.openapi_client.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(enpi_api.l1.openapi_client.models, klass)
