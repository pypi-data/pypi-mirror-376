...
class TripPenalties(BaseModel):
    ...
    max_locations_limits_penalty: Optional[Union[Annotated[float, Field(le=1000000000, strict=True, ge=0)], Annotated[int, Field(le=1000000000, strict=True, ge=0)]]] = Field(default=0.0, description="The maximum allowable amount of fines for violating location's capacity limit.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "max_locations_limits_penalty": obj.get("max_locations_limits_penalty") if obj.get("max_locations_limits_penalty") is not None else 0.0
        })
