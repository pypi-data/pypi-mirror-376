...
class CapacityMultiplier(BaseModel):
    ...
    """ # noqa: E501
    mass: Optional[Union[Annotated[float, Field(le=1000, strict=True, ge=0)], Annotated[int, Field(le=1000, strict=True, ge=0)]]] = Field(default=1.0, description="Mass multiplier.")
    volume: Optional[Union[Annotated[float, Field(le=1000, strict=True, ge=0)], Annotated[int, Field(le=1000, strict=True, ge=0)]]] = Field(default=1.0, description="Volume multiplier.")
    capacity_a: Optional[Union[Annotated[float, Field(le=1000, strict=True, ge=0)], Annotated[int, Field(le=1000, strict=True, ge=0)]]] = Field(default=1.0, description="Additional parameter (A) multiplier.")
    capacity_b: Optional[Union[Annotated[float, Field(le=1000, strict=True, ge=0)], Annotated[int, Field(le=1000, strict=True, ge=0)]]] = Field(default=1.0, description="Additional parameter (B) multiplier.")
    capacity_c: Optional[Union[Annotated[float, Field(le=1000, strict=True, ge=0)], Annotated[int, Field(le=1000, strict=True, ge=0)]]] = Field(default=1.0, description="Additional parameter (C) multiplier.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "mass": obj.get("mass") if obj.get("mass") is not None else 1.0,
            "volume": obj.get("volume") if obj.get("volume") is not None else 1.0,
            "capacity_a": obj.get("capacity_a") if obj.get("capacity_a") is not None else 1.0,
            "capacity_b": obj.get("capacity_b") if obj.get("capacity_b") is not None else 1.0,
            "capacity_c": obj.get("capacity_c") if obj.get("capacity_c") is not None else 1.0
        })
