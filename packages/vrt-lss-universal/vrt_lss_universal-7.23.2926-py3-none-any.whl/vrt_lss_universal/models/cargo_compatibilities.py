...
class CargoCompatibilities(BaseModel):
    ...
    """ # noqa: E501
    width: Optional[Union[Annotated[float, Field(le=1000000, strict=True, ge=0)], Annotated[int, Field(le=1000000, strict=True, ge=0)]]] = Field(default=0.0, description="Width in meters, used to check the transport box capacity.")
    height: Optional[Union[Annotated[float, Field(le=1000000, strict=True, ge=0)], Annotated[int, Field(le=1000000, strict=True, ge=0)]]] = Field(default=0.0, description="Height in meters, used to check the transport box capacity.")
    length: Optional[Union[Annotated[float, Field(le=1000000, strict=True, ge=0)], Annotated[int, Field(le=1000000, strict=True, ge=0)]]] = Field(default=0.0, description="Length in meters, used to check the transport box capacity.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "width": obj.get("width") if obj.get("width") is not None else 0.0,
            "height": obj.get("height") if obj.get("height") is not None else 0.0,
            "length": obj.get("length") if obj.get("length") is not None else 0.0,
