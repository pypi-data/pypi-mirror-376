...
class Capacity(BaseModel):
    ...
    """ # noqa: E501
    mass: Optional[Union[Annotated[float, Field(le=1000000, strict=True, ge=0)], Annotated[int, Field(le=1000000, strict=True, ge=0)]]] = Field(default=0.0, description="Weight in kilograms.")
    volume: Optional[Union[Annotated[float, Field(le=1000000, strict=True, ge=0)], Annotated[int, Field(le=1000000, strict=True, ge=0)]]] = Field(default=0.0, description="Volume in cubic meters.")
    capacity_a: Optional[Union[Annotated[float, Field(le=1000000, strict=True, ge=0)], Annotated[int, Field(le=1000000, strict=True, ge=0)]]] = Field(default=0.0, description="Additional parameter (A) for measuring cargoes and boxes in alternative units. For example, to account for cargo in pieces (this parameter is equal to one for a cargo and the maximum number of cargo to hold for a box). ")
    capacity_b: Optional[Union[Annotated[float, Field(le=1000000, strict=True, ge=0)], Annotated[int, Field(le=1000000, strict=True, ge=0)]]] = Field(default=0.0, description="Additional parameter (B) for measuring cargoes and boxes in alternative units. ")
    capacity_c: Optional[Union[Annotated[float, Field(le=1000000, strict=True, ge=0)], Annotated[int, Field(le=1000000, strict=True, ge=0)]]] = Field(default=0.0, description="Additional parameter (C) for measuring cargoes and boxes in alternative units. ")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "mass": obj.get("mass") if obj.get("mass") is not None else 0.0,
            "volume": obj.get("volume") if obj.get("volume") is not None else 0.0,
            "capacity_a": obj.get("capacity_a") if obj.get("capacity_a") is not None else 0.0,
            "capacity_b": obj.get("capacity_b") if obj.get("capacity_b") is not None else 0.0,
            "capacity_c": obj.get("capacity_c") if obj.get("capacity_c") is not None else 0.0
        })
