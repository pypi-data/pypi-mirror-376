...
async def get_spreadsheet(
        ...
        excludeTablesInBandedRanges: Annotated[
            Optional[bool, Field(description="Whether to exclude tables in banded ranges")]] = False
):
...
async def list_spreadsheets(
        ...
        pageToken: Annotated[
            Optional[str, Field(description="The token for continuing a previous list request")]] = None,
        query: Annotated[Optional[
            str, Field(description="Optional filter for spreadsheets (e.g., \"name contains 'report'\")")]] = None
...
async def batch_update_spreadsheet(
        ...
        includeSpreadsheetInResponse: Annotated[
            Optional[bool, Field(description="Whether to include the updated spreadsheet in the response")]] = False,
        responseIncludeGridData: Annotated[
            Optional[bool, Field(description="Whether to include grid data in the response")]] = False
):
    body = {
...
async def append_values(
        ...
        valueInputOption: Annotated[
            Optional[ValueInputOption, Field(description="How the input data should be interpreted")]] = None,
        insertDataOption: Annotated[
            Optional[InsertDataOption, Field(description="How the input data should be inserted")]] = None,
):
...
async def get_values(
        ...
        majorDimension: Annotated[
            Optional[Dimension, Field(description="The major dimension of the values")]] = Dimension.ROWS,
        valueRenderOption: Annotated[Optional[
            ValueRenderOption, Field(description="How values should be rendered")]] = ValueRenderOption.FORMATTED_VALUE,
        dateTimeRenderOption: Annotated[Optional[DateTimeRenderOption, Field(
            description="How dates, times, and durations should be rendered")]] = DateTimeRenderOption.SERIAL_NUMBER
):
...
async def update_values(
        ...
        valueInputOption: Annotated[
            Optional[ValueInputOption, Field(description="How the input data should be interpreted")]] = None,
        includeValuesInResponse: Annotated[
            Optional[bool, Field(description="Whether to include the updated values in the response")]] = False,
        responseValueRenderOption: Annotated[Optional[ValueRenderOption, Field(
            description="How values should be rendered in the response")]] = ValueRenderOption.FORMATTED_VALUE,
        responseDateTimeRenderOption: Annotated[Optional[DateTimeRenderOption, Field(
            description="How dates, times, and durations should be rendered in the response")]] = DateTimeRenderOption.SERIAL_NUMBER
):
    body = body.model_dump(mode="json")
...
async def batch_update_values(
        ...
        valueInputOption: Annotated[
            ValueInputOption, Field(description="How the input data should be interpreted")] = None,
        includeValuesInResponse: Annotated[
            Optional[bool, Field(description="Whether to include the updated values in the response")]] = False,
        responseValueRenderOption: Annotated[Optional[ValueRenderOption, Field(
            description="How values should be rendered in the response")]] = ValueRenderOption.FORMATTED_VALUE,
...
async def batch_update_values_by_data_filter(
        spreadsheetId: Annotated[str, Field(description="The ID of the spreadsheet to update values in")],
        data: Annotated[
            List[DataFilterValueRange], Field(description="The list of data filter value ranges to update")],
        valueInputOption: Annotated[
            ValueInputOption, Field(description="How the input data should be interpreted")] = None,
        includeValuesInResponse: Annotated[
            Optional[bool, Field(description="Whether to include the updated values in the response")]] = False,
