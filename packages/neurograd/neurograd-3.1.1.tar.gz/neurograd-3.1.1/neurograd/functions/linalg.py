...
class EinSum(Function, Module):
    name = "EinSum"
    def __init__(self, subscripts: str, optimize = None, 
    ...
    def forward(self, *operands: xp.ndarray) -> xp.ndarray:
        ...
        if self.backend == "opt_einsum":
            ...
            return self.cuquantum_contract(self.subscripts, *operands, optimize=self.optimize)
        else:
    ...
    def backward(self, grad_output: xp.ndarray):
        ...
        for i, tensor in enumerate(self.parent_tensors):
            ...
            if self.backend == "opt_einsum":
                ...
                grad = self.cuquantum_contract(grad_equation, *grad_operands, optimize=self.optimize)
