...
class DataLoader:
    ...
    def prefetch(self, num_batches: int = None):
        ...
        # Robust prefetching implementation with fallback
        import threading
        ...
        try:
            ...
            # Fallback to synchronous iteration if threading fails
            print(f"Warning: Prefetching failed ({e}), falling back to synchronous iteration")
