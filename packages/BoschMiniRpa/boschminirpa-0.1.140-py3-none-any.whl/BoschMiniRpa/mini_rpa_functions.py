...
class MiniRpaFunction(MiniRPACore):
    ...
    #                         self.batch_copy_files_within_public_folders(from_server_name, from_share_name, sub_from_folder_path, file_key_word, update_server_name,
    #                                                                     update_share_name, update_folder_path, copy_mode, deep_search)
    #         finally:
