...
from PETINA.package.BayesianOptimization_local.constraint import ConstraintModel
...
class BayesianOptimization(Observable):
    ...
    def maximize(self,
        ...
        acquisition_function: object, optional
            An instance of PETINA.package.BayesianOptimization_local.util.UtilityFunction.
        ...
        if old_params_used or gp_params:
            raise Exception('\nPassing acquisition function parameters or gaussian process parameters to maximize'
                                     ...
                                     '\n the gp params, and pass an instance of PETINA.package.BayesianOptimization_local.util.UtilityFunction'
