import pytest
import numpy as np
from PETINA.package.BayesianOptimization_local import UtilityFunction
from PETINA.package.BayesianOptimization_local import BayesianOptimization
from PETINA.package.BayesianOptimization_local.logger import ScreenLogger
from PETINA.package.BayesianOptimization_local.event import Events, DEFAULT_EVENTS
from PETINA.package.BayesianOptimization_local.util import NotUniqueError
import pickle
import os
