...
class ThreeDisplayBlock(StructBlock):
    ...
    autospin = DecimalBlock(required=False, default=0, help_text=_("Auto-spin speed for the model, negative values change direction."))
    offset = DecimalBlock(required=False, default=0, help_text=_("Offset for the model position."))
    ...
    room_size_multiplier = DecimalBlock(required=False, default=1, help_text=_("Multiplier for the room size."))
