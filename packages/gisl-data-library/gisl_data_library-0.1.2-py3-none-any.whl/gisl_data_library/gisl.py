...
def get_character_data(character_name: str) -> dict:
    ...
    print(f"GISL_DATA_LIBRARY: Attempting to retrieve data for character: {character_name}")
    data = gisl_data.get(character_name.lower(), {})
    if not data:
        logger.warning(f"No data found for character: {character_name}")
        print(f"GISL_DATA_LIBRARY: No data found for character: {character_name}")
    else:
        logger.info(f"Data found for character: {character_name}")
        print(f"GISL_DATA_LIBRARY: Data found for character: {character_name}")
    return data
