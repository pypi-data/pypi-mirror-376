...
class FeedbackAnon(BaseModel):
    """
    FeedbackAnon
    """ # noqa: E501
    source: StrictStr = Field(description="Source identifier")
    feedback: StrictStr = Field(description="Anonymous user feedback or comment.")
    __properties: ClassVar[List[str]] = ["source", "feedback"]
