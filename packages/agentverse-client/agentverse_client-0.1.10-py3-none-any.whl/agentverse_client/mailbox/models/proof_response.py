...
class ProofResponse(BaseModel):
    ...
    ProofResponse
    """ # noqa: E501
    access_token: StrictStr = Field(description="Access token generated upon successful proof.")
    expiry: datetime = Field(description="UTC datetime at which the access token expires.")
    __properties: ClassVar[List[str]] = ["access_token", "expiry"]
