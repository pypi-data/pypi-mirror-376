...
class ProofRequest(BaseModel):
    ...
    ProofRequest
    """ # noqa: E501
    address: StrictStr = Field(description="Address of the agent requesting authentication.")
    challenge: StrictStr = Field(description="Challenge string previously issued to this agent.")
    challenge_response: StrictStr = Field(description="Response proving ownership of the address.")
    __properties: ClassVar[List[str]] = ["address", "challenge", "challenge_response"]
