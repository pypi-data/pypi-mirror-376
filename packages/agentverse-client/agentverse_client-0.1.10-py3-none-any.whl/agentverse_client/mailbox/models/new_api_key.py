...
class NewApiKey(BaseModel):
    ...
    expiry: StrictInt = Field(description="Expiration timestamp in milliseconds since epoch.")
    name: Annotated[str, Field(min_length=1, strict=True, max_length=250)] = Field(description="Name for the API key.")
    scope: Optional[StrictStr] = Field(default='', description="Scope or permissions granted by the API key.")
    __properties: ClassVar[List[str]] = ["id", "expiry", "name", "scope"]
