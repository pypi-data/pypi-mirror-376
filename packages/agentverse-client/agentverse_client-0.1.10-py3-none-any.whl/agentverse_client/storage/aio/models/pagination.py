...
class Pagination(BaseModel):
    ...
    Pagination
    """ # noqa: E501
    offset: StrictInt = Field(description="Number of items to skip before starting to collect the result set.")
    limit: StrictInt = Field(description="Maximum number of items to return.")
