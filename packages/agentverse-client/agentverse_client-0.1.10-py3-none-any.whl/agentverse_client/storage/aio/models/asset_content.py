...
class AssetContent(BaseModel):
    ...
    AssetContent
    """ # noqa: E501
    mime_type: StrictStr = Field(description="MIME type of the asset content (e.g., 'image/png').")
    contents: StrictStr = Field(description="Base64-encoded string representing the asset contents.")
    __properties: ClassVar[List[str]] = ["mime_type", "contents"]
