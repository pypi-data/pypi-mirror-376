...
class TestAssetContent(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AssetContent:
        """Test AssetContent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AssetContent`
        """
        model = AssetContent()
        if include_optional:
            return AssetContent(
