...
from agentverse_client.storage.aio.api_response import ApiResponse, T as ApiResponseT
import agentverse_client.storage.aio.models
from agentverse_client.storage.aio import rest
from agentverse_client.storage.aio.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(agentverse_client.storage.aio.models, klass)
