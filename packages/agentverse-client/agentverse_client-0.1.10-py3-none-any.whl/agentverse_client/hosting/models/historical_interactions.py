...
class HistoricalInteractions(BaseModel):
    """
    HistoricalInteractions
    """ # noqa: E501
    data_points: Dict[str, StrictInt] = Field(description="Dictionary mapping dates to interaction counts.")
    total_interactions: StrictInt = Field(description="Total number of interactions.")
    __properties: ClassVar[List[str]] = ["data_points", "total_interactions"]
