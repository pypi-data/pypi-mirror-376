...
class TestInteractionPeriod(unittest.TestCase):
    """InteractionPeriod unit test stubs"""
    ...
    def testInteractionPeriod(self):
        """Test InteractionPeriod"""
        # inst = InteractionPeriod()
