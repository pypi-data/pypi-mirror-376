# agentverse_client.almanac.aio.ManifestsApi
...
async with agentverse_client.almanac.aio.ApiClient(configuration) as api_client:
    ...
    api_instance = agentverse_client.almanac.aio.ManifestsApi(api_client)
    protocol_digest = 'protocol_digest_example' # str | 

    try:
        # Get Protocol Manifest
        api_response = await api_instance.get_manifest(protocol_digest)
...
async with agentverse_client.almanac.aio.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Protocol Models
        api_response = await api_instance.get_protocol_models(model_digest)
...
async with agentverse_client.almanac.aio.ApiClient(configuration) as api_client:
    ...
    try:
        # Upload Manifest
        api_response = await api_instance.list_manifests(body)
...
async with agentverse_client.almanac.aio.ApiClient(configuration) as api_client:
    ...
    try:
        # Resolve Procotol Digests
        api_response = await api_instance.resolve_protocol_digest(protocol_digest=protocol_digest)
...
async with agentverse_client.almanac.aio.ApiClient(configuration) as api_client:
    ...
    try:
        # Search Procotol Digests
        api_response = await api_instance.search_protocol_digests(name=name)
