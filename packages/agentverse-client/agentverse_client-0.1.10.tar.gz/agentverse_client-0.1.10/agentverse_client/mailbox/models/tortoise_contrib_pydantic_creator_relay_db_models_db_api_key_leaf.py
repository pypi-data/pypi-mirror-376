...
class TortoiseContribPydanticCreatorRelayDbModelsDbApiKeyLeaf(BaseModel):
    """
    ...
    expires_at: datetime
    scope: Optional[Annotated[str, Field(strict=True, max_length=250)]] = None
    __properties: ClassVar[List[str]] = ["id", "name", "expires_at", "scope"]
