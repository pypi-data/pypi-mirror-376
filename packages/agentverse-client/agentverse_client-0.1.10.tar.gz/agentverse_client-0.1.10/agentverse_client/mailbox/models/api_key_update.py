...
class ApiKeyUpdate(BaseModel):
    ...
    ApiKeyUpdate
    """ # noqa: E501
    id: StrictStr = Field(description="Identifier of the API key to update.")
    expiry: StrictInt = Field(description="New expiration timestamp in milliseconds since epoch.")
    __properties: ClassVar[List[str]] = ["id", "expiry"]
