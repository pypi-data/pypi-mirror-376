...
class MailboxQuotas(BaseModel):
    """
    Class for representing Mailbox user quotas
    """ # noqa: E501
    bytes_transferred: StrictInt
    num_messages: StrictInt
    bytes_stored: StrictInt
    num_agents: StrictInt
    __properties: ClassVar[List[str]] = ["bytes_transferred", "num_messages", "bytes_stored", "num_agents"]
