...
class Feedback(BaseModel):
    ...
    Feedback
    """ # noqa: E501
    score: Annotated[int, Field(le=4, strict=True, ge=1)] = Field(description="Feedback score between 1 (bad) and 4 (excellent).")
    feedback: StrictStr = Field(description="Detailed user feedback or comment.")
    __properties: ClassVar[List[str]] = ["score", "feedback"]
