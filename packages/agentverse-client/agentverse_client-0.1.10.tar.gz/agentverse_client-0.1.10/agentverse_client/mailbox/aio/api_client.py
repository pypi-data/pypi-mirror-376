...
from agentverse_client.mailbox.aio.api_response import ApiResponse, T as ApiResponseT
import agentverse_client.mailbox.aio.models
from agentverse_client.mailbox.aio import rest
from agentverse_client.mailbox.aio.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(agentverse_client.mailbox.aio.models, klass)
