...
class TestUploadAssetResponse(unittest.TestCase):
    """UploadAssetResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UploadAssetResponse:
        """Test UploadAssetResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UploadAssetResponse`
        """
        model = UploadAssetResponse()
        if include_optional:
    ...
    def testUploadAssetResponse(self):
        """Test UploadAssetResponse"""
