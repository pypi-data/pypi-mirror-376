...
class TestNewPermission(unittest.TestCase):
    """NewPermission unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NewPermission:
        """Test NewPermission
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NewPermission`
        """
        model = NewPermission()
        if include_optional:
