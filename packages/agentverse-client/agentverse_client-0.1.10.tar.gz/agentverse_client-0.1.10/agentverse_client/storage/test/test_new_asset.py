...
class TestNewAsset(unittest.TestCase):
    """NewAsset unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NewAsset:
        """Test NewAsset
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NewAsset`
        """
        model = NewAsset()
        if include_optional:
            return NewAsset(
