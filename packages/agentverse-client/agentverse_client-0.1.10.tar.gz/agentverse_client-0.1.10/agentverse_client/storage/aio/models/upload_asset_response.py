...
class UploadAssetResponse(BaseModel):
    ...
    UploadAssetResponse
    """ # noqa: E501
    asset_id: StrictStr = Field(description="Unique identifier of the uploaded asset.")
    reference: StrictStr = Field(description="Internal reference string pointing to the stored asset.")
    __properties: ClassVar[List[str]] = ["asset_id", "reference"]
