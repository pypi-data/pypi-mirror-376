...
class TestStorageItem(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> StorageItem:
        """Test StorageItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StorageItem`
        """
        model = StorageItem()
        if include_optional:
            return StorageItem(
