...
class NewDomainName(BaseModel):
    """
    NewDomainName
    """ # noqa: E501
    domain_name: StrictStr = Field(description="The new domain name to register for the agent.")
    __properties: ClassVar[List[str]] = ["domain_name"]
