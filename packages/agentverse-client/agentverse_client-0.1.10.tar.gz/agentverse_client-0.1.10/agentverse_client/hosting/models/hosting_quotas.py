...
class HostingQuotas(BaseModel):
    """
    Class for representing Agentverse hosting user quotas
    """ # noqa: E501
    computation_time: StrictInt
    num_messages: StrictInt
    num_message_bytes: StrictInt
    num_storage_bytes: StrictInt
    num_agents: StrictInt
    __properties: ClassVar[List[str]] = ["computation_time", "num_messages", "num_message_bytes", "num_storage_bytes", "num_agents"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "num_message_bytes": obj.get("num_message_bytes"),
            "num_storage_bytes": obj.get("num_storage_bytes"),
