...
class _Crc64Calculator:
    ...
    def __init__(self, polynomial: int, initial_xor=0xffffffffffffffff) -> None:
        self._construct_lookup_table(polynomial)
        self._crc64 = initial_xor


    @property
    def crc64(self) -> Crc64Result:
    ...
    def update(self, content: bytes | bytearray) -> None:
    ...
    def _construct_lookup_table(self, polynomial: int) -> None:
