...
class ContainerContainerPullThroughDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["pulp_labels", "repository", "prn", "base_path", "hidden", "pulp_created", "content_guard", "name", "pulp_href", "no_content_change_since", "pulp_last_updated", "remote", "distributions", "namespace", "private", "description"]
