...
class OpenAIResponseGenerator:
    ...
    async def generate_with_fallback(
        self,
        messages: List[Message],
        fallback_response: str = "I apologize, but I'm unable to generate a response at this time.",
        **kwargs
    ) -> Dict[str, Any]:
        """
        ...
        Args:
            ...
            fallback_response: Fallback response text
            **kwargs: Additional parameters for generate_final_response
            
        Returns:
            Response dictionary (generated or fallback)
        """
        try:
            return await self.generate_final_response(messages, **kwargs)
        except Exception as e:
            logger.error(f"Failed to generate response, using fallback: {str(e)}")
