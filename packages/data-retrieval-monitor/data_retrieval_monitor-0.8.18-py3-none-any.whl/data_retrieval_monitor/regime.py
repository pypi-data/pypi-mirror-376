...
def main():
    ...
    addon_df.to_csv(os.path.join('./', "addon_regimes.csv"))
    # ====================== ADD-ONS END ======================
   ...
   # ---------- README ----------
    with open(os.path.join(OUTPUT_DIR, "README_outputs.txt"), "w") as f:
        ...
        "Add-ons generated files:\n"
        "- exhibit4_vqvae_ind.png / exhibit4_saint_knn.png / exhibit4_conformal.png\n"
        "- vqvae_ind_*_by_regime.csv + *_heatmap.png\n"
        "- saint_knn_*_by_regime.csv + *_heatmap.png\n"
        "- conformal_*_by_regime.csv + *_heatmap.png\n"
        "- conformal_pvalues.csv, conformal_regimes.csv, addon_regimes.csv\n"
        "- rolling_gaussian_distances.csv\n"
    )
