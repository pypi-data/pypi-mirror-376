...
0. $$\text{maximize } \sum_{i \in I} \sum_{j \in J} \sum_{t \in T} \frac{r^t \cdot a_{ijt} \cdot x_{ij}}{(1+\tau)^t}$$
...
Python Package Version 1.1.2 https://pypi.org/project/treemun-sim/
```