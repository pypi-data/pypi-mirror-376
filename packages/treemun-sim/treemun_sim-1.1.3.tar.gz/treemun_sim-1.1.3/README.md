...
![Pinus radiata policies](docs/images/grafico_final_policies_pino.png)
...
![Eucalyptus globulus policies](docs/images/grafico_final_policies_eucalipto.png)
...
Python Package Version 1.1.3 https://pypi.org/project/treemun-sim/
```