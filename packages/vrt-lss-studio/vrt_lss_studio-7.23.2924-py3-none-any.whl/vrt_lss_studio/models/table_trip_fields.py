...
class TableTripFields(BaseModel):
    ...
    cost: Optional[Union[Annotated[float, Field(le=1000000000000, strict=True, ge=0)], Annotated[int, Field(le=2147483647, strict=True, ge=0)]]] = Field(default=0.0, description="Total cost calculated based on the performer's and transport tariffs. ")
    reward: Optional[Union[Annotated[float, Field(le=1000000000000, strict=True, ge=0)], Annotated[int, Field(le=2147483647, strict=True, ge=0)]]] = Field(default=0.0, description="The total reward for orders fulfillment.")
    profit: Optional[Union[Annotated[float, Field(le=1000000000000, strict=True, ge=-1000000000000)], Annotated[int, Field(le=2147483647, strict=True, ge=-2147483648)]]] = Field(default=0.0, description="The total profit is equal to the difference between the total reward (`reward`) and cost (`cost`). ")
    ...
    cargo_capacity_ratio_mass: Optional[Union[Annotated[float, Field(le=1000000, strict=True, ge=0)], Annotated[int, Field(le=1000000, strict=True, ge=0)]]] = Field(default=0.0, description="The ratio of the total additive measures of the transported cargo to the total capacity of the boxes.")
    cargo_capacity_ratio_volume: Optional[Union[Annotated[float, Field(le=1000000, strict=True, ge=0)], Annotated[int, Field(le=1000000, strict=True, ge=0)]]] = Field(default=0.0, description="The ratio of the total additive measures of the transported cargo to the total capacity of the boxes.")
    cargo_capacity_ratio_capacity_a: Optional[Union[Annotated[float, Field(le=1000000, strict=True, ge=0)], Annotated[int, Field(le=1000000, strict=True, ge=0)]]] = Field(default=0.0, description="The ratio of the total additive measures of the transported cargo to the total capacity of the boxes.")
    cargo_capacity_ratio_capacity_b: Optional[Union[Annotated[float, Field(le=1000000, strict=True, ge=0)], Annotated[int, Field(le=1000000, strict=True, ge=0)]]] = Field(default=0.0, description="The ratio of the total additive measures of the transported cargo to the total capacity of the boxes.")
    cargo_capacity_ratio_capacity_c: Optional[Union[Annotated[float, Field(le=1000000, strict=True, ge=0)], Annotated[int, Field(le=1000000, strict=True, ge=0)]]] = Field(default=0.0, description="The ratio of the total additive measures of the transported cargo to the total capacity of the boxes.")
    max_transport_load_mass: Optional[Union[Annotated[float, Field(le=1000000, strict=True, ge=0)], Annotated[int, Field(le=1000000, strict=True, ge=0)]]] = Field(default=0.0, description="The ratio of the maximum load of boxes to the total capacity of boxes.")
    max_transport_load_volume: Optional[Union[Annotated[float, Field(le=1000000, strict=True, ge=0)], Annotated[int, Field(le=1000000, strict=True, ge=0)]]] = Field(default=0.0, description="The ratio of the maximum load of boxes to the total capacity of boxes.")
    max_transport_load_capacity_a: Optional[Union[Annotated[float, Field(le=1000000, strict=True, ge=0)], Annotated[int, Field(le=1000000, strict=True, ge=0)]]] = Field(default=0.0, description="The ratio of the maximum load of boxes to the total capacity of boxes.")
    max_transport_load_capacity_b: Optional[Union[Annotated[float, Field(le=1000000, strict=True, ge=0)], Annotated[int, Field(le=1000000, strict=True, ge=0)]]] = Field(default=0.0, description="The ratio of the maximum load of boxes to the total capacity of boxes.")
    max_transport_load_capacity_c: Optional[Union[Annotated[float, Field(le=1000000, strict=True, ge=0)], Annotated[int, Field(le=1000000, strict=True, ge=0)]]] = Field(default=0.0, description="The ratio of the maximum load of boxes to the total capacity of boxes.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "profit": obj.get("profit") if obj.get("profit") is not None else 0.0,
            ...
            "cargo_capacity_ratio_mass": obj.get("cargo_capacity_ratio_mass") if obj.get("cargo_capacity_ratio_mass") is not None else 0.0,
            "cargo_capacity_ratio_volume": obj.get("cargo_capacity_ratio_volume") if obj.get("cargo_capacity_ratio_volume") is not None else 0.0,
            "cargo_capacity_ratio_capacity_a": obj.get("cargo_capacity_ratio_capacity_a") if obj.get("cargo_capacity_ratio_capacity_a") is not None else 0.0,
            "cargo_capacity_ratio_capacity_b": obj.get("cargo_capacity_ratio_capacity_b") if obj.get("cargo_capacity_ratio_capacity_b") is not None else 0.0,
            "cargo_capacity_ratio_capacity_c": obj.get("cargo_capacity_ratio_capacity_c") if obj.get("cargo_capacity_ratio_capacity_c") is not None else 0.0,
            "max_transport_load_mass": obj.get("max_transport_load_mass") if obj.get("max_transport_load_mass") is not None else 0.0,
            "max_transport_load_volume": obj.get("max_transport_load_volume") if obj.get("max_transport_load_volume") is not None else 0.0,
            "max_transport_load_capacity_a": obj.get("max_transport_load_capacity_a") if obj.get("max_transport_load_capacity_a") is not None else 0.0,
            "max_transport_load_capacity_b": obj.get("max_transport_load_capacity_b") if obj.get("max_transport_load_capacity_b") is not None else 0.0,
            "max_transport_load_capacity_c": obj.get("max_transport_load_capacity_c") if obj.get("max_transport_load_capacity_c") is not None else 0.0,
