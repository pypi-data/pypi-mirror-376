...
def init_pool(
    ...
    **kwargs: Any,
    ...
    Example:
        >>> init_pool("postgresql://user:pass@localhost/mydb", 
        ...           db_name="mydb", application_name="my-app")
    ...
    if dsn is None:
        if db_name == "default":
            ...
            env_key = f"{db_name.upper()}_DATABASE_URL"
    ...
    # Create new pool without auto-opening (to avoid deprecation warning)
