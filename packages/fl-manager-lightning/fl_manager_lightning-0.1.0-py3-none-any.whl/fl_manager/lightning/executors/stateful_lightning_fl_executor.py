...
@FLExecutorRegistry.register(name='stateful_lightning_fl_executor')
class StatefulLightningFLExecutor(LightningFLExecutor):
    @property
    def nvflare_executor_cls(self) -> Type['NVFlareLightningExecutor']:
        from fl_manager.lightning.executors.nv.stateful_nvflare_lightning_executor import (
            StatefulNVFlareLightningExecutor,
        )

        return StatefulNVFlareLightningExecutor
