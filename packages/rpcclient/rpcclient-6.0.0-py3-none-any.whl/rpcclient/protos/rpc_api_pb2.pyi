...
class ReplyError(google.protobuf.message.Message):
    ...
    ERRNO_CODE_FIELD_NUMBER: builtins.int
    message: builtins.str
    errno_code: builtins.int
    def __init__(
        self,
        *,
        message: builtins.str = ...,
    ...
    def ClearField(self, field_name: typing.Literal["errno_code", b"errno_code", "message", b"message"]) -> None: ...
