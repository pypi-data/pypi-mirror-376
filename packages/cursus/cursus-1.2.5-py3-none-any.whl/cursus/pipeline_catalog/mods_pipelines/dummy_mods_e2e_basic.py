...
def create_dag() -> PipelineDAG:
    ...
    logger.info(
        f"Created MODS dummy end-to-end basic DAG with {len(dag.nodes)} nodes and {len(dag.edges)} edges"
    )
    return dag
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Create a MODS-enhanced dummy end-to-end basic pipeline"
    )
    parser.add_argument(
