...
def create_dag() -> PipelineDAG:
    ...
    logger.info(
        f"Created MODS XGBoost complete end-to-end DAG with {len(dag.nodes)} nodes and {len(dag.edges)} edges"
    )
    return dag
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Create a MODS-enhanced complete XGBoost end-to-end pipeline"
    )
    parser.add_argument(
