...
MODEL_CALIBRATION_TRAINING_SPEC = StepSpecification(
    ...
    dependencies={
        "evaluation_data": DependencySpec(
            ...
            semantic_keywords=["training", "train", "evaluation", "predictions", "scores", "results", "model_output", "performance", "training_evaluation", "train_predictions", "training_results"],
            data_type="S3Uri",
    ...
    outputs={
        "calibration_output": OutputSpec(
            ...
            aliases=["calibration_model", "training_calibration", "train_calibrator", "training_probability_calibration", "training_calibration_artifacts"],
            data_type="S3Uri",
        ...
        "metrics_output": OutputSpec(
            ...
            aliases=["training_calibration_metrics", "training_reliability_metrics", "training_probability_metrics", "training_calibration_performance", "training_calibration_evaluation"],
            data_type="S3Uri",
        ...
        "calibrated_data": OutputSpec(
            ...
            aliases=["training_calibrated_predictions", "training_calibrated_probabilities", "training_probability_scores", "training_adjusted_predictions", "training_calibrated_outputs"],
            data_type="S3Uri",
