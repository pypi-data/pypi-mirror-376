...
MODEL_CALIBRATION_CALIBRATION_SPEC = StepSpecification(
    ...
    dependencies={
        "evaluation_data": DependencySpec(
            ...
            semantic_keywords=["calibration", "evaluation", "predictions", "scores", "results", "model_output", "performance", "calibration_evaluation", "calibration_predictions", "calibration_results"],
            data_type="S3Uri",
