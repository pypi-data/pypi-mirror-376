...
def extract_hyperparameters_from_tarball(input_model_dir: Path, working_directory: Path) -> Dict:
...
if __name__ == '__main__':
    try:
        ...
        environ_vars = {}
        for env_var in [ENV_CONTENT_TYPES, ENV_DEFAULT_NUMERIC_VALUE, ENV_DEFAULT_TEXT_VALUE]:
