...
def create_dag() -> PipelineDAG:
    ...
    logger.info(
        f"Created MODS PyTorch basic training DAG with {len(dag.nodes)} nodes and {len(dag.edges)} edges"
    )
    return dag
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Create a MODS-enhanced PyTorch basic training pipeline"
    )
    parser.add_argument(
