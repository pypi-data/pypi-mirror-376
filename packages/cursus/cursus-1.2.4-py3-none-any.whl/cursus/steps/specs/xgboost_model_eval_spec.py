...
MODEL_EVAL_SPEC = StepSpecification(
    ...
    dependencies=[
        DependencySpec(
            ...
            required=True,
            compatible_sources=["XGBoostTraining", "PyTorchTraining", "DummyTraining", "XGBoostModel", "PyTorchModel"],
        ...
        DependencySpec(
            ...
            required=True,
            compatible_sources=["TabularPreprocessing", "CradleDataLoading", "RiskTableMapping", "CurrencyConversion"],
