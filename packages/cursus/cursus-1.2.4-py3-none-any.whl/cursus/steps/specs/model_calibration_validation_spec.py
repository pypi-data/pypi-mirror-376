...
MODEL_CALIBRATION_VALIDATION_SPEC = StepSpecification(
    ...
    dependencies={
        "evaluation_data": DependencySpec(
            ...
            required=True,
            compatible_sources=["PytorchTraining", "XGBoostTraining", "XGBoostModelEval", "ModelEvaluation", "TrainingEvaluation", "CrossValidation"],
            semantic_keywords=["validation", "val", "evaluate", "evaluation", "predictions", "scores", "results", "model_output", "performance", "validation_evaluation", "val_predictions", "validation_results"],
            data_type="S3Uri",
    ...
    outputs={
        "calibration_output": OutputSpec(
            ...
            aliases=["calibration_model", "validation_calibration", "val_calibrator", "validation_probability_calibration", "validation_calibration_artifacts"],
            data_type="S3Uri",
        ...
        "metrics_output": OutputSpec(
            ...
            aliases=["validation_calibration_metrics", "validation_reliability_metrics", "validation_probability_metrics", "validation_calibration_performance", "validation_calibration_evaluation"],
            data_type="S3Uri",
        ...
        "calibrated_data": OutputSpec(
            ...
            aliases=["validation_calibrated_predictions", "validation_calibrated_probabilities", "validation_probability_scores", "validation_adjusted_predictions", "validation_calibrated_outputs"],
            data_type="S3Uri",
