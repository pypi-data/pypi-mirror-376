...
MODEL_CALIBRATION_TESTING_SPEC = StepSpecification(
    ...
    dependencies={
        "evaluation_data": DependencySpec(
            ...
            semantic_keywords=["testing", "test", "evaluate", "evaluation", "predictions", "scores", "results", "model_output", "performance", "testing_evaluation", "test_predictions", "testing_results"],
            data_type="S3Uri",
    ...
    outputs={
        "calibration_output": OutputSpec(
            ...
            aliases=["calibration_model", "testing_calibration", "test_calibrator", "testing_probability_calibration", "testing_calibration_artifacts"],
            data_type="S3Uri",
        ...
        "metrics_output": OutputSpec(
            ...
            aliases=["testing_calibration_metrics", "testing_reliability_metrics", "testing_probability_metrics", "testing_calibration_performance", "testing_calibration_evaluation"],
            data_type="S3Uri",
        ...
        "calibrated_data": OutputSpec(
            ...
            aliases=["testing_calibrated_predictions", "testing_calibrated_probabilities", "testing_probability_scores", "testing_adjusted_predictions", "testing_calibrated_outputs"],
            data_type="S3Uri",
