...
try:
    from ..specs.currency_conversion_training_spec import CURRENCY_CONVERSION_TRAINING_SPEC
    from ..specs.currency_conversion_calibration_spec import CURRENCY_CONVERSION_CALIBRATION_SPEC
    from ..specs.currency_conversion_validation_spec import CURRENCY_CONVERSION_VALIDATION_SPEC
    from ..specs.currency_conversion_testing_spec import CURRENCY_CONVERSION_TESTING_SPEC
