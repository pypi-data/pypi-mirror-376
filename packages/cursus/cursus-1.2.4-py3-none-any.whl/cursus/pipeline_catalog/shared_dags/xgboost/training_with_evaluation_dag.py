...
def create_xgboost_training_with_evaluation_dag() -> PipelineDAG:
    ...
    logger.info(f"Created XGBoost training with evaluation DAG with {len(dag.nodes)} nodes and {len(dag.edges)} edges")
    return dag
...
def get_dag_metadata() -> DAGMetadata:
    ...
    return DAGMetadata(
        ...
        extra_metadata={
            ...
            "task_type": "training",
            "entry_points": ["CradleDataLoading_training", "CradleDataLoading_evaluation"],
