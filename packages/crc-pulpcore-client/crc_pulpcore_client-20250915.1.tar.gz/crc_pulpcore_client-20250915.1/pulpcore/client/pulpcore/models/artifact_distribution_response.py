...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["base_path", "pulp_href", "hidden", "pulp_labels", "name", "prn", "content_guard", "no_content_change_since", "pulp_last_updated", "base_url", "pulp_created"]
