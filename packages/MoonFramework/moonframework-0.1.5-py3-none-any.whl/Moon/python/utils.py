...
def find_library() -> str:
    ...
    print(f"{Fore.YELLOW}{caller_filename:<20}{Fore.RESET} -> Library not found in standard paths, searching in module installation directory...")
    
    # Получаем путь к установленному модулю Moon
    module_path = find_module_installation_path('Moon')
    
    if module_path:
        print(f"{Fore.CYAN}{caller_filename:<20}{Fore.RESET} -> Searching in module path: {module_path}")
    ...
    print(f"{Fore.YELLOW}{caller_filename:<20}{Fore.RESET} -> Library not found in module directory, starting recursive search from current directory...")
