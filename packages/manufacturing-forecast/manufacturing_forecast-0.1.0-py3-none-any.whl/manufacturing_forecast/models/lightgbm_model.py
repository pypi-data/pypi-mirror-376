...
lgb.LGBMRegressor._silent = True
import numpy as np
import shap
...
class LightGBMRegression(BaseRegression):
    def __init__(self, **lgb_params):
        ...
        self._init_params = self.lgb_params.copy()

    def fit(self, X, y, num_boost_round=100, valid_sets=None, callbacks=None):
        """Fit the LightGBM regression model"""
...
if __name__ == "__main__":
    ...
    loaded_model = LightGBMRegression.load("lightgbm_model.pkl")
    print(
