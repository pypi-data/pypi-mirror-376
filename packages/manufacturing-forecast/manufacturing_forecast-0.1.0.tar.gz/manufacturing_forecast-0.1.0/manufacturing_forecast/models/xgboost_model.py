...
class XGBoostRegression(BaseRegression):
    def __init__(self, **xgb_params):
        ...
        self._init_params = self.xgb_params.copy()
    ...
    def fit(self, X, y):
        ...
        if y.ndim > 1 and y.shape[1] > 1:
            ...
            for i in range(y.shape[1]):
                model_i = xgb.XGBRegressor(**self.xgb_params)
                model_i.fit(X, y[:, i])
...
if __name__ == "__main__":
    ...
    loaded_model = XGBoostRegression.load("xgb_model.pkl")
    print(
