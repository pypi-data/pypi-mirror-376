...
def serialRfDemo():
    ...
    """
    g_pkt = zlb.ZlBusUnPack(tracker_nums = 17, user_id = 0xFF, fifoMaxSize = (17*5))
    ...
    if uartStr:
        ...
        serialWrite(zlapi.hl_configOutDataPort(zlapi.e_DataOutPort.TK_RF_PORT))
