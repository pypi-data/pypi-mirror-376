...
def get_client_ip(request: HttpRequest) -> str:
    ...
    1. HTTP_X_ORIGINAL_FORWARDED_FOR (original client IP through multiple proxies)
    2. HTTP_X_FORWARDED_FOR (client IP through proxy)
    3. REMOTE_ADDR (direct connection IP)

    Returns:
        str: Client IP address, empty string if not found
    """
    ip = (
