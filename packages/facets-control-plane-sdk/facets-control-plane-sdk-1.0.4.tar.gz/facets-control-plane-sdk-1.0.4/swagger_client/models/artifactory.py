...
class Artifactory(object):
    ...
    def __init__(self, id=None, created_by=None, creation_date=None, last_modified_date=None, last_modified_by=None, name=None, uri=None, artifactory_type=None, change_log=None, stacks_associated=None, system_defined=None, versioning_key=None):  # noqa: E501
