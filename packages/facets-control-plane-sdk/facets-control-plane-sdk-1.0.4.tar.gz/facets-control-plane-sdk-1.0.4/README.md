...
*ModuleManagementApi* | [**get_intent_add_on_modules**](docs/ModuleManagementApi.md#get_intent_add_on_modules) | **GET** /cc-ui/v1/modules/{stackName}/intent/{intent}/flavor/{flavor}/add-ons | Get Add-On Modules
...
*UiStackControllerApi* | [**get_running_clusters_with_kubedebugger**](docs/UiStackControllerApi.md#get_running_clusters_with_kubedebugger) | **GET** /cc-ui/v1/stacks/running-clusters-with-kubedebugger | 
...
*UiTektonActionControllerApi* | [**download_upload**](docs/UiTektonActionControllerApi.md#download_upload) | **GET** /cc-ui/v1/actions/runs/{actionRunName}/upload | Download Upload for Action Run
*UiTektonActionControllerApi* | [**get_action_runs**](docs/UiTektonActionControllerApi.md#get_action_runs) | **GET** /cc-ui/v1/actions/{actionName}/runs | Get Action Runs
*UiTektonActionControllerApi* | [**get_actions**](docs/UiTektonActionControllerApi.md#get_actions) | **GET** /cc-ui/v1/actions | Get Actions
*UiTektonActionControllerApi* | [**get_step_logs**](docs/UiTektonActionControllerApi.md#get_step_logs) | **GET** /cc-ui/v1/actions/runs/{actionRunName}/steps/{stepName}/logs | Get Step Logs
*UiTektonActionControllerApi* | [**run_actions**](docs/UiTektonActionControllerApi.md#run_actions) | **POST** /cc-ui/v1/actions/run | Run Multiple Actions
...
## Documentation For Models
 ...
 - [ActionParameterDto](docs/ActionParameterDto.md)
 - [ActionParameterValueDto](docs/ActionParameterValueDto.md)
 - [ActionRunDto](docs/ActionRunDto.md)
 - [ActionRunRequestDto](docs/ActionRunRequestDto.md)
 - [ActionStepDto](docs/ActionStepDto.md)
 ...
 - [ArtifactoryOneTimeWebhook](docs/ArtifactoryOneTimeWebhook.md)
 ...
 - [BulkActionRunRequestDto](docs/BulkActionRunRequestDto.md)
