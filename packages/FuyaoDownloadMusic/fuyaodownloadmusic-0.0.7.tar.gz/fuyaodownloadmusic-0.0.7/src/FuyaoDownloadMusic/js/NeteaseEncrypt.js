...
Encryption.c = function (a, b, c) {
        var d, e;
        return setMaxDigits(131),
        d = new RSAKeyPair(b,"",c),
        e = encryptedString(d, a)
    }
function encryptTextSecKey(d, e, f, g) {
    var h = {}
        , i = Encryption.a(16);
    return h.encText = Encryption.b(d, g),
        h.encText = Encryption.b(h.encText, i),
        h.encSecKey = Encryption.c(i, e, f),
        h
}

var main = function (key){
    return encryptTextSecKey(key, '010001', '', '0CoJUm6Qyw8W8jud')
}

console.log(main('{"ids": "[1394167216]", "level": "exhigh", "encodeType": "aac"}'))