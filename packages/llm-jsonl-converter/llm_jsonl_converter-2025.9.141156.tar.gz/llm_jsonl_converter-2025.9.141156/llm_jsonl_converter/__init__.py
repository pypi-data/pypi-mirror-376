...
def generate_jsonl_from_text(
    ...
    *,
    ...
    verbose: bool = False,
    provide_full_context: bool = False,
) -> str:
    """
    ...
    Args:
        ...
        provide_full_context: If True, provides the full text context to each chunk.
        ...
        for i, chunk_text in enumerate(chunks):
            for _ in range(rows_per_chunk):
                try:
                    ...
                    if provide_full_context:
                        full_context = f"[The full context is provided here.]\n\n{text}\n\n[End of full context.]\n\n"
