...
class BibleVectorDatabase:
    ...
    def search_verse(self, query: str, partial: bool=False):
        full_match = "SELECT * FROM Verses ORDER BY Book, Chapter, Verse WHERE Scripture = ?"
        partial_match = "SELECT * FROM Verses ORDER BY Book, Chapter, Verse WHERE Scripture LIKE ?"
