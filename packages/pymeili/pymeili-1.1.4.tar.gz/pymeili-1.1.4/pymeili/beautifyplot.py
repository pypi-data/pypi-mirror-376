...
if True:
    ...
    def text(x=0, y=0, s='', ax=None, fontsize=None, color="fg", fonttype="default", **kwargs):
        ...
        if fonttype not in ["default", "bold", "black", "zh", "ocr", "zh_bold", "kl"]:
            raise TypeError(f"\033[41m[pymeili Error]\033[0m text() got an unexpected keyword argument: fonttype='{fonttype}'. 'default', 'bold', 'black', 'zh', 'special', 'zhbold' or 'kl' is valid.")
        global _ax_
        if ax is None: ax = _ax_
