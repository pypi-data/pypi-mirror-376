...
if True:
    ...
    from pymeili3.cmapdict import cmaplist
    from pymeili3.richTable import printTable, getTableTime
    from pymeili3.configure import ConfigManager
    ...
    class FontFamily:
        def __init__(self, config: ConfigManager = None):
            ...
            # 載入字型路徑
            self.fontpath_medium = self._resolve_font("default")
            ...
            self.fontpath_zhbold = self._resolve_font("zh_bold")
