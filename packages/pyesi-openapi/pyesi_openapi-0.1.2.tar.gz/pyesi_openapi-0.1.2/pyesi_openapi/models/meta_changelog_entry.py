...
class MetaChangelogEntry(BaseModel):
    ...
    is_breaking: StrictBool = Field(description="Whether this is a breaking change")
    method: StrictStr = Field(description="HTTP method of the route")
    path: StrictStr = Field(description="Path of the route")
    __properties: ClassVar[List[str]] = ["compatibility_date", "description", "is_breaking", "method", "path"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "is_breaking": obj.get("is_breaking"),
