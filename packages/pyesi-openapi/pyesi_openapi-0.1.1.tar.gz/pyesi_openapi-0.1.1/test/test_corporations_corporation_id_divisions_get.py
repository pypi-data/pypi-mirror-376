    ...
    def make_instance(self, include_optional) -> CorporationsCorporationIdDivisionsGet:
        ...
        if include_optional:
            return CorporationsCorporationIdDivisionsGet(
                hangar = [
                    pyesi_openapi.models.corporations_corporation_id_divisions_get_hangar_inner.CorporationsCorporationIdDivisionsGet_hangar_inner(
                        division = 56, 
                        name = '', )
                    ],
                wallet = [
                    pyesi_openapi.models.corporations_corporation_id_divisions_get_wallet_inner.CorporationsCorporationIdDivisionsGet_wallet_inner(
                        division = 56, 
                        name = '', )
                    ]
            )
