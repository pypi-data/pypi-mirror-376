...
Open a file using the default system application. This tool works across Windows, macOS, and Linux platforms.

Parameters:

- `file_path` (required): Path to the file to open
...
```json
{
  "file_path": "C:\\Users\\username\\Documents\\file.docx"
}
```

The file will be opened in the default application associated with its file type.
