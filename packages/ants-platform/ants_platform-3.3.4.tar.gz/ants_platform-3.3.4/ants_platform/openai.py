...
```diff
- import openai
+ from ants_platform.openai import openai
```
...
See docs for more details: https://ants_platform.com/docs/integrations/openai
"""
...
from ants_platform._client.span import LangfuseGeneration
