...
from ants_platform._client.get_client import _set_current_public_key, get_client
...
from ants_platform.types import TraceContext
...
class LangfuseDecorator:
    ...
    _log = logging.getLogger("ants_platform")
    ...
    def observe(
        ...
        *,
        ...
        function_io_capture_enabled = os.environ.get(
            ANTS_PLATFORM_OBSERVE_DECORATOR_IO_CAPTURE_ENABLED, "True"
