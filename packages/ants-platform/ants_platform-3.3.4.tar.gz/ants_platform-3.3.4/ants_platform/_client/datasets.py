...
if TYPE_CHECKING:
    from ants_platform._client.client import Langfuse
...
class DatasetItemClient:
    ...
    Example:
        ```python
        from ants_platform import Langfuse
    ...
    def run(
        ...
        *,
        ...
        with self.ants_platform.start_as_current_span(name=trace_name) as span:
            span.update_trace(
                name=trace_name,
                metadata={
            ...
            self.ants_platform.api.dataset_run_items.create(
