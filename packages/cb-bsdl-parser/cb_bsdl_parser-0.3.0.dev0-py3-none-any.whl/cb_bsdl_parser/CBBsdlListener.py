...
class CBBsdlListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by CBBsdlParser#pin_desc.
    def enterPin_desc(self, ctx:CBBsdlParser.Pin_descContext):
        pass

    # Exit a parse tree produced by CBBsdlParser#pin_desc.
    def exitPin_desc(self, ctx:CBBsdlParser.Pin_descContext):
        pass
