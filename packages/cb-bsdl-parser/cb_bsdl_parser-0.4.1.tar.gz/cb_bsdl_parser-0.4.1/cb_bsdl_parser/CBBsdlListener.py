...
class CBBsdlListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by CBBsdlParser#port.
    def enterPort(self, ctx:CBBsdlParser.PortContext):
        pass

    # Exit a parse tree produced by CBBsdlParser#port.
    def exitPort(self, ctx:CBBsdlParser.PortContext):
        pass
