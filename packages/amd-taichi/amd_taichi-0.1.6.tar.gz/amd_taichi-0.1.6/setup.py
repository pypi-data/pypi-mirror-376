...
if 'install' in sys.argv:
    ...
    module_path = os.path.join(os.path.dirname(__file__), "amd-taichi", "_postinstall.py")
    spec = importlib.util.spec_from_file_location("amd-taichi._postinstall", module_path)
