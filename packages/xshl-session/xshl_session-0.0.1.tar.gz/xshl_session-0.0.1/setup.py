...
if base_dir:
    os.chdir(base_dir)
with open(os.path.join(base_dir, "xshl", "session", "__about__.py")) as f:
    exec(f.read(), about)
...
setup(
    ...
    url=about["__uri__"],
    project_urls={
        "Bug Tracker": "https://github.com/mcode-cc/py-xshl-session/issues",
        "Source Code": "https://github.com/mcode-cc/py-xshl-session",
    },
