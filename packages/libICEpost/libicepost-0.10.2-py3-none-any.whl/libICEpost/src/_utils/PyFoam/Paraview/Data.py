...
from libICEpost.src._utils.PyFoam.Paraview import caseDirectory as case
from libICEpost.src._utils.PyFoam.Paraview import viewTime as vTime
...
def setSampleData(tbl,lineName,dirName="sets"):
    ...
    source code write
from libICEpost.src._utils.PyFoam.Paraview.Data import setSampleData
...
def setTimelineData(tbl,dirName,fields=[],positions=[],time=0):
    ...
    source code write
from libICEpost.src._utils.PyFoam.Paraview.Data import setTimelineData
...
from libICEpost.src._utils.PyFoam.Paraview.Data import setPlotData
...
from libICEpost.src._utils.PyFoam.Paraview.Data import setCurrentTimeline
