...
class Tracing:
    ...
    def success(self) -> None:
        ...
        if 'success' not in self.state or not self.state['success'] or Tracing._last_report is None or (time.time() - Tracing._last_report) > self.max_interval:
            try:
    ...
    def failure(self) -> None:
        ...
        if 'success' in self.state and not self.state['success'] and not report:
            return
