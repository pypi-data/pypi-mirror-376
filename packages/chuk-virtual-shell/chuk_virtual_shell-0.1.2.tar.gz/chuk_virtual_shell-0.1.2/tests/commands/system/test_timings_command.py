...
class TestTimingsCommand:
    ...
    def test_timings_sort_by_count(self, shell):
        ...
        shell.enable_timing = True
        shell.command_timing = {
            "ls": {'count': 10, 'total_time': 0.1, 'min_time': 0.008, 'max_time': 0.012},
            "echo": {'count': 5, 'total_time': 0.05, 'min_time': 0.008, 'max_time': 0.012},
            "pwd": {'count': 15, 'total_time': 0.15, 'min_time': 0.008, 'max_time': 0.012}
        }
        ...
        data_lines = [line for line in lines if line and not line.startswith("-") and "Command" not in line and "Total" not in line]
    ...
    def test_timings_sort_by_avg(self, shell):
        ...
        shell.command_timing = {
            ...
            "fast": {'count': 10, 'total_time': 0.1, 'min_time': 0.009, 'max_time': 0.011},
            "medium": {'count': 5, 'total_time': 1.0, 'min_time': 0.18, 'max_time': 0.22}
        }
    ...
    def test_timings_sort_by_total(self, shell):
        ...
        shell.command_timing = {
            ...
            "cmd2": {'count': 10, 'total_time': 1.0, 'min_time': 0.09, 'max_time': 0.11},
            "cmd3": {'count': 5, 'total_time': 0.25, 'min_time': 0.04, 'max_time': 0.06}
        }
    ...
    def test_timings_status_when_enabled(self, shell):
        ...
        timings_cmd = TimingsCommand(shell)
        shell.enable_timing = True
        shell.command_timing = {"ls": {'count': 1, 'total_time': 0.1, 'min_time': 0.1, 'max_time': 0.1}}
    ...
    def test_timings_calculation_accuracy(self, shell):
        ...
        lines = result.split("\n")
        test_line = next(line for line in lines if "test" in line and "Command" not in line)
