...
class AsyncHTTPClient(BaseClient):
    ...
    async def get(self, url_path, params: Optional[dict] = None, **kwargs) -> Dict[str, Any]:
        """Sends a GET request."""
        params = params or {}
        if kwargs:
            params.update(kwargs)
        return await self.prepare_and_send_request("GET", url_path, params, data=None)
    ...
    async def post(
        ...
        **kwargs,
        ...
        if kwargs:
            data.update(kwargs)
        return await self.prepare_and_send_request("POST", url_path, params, data)
    ...
    async def put(
        ...
        **kwargs,
        ...
        if kwargs:
            data.update(kwargs)
        return await self.prepare_and_send_request("PUT", url_path, params, data)
    ...
    async def delete(
        ...
        **kwargs,
        ...
        if kwargs:
            data.update(kwargs)
        return await self.prepare_and_send_request("DELETE", url_path, params, data)
    ...
    async def prepare_and_send_request(
        ...
        return await self.send_request(http_method, url_path, params, headers, data=data)

    async def send_request(self, http_method, url_path, params, headers, data=None):
