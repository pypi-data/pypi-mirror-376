<div align="left">
  ...
  [![Version](https://img.shields.io/badge/version-2.1.7-green)](https://pypi.org/project/purechainlib/)
...
- **Resolved ckzg compilation issues** on Windows systems
- **No Visual C++ required** for basic functionality
- **Automatic fallback** for systems without build tools
- **Comprehensive Windows installation guide** available

## Previous Updates (v2.1.4)
...
**Windows Users:** If you encounter installation errors, see our [Windows Installation Guide](WINDOWS_INSTALLATION.md) for solutions.

**Note:** Version 2.1.7+ includes Windows compatibility improvements. Security tools like Mythril can be installed separately if needed.
