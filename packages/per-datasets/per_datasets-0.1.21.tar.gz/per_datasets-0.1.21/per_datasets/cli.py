...
def show_status() -> None:
    ...
    if 'api_key' in config:
        ...
        try:
            ...
            response = requests.get('https://5000-firebase-perd-server-1756729132019.cluster-fbfjltn375c6wqxlhoehbz44sk.cloudworkstations.dev/datasets', headers=headers, timeout=5)
