...
class LLM:
    def __init__(self, client:OpenAI, model:str, temperature:float, sys_prompt:str):
        ...
        if self.platform == "windows":
            ...
            # Force interactive mode and prevent auto-exit by using /dev/null as input initially
...
"""
    ...
    def reset_shell(self) -> Dict[str, Any]:
        ...
        try:
            ...
            # Send initial command to keep shell alive and get prompt
            time.sleep(0.1)  # Give shell time to start
            self.shell_process.stdin.write("echo 'Shell initialized'\n")
