...
class ApiParams(TypedDict, total=False):
    ...
    domain: Optional[str]
    """Novita Agent Sandbox domain to use for authentication, defaults to `NOVITA_DOMAIN` environment variable."""
...
class ConnectionConfig:
    ...
    @staticmethod
    def _domain():
        return os.getenv("NOVITA_DOMAIN") or "sandbox.novita.ai"
