...
uvx specify-cli specify init <PROJECT_NAME>
...
uvx specify-cli specify init my-project

# Initialize with specific AI assistant
uvx specify-cli specify init my-project --ai claude

# Initialize in current directory
uvx specify-cli specify init --here --ai copilot

# Skip git initialization
uvx specify-cli specify init my-project --ai gemini --no-git

# Check system requirements
uvx specify-cli specify check
```
...
```bash
uvx specify-cli specify init --here
```
...
```bash
uvx specify-cli specify init <project_name> --ai claude
uvx specify-cli specify init <project_name> --ai gemini
uvx specify-cli specify init <project_name> --ai copilot
# Or in current directory:
uvx specify-cli specify init --here --ai claude
```
...
```bash
uvx specify-cli specify init <project_name> --ai claude --ignore-agent-tools
```
