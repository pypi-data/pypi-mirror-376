...
if version_info >= (3, 11):
    ...
    from importlib_metadata import version as metadata_version  # type: ignore[import,no-redef,unused-ignore]
    from importlib_metadata import PackageNotFoundError  # type: ignore[assignment,no-redef,unused-ignore]
