...
class Relation:
    ...
    def __init__(self, foreign_model, name=None, print_options=None, lazy_load=True):
...
class ManyToOne(Relation):
    ...
    def __init__(self, foreign_model, foreign_key_field,
                 foreign_model_key_field=None, insert_search_column=None, update_search_column=None,
                 load_all=False, lazy_load=True, name=None, print_options=None):
        super().__init__(foreign_model=foreign_model, name=name, print_options=print_options, lazy_load=lazy_load)
        ...
        self.insert_search_column = insert_search_column
