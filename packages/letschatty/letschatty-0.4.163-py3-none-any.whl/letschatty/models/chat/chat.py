...
from .flow_link_state import FlowStateAssignedToChat, SmartFollowUpState
...
class Chat(CompanyAssetModel):
    ...
    flow_states: List[FlowStateAssignedToChat | SmartFollowUpState] = Field(default_factory=list)
