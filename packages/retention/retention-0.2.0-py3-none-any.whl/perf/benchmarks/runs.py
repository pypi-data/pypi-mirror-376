...
from retention.vidrial_fused import power_retention as power_retention_fused
...
from retention._update_state import update_state_triton, update_state_vidrial, create_inputs as create_inputs_update_state
from retention._query_state import query_state_triton, query_state_vidrial, create_inputs as create_inputs_query_state
...
class PowerFullFused():
    ...
    def make_run(**kw):
        inputs = sanitize_kwargs(create_inputs_power)(**kw)
        return lambda: power_retention_fused(**inputs)
