...
class Dvol(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["openDate", "open", "high", "low", "close"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Dvol from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Dvol from a dict"""
        if obj is None:
            return None
