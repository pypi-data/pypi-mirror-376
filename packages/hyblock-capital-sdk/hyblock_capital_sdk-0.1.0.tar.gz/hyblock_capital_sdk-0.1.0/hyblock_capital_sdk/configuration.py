...
AuthSettings = TypedDict(
    "AuthSettings",
    {
        "Client Credentials": OAuth2AuthSetting,
...
class Configuration:
    ...
    conf = hyblock_capital_sdk.Configuration(
    ...
    def __init__(
        ...
        *,
        ...
        """Constructor"""
        self._base_path = (
            "https://api1.dev.hyblockcapital.com/v1" if host is None else host
        )
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("hyblock_capital_sdk")
    ...
    def get_host_settings(self) -> List[HostSetting]:
        ...
        return [
            {
                "url": "https://api1.dev.hyblockcapital.com/v1",
