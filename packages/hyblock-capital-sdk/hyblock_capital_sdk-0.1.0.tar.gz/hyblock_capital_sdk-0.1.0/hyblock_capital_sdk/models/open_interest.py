...
class OpenInterest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["openDate", "open", "low", "high", "close"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OpenInterest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OpenInterest from a dict"""
        if obj is None:
            return None
