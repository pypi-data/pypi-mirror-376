...
from xladmin.views.dashboard import ModelBaseWidget, widget_manager
from xladmin.util import lookup_field, label_for_field, json
...
class ChartWidget(ModelBaseWidget):
    ...
    template = 'xladmin/widgets/chart.html'
    ...
    # Media
    def media(self):
        return self.vendor('flot.js', 'xladmin.plugin.charts.js')
...
class ChartsPlugin(BaseAdminPlugin):
    ...
    def get_media(self, media):
        return media + self.vendor('flot.js', 'xladmin.plugin.charts.js')
    ...
    def block_results_top(self, context, nodes):
        ...
        nodes.append(loader.render_to_string('xladmin/blocks/model_list.results_top.charts.html',
