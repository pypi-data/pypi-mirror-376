...
from xladmin.views.list import ResultRow, ResultItem
from xladmin.util import display_for_field
...
class AggregationPlugin(BaseAdminPlugin):
    ...
    def get_media(self, media):
        return media + Media(css={'screen': [self.static('xladmin/css/xladmin.plugin.aggregation.css'), ]})
