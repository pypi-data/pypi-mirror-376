...
if __name__ == '__main__':
    ...
    kaqCoinRedisRepository = KaqCoinRedisRepository(host=host, port=port, password=passwd)
    # value = kaqCoinRedisRepository.get('test')
    df = kaqCoinRedisRepository.get_values_by_pattern('kaq_binance_commision_rate_*')
    print(df)