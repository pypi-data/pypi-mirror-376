...
def read_config(project_dir=os.getcwd(), pkg_name='kaq_quant_common'):
    config_path = f'{project_dir}{os.sep}config{os.sep}config.yaml'
...
def get_mysql_script(project_dir=os.getcwd(), file_name: str='mysql_script.sql', pkg_name='kaq_quant_common'):
    '''
    读取mysql脚本
    '''
    config_path = f'{project_dir}{os.sep}config{os.sep}mysql_script{os.sep}{file_name}'
    try:
...
def get_dos_script(project_dir=os.getcwd(), file_name='ddb_script.dos', pkg_name='kaq_quant_common'):
    '''
    读取ddb脚本
    '''
    config_path = f'{project_dir}{os.sep}config{os.sep}ddb_script{os.sep}{file_name}'
    if os.path.exists(config_path) is False:
