...
RedoHandler = Union[Callable[[ROContext[R]], bool], Callable[[ROContext[R]], Awaitable[bool]]]

RedoHandlerAsync = Callable[[ROContext[R]], Awaitable[bool]]
...
class RedoHandlerWrapper:
    ...
    async def __call__(self, ctx: ROContext[R]) -> bool:
    ...
    def set_handler(self, handler: RedoHandler):
        if inspect.iscoroutinefunction(handler):
            ...
            async def sync_caller(message: ROContext) -> bool:
