...
def overview():
    return rx.box(
        rxe.flow(
            ...
            node_types={
                "tools": rx.vars.function.ArgsFunctionOperation.create(
                    (rx.vars.function.DestructuredArg(fields=("data",)),),
                    toolbar_node(data=rx.Var("data")),
                ),
                "circle": rx.vars.function.ArgsFunctionOperation.create(
                    (
                        rx.vars.function.DestructuredArg(
                            fields=("positionAbsoluteX", "positionAbsoluteY")
                        ),
                    ),
                    circle_node(
                        positionAbsoluteX=rx.Var("positionAbsoluteX"),
                        positionAbsoluteY=rx.Var("positionAbsoluteY"),
                    ),
                ),
                "resizer": rx.vars.function.ArgsFunctionOperation.create(
                    (rx.vars.function.DestructuredArg(fields=("data",)),),
                    resizer_node(data=rx.Var("data")),
                ),
                "annotation": rx.vars.function.ArgsFunctionOperation.create(
                    (rx.vars.function.DestructuredArg(fields=("data",)),),
                    annotation_node(data=rx.Var("data")),
                ),
                "textinput": rx.vars.function.ArgsFunctionOperation.create(
                    (rx.vars.function.DestructuredArg(fields=("id",)),),
                    dimension_node(id=rx.Var("id")),
                ),
            },
            edge_types={
