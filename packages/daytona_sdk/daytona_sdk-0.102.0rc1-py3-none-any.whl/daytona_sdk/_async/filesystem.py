...
import aiofiles.os
import httpx
from daytona_daemon_api_client_async import (
    FileInfo,
    FileSystemApi,
    Match,
    ReplaceRequest,
...
class AsyncFileSystem:
    ...
    async def delete_file(self, path: str) -> None:
        ...
        Example:
            ...
            ```
        """
        await self._api_client.delete_file(path=prefix_relative_path(await self._get_root_dir(), path))
    ...
    async def upload_files(self, files: List[FileUpload], timeout: int = 30 * 60) -> None:
        ...
        with ExitStack() as stack:
            ...
            # pylint: disable=protected-access
            _, url, headers, *_ = self._api_client._upload_files_serialize(None, None, None, None, None, None)
