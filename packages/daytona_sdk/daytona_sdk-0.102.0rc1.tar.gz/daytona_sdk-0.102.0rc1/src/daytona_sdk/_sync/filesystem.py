...
import httpx
from daytona_daemon_api_client import FileInfo, FileSystemApi, Match, ReplaceRequest, ReplaceResult, SearchFilesResponse
...
class FileSystem:
    ...
    def delete_file(self, path: str) -> None:
        ...
        Example:
            ...
            ```
        """
        self._api_client.delete_file(path=prefix_relative_path(self._get_root_dir(), path))
