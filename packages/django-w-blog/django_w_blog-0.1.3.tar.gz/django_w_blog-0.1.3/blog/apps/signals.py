...
from blog.apps.categories.models import BlogCategory
...
def register_category_signal_receivers():
    register_signal_receivers(BlogCategory)


def register_article_signal_receivers():
    register_signal_receivers(BlogArticle)
