...
def prepare_generic_server(
    ...
    """
    cprint(f"🔥 RIEN Firewall:", color="red", file=sys.stdout, end='')
    print(' check of dit een Hetzner server is, en of de firewall ingesteld moet worden!')
    ...
    cprint(f"🔥 RIEN Firewall:", color="red", file=sys.stdout, end='')
    print(' nogmaals ... check of dit een Hetzner server is, en of de firewall ingesteld moet worden!')
