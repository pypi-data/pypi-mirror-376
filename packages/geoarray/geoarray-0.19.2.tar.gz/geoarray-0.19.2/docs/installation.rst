...
.. code-block:: console
    ...
    $ curl  -OL https://git.gfz-potsdam.de/danschef/geoarray/repository/archive.tar.gz?ref=main
...
.. _tarball: https://git.gfz-potsdam.de/danschef/geoarray/repository/archive.tar.gz?ref=main
