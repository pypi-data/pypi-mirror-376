...
from .fylex import filecopy, filemove, undo, FylexConfig
...
def parse_args():
    ...
    copy_parser.add_argument("--algo", default=FylexConfig.DEFAULT_HASH_ALGO, help="Hash algorithm (xxhash, blake3, md5, sha256, sha512)")
    copy_parser.add_argument("--chunk-size", type=int, default=FylexConfig.DEFAULT_CHUNK_SIZE, help="Read buffer size in bytes")
    ...
    copy_parser.add_argument("--summary", default=None, help="Write summary log to this path")
    ...
    copy_parser.add_argument("--preserve-meta", action="store_true", default=True, help="Preserve metadata (mtime, permissions, xattrs, ACLs)")
    ...
    move_parser.add_argument("--resolve", choices=FylexConfig.ON_CONFLICT_MODES, default="rename",
                             help="Conflict resolution strategy")
    move_parser.add_argument("--algo", default=FylexConfig.DEFAULT_HASH_ALGO, help="Hash algorithm")
    move_parser.add_argument("--chunk-size", type=int, default=FylexConfig.DEFAULT_CHUNK_SIZE, help="Read buffer size in bytes")
    ...
    move_parser.add_argument("--summary", default=None, help="Write summary log to this path")
    ...
    move_parser.add_argument("--preserve-meta", action="store_true", default=True, help="Preserve metadata")
    ...
    undo_parser.add_argument("--algo", default=FylexConfig.DEFAULT_HASH_ALGO, help="Hash algorithm used")
