...
# DO NOT REMOVE.
from calliope_jupyter_ai_magics import (  # type: ignore[import-untyped]
...
def _jupyter_labextension_paths():
    return [{"src": "labextension", "dest": "@calliope-jupyter-ai/core"}]


def _jupyter_server_extension_points():
    return [{"module": "calliope_jupyter_ai", "app": AiExtension}]
