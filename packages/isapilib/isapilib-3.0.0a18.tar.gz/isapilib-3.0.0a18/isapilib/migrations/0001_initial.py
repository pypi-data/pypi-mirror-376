...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('agencia', '0004_alter_agencia_options'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('branch', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='permissions', to='isapilib.branchapi')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='permissions', to='isapilib.userapi')),
            ],
            options={
