...
from synthetic.commands import Command, CommandSignature, CommandExecution
    ...
    def generate(self, **kwargs: Any) -> GenerationOutput:
        ...
        try:
            while self.max_new_tokens is None or step < self.max_new_tokens:
                ...
                command_executions = token_event.command_executions
        ...
        return GenerationOutput(
            input=kwargs,
            step=step,
            command_executions=eos_event.command_executions,
            stop_criteria=eos_event.eos_exception.stop_criteria,
            **eos_event.output,
        )
