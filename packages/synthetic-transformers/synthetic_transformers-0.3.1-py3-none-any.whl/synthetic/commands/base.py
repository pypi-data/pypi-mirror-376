...
def command(name: str) -> Callable[[Callable[[CommandInput], CommandOutput]], Command]:
    def decorator(func: Callable[[CommandInput], CommandOutput]) -> Command:
        return Command(name=name, execute=func)
