#!/usr/bin/env python3
"""
Sample client for connecting to IB Gateway live trading on K3s.
This demonstrates how to connect to the live trading environment.
WARNING: This connects to real money trading - use with caution!
"""
...
class K3sLiveClient:
    def __init__(self, config_file=None, host=None, port=32001, client_id=None):
    ...
    async def connect(self):
        """Connect to the live trading gateway."""
        try:
            conn = self.config["connection"]
            print(f"Connecting to live trading on {conn['host']}:{conn['port']}...")
            ...
            print("✅ Connected to live trading successfully!")
            return True
    ...
    async def disconnect(self):
        ...
        try:
            if self.ib.isConnected():
                self.ib.disconnect()
                print("\n✅ Disconnected from live trading")
        except Exception as e:
