...
class TestMiscTools:
    ...
    @pytest.mark.unit
    @patch('src.vnstock_mcp.server.sjc_gold_price')
    def test_get_gold_price_sjc_no_date_json(self, mock_sjc_gold_price, sample_gold_price_data):
        ...
        # Test
        result = get_gold_price(None, 'SJC', 'json')
    ...
    def test_get_gold_price_sjc_with_date_json(self, mock_sjc_gold_price, sample_gold_price_data):
        ...
        # Test
        result = get_gold_price('2024-01-01', 'SJC', 'json')
    ...
    @pytest.mark.unit
    @patch('src.vnstock_mcp.server.btmc_goldprice')
    def test_get_gold_price_btmc_no_date_json(self, mock_btmc_goldprice, sample_gold_price_data):
        ...
        # Test
        result = get_gold_price(None, 'BTMC', 'json')
    ...
    def test_get_gold_price_sjc_dataframe(self, mock_sjc_gold_price, sample_gold_price_data):
        ...
        # Test
        result = get_gold_price('2024-01-01', 'SJC', 'dataframe')
    ...
    def test_get_gold_price_with_date_parameter(self, mock_sjc_gold_price, sample_gold_price_data):
        ...
        result = get_gold_price(test_date, 'SJC', 'json')
    ...
    @pytest.mark.unit
    @patch('src.vnstock_mcp.server.vcb_exchange_rate')
    ...
    def test_get_exchange_rate_no_date_json(self, mock_datetime, mock_vcb_exchange_rate, sample_exchange_rate_data):
        ...
        # Test
        result = get_exchange_rate(None, 'json')
    ...
    def test_get_exchange_rate_with_date_json(self, mock_vcb_exchange_rate, sample_exchange_rate_data):
        ...
        # Test
        result = get_exchange_rate('2024-01-15', 'json')
    ...
    def test_get_exchange_rate_dataframe(self, mock_vcb_exchange_rate, sample_exchange_rate_data):
        ...
        # Test
        result = get_exchange_rate('2024-01-01', 'dataframe')
    ...
    def test_get_gold_price_default_parameters(self):
        ...
        with patch('src.vnstock_mcp.server.sjc_gold_price') as mock_sjc_gold_price:
            mock_sjc_gold_price.return_value = pd.DataFrame([{'price': 75000000}])
            
            # Test default source (should be 'SJC') and output_format (should be 'json')
    ...
    def test_get_exchange_rate_default_parameters(self):
        ...
        with patch('src.vnstock_mcp.server.vcb_exchange_rate') as mock_vcb_exchange_rate, \
             patch('src.vnstock_mcp.server.datetime') as mock_datetime:
            
            mock_datetime.now.return_value.strftime.return_value = '2024-01-01'
            mock_vcb_exchange_rate.return_value = pd.DataFrame([{'currency': 'USD'}])
            
            # Test default date (should use current date) and output_format (should be 'json')
    ...
    def test_misc_tools_error_handling(self):
        ...
        with patch('src.vnstock_mcp.server.sjc_gold_price') as mock_sjc_gold_price:
            ...
            with pytest.raises(Exception):
                get_gold_price('2024-01-01', 'SJC', 'json')

        with patch('src.vnstock_mcp.server.vcb_exchange_rate') as mock_vcb_exchange_rate:
            mock_vcb_exchange_rate.side_effect = Exception("API Error")
            
            with pytest.raises(Exception):
                get_exchange_rate('2024-01-01', 'json')
    ...
    def test_gold_price_source_selection(self):
        ...
        with patch('src.vnstock_mcp.server.sjc_gold_price') as mock_sjc, \
             patch('src.vnstock_mcp.server.btmc_goldprice') as mock_btmc:
    ...
    def test_date_format_handling(self):
        ...
        with patch('src.vnstock_mcp.server.sjc_gold_price') as mock_sjc, \
             patch('src.vnstock_mcp.server.vcb_exchange_rate') as mock_vcb:
            ...
            for date_str in date_formats:
                # Test gold price
                get_gold_price(date_str, 'SJC', 'json')
                mock_sjc.assert_called_with(date=date_str)
                
                # Test exchange rate
                get_exchange_rate(date_str, 'json')
    ...
    def test_current_date_generation(self, mock_datetime):
        ...
        with patch('src.vnstock_mcp.server.vcb_exchange_rate') as mock_vcb:
            # Setup mock datetime
            mock_now = Mock()
    ...
    def test_misc_tools_consistency(self):
        ...
        with patch('src.vnstock_mcp.server.sjc_gold_price') as mock_sjc, \
            ...
            gold_result = get_gold_price(None, 'SJC', 'dataframe')
            exchange_result = get_exchange_rate(None, 'dataframe')
            ...
            gold_result_json = get_gold_price(None, 'SJC', 'json')
            exchange_result_json = get_exchange_rate(None, 'json')
