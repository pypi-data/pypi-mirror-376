...
class TestMergeRequest:
    ...
    def test_fetch_all_mine(self):
        ...
        result = MergeRequest.fetch_all_mine(api, user, "created_at")
    ...
    def test_comment(self):
        ...
        self.api.call.assert_called_once_with(
            POST("/projects/1234/merge_requests/54/notes", {"body": "blah"})
        )
    ...
    def test_trigger_pipeline_fallback_succeeds(self):
        ...
        def side_effect(request):
            if request.endpoint == "/projects/1234/merge_requests/54/pipelines":
                raise BadRequest(NO_JOBS_MESSAGE, 400)
    ...
    def test_trigger_pipeline_rules_fallback_succeeds(self):
        ...
        def side_effect(request):
            if request.endpoint == "/projects/1234/merge_requests/54/pipelines":
                raise BadRequest(RULES_PREVENT_JOBS_MESSAGE, 400)
            if request.endpoint == "/projects/1234/pipeline?ref=useless_new_feature":
                return expected_result
            return None
    ...
    def test_trigger_pipeline_fallback_fails(self):
        ...
        def side_effect(request):
            if request.endpoint == "/projects/1234/merge_requests/54/pipelines":
                raise BadRequest("Another error.", 500)
